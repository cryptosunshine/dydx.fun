function easeOutBounce(t, e, i, s) {
  return (t /= s) < 1 / 2.75
    ? i * (7.5625 * t * t) + e
    : t < 2 / 2.75
...
function easeFunc(t, e, i, s, n, r) {
  ...
  switch (t) {
    ...
    case 12:
      ...
      break;
    case 13:
      a = easeInCircle[integerize(e, n)];
      break;
    case 14:
      a = easeOutCircle[integerize(e, n)];
      break;
    case 15:
      a = easeInOutCircle[integerize(e, n)];
      break;
    case 16:
      var o = 0;
      0 == o && (o = 1.70158), (a = s * (e /= n) * e * ((o + 1) * e - o) + i);
      break;
    case 17:
      a = easeOutBack[integerize(e, n)];
      break;
    case 18:
      a = easeInOutBack[integerize(e, n)];
      break;
    case 19:
      a = easeInElasticArray[integerize(e, n)];
      break;
    case 20:
      a = easeOutElasticArray[integerize(e, n)];
      break;
    case 21:
      a = easeInOutElasticArray[integerize(e, n)];
      break;
    case 22:
      a = s - easeOutBounceArray[integerize(n - e, n)] + i;
      break;
    case 23:
      a = easeOutBounceArray[integerize(e, n)];
      break;
    case 24:
      a =
        e < n / 2
...
(cr.plugins_ = {}),
  ...
  (function () {
    ...
    function l(t, e, i) {
      var s;
      return (
        h.prototype.totalCellCount++,
        k.length
          ? ((s = k.pop()), (s.grid = t), (s.x = e), (s.y = i), s)
    ...
    function d(t, e, i) {
      var s;
      return (
        c.prototype.totalCellCount++,
        E.length
          ? ((s = E.pop()), (s.grid = t), (s.x = e), (s.y = i), s)
    ...
    (cr.logexport = function (t) {
      ...
      (cr.vector2 = t),
      (cr.segments_intersect = function (t, e, i, s, n, r, a, o) {
        var h, c, l, u, p, d, f, g;
        if (
          (t < i ? ((c = t), (h = i)) : ((c = i), (h = t)),
          n < a ? ((d = n), (p = a)) : ((d = a), (p = n)),
    ...
    (i.prototype.bounding_box = function (t) {
      ...
      (i.prototype.intersects_segment = function (t, e, i, s) {
        ...
        for (h = 0; h < 4; h++)
          if (
            ...
            (a = this.at(h + 1, !0)),
            (o = this.at(h + 1, !1)),
            cr.segments_intersect(t, e, i, s, n, r, a, o))
          )
            return !0;
        return !1;
      }),
      (i.prototype.intersects_quad = function (t) {
        ...
        if (((e = this.midX()), (i = this.midY()), t.contains_pt(e, i)))
          return !0;
        var s, n, r, a, o, h, c, l, u, p;
        for (u = 0; u < 4; u++)
          for (p = 0; p < 4; p++)
            if (
              ((s = this.at(u, !0)),
              ...
              (c = t.at(p + 1, !0)),
              (l = t.at(p + 1, !1)),
              cr.segments_intersect(s, n, r, a, o, h, c, l))
            )
              return !0;
        return !1;
      }),
      ...
      (cr.fastIndexOf = function (t, e) {
        var i, s;
        for (i = 0, s = t.length; i < s; ++i) if (t[i] === e) return i;
        return -1;
      }),
    ...
    "undefined" != typeof window &&
      ...
      (w = !b && /safari/i.test(navigator.userAgent)),
      (x = /(iphone|ipod|ipad)/i.test(navigator.userAgent)),
      (T = window.c2ejecta));
    var S =
      !w &&
      !T &&
    ...
    (n.prototype.contains = function (t) {
      return (
        !this.isEmpty() &&
        (S ? this.s.has(t) : this.items && this.items.hasOwnProperty(t))
      );
    }),
      (n.prototype.add = function (t) {
        if (S) this.s.has(t) || (this.s.add(t), (this.cache_valid = !1));
        else {
          var e = t.toString(),
            i = this.items;
          i
      ...
      (n.prototype.remove = function (t) {
        if (!this.isEmpty())
          if (S) this.s.has(t) && (this.s.delete(t), (this.cache_valid = !1));
          else if (this.items) {
            var e = t.toString(),
              i = this.items;
            i.hasOwnProperty(e) &&
              (delete i[e], this.item_count--, (this.cache_valid = !1));
          }
      }),
      (n.prototype.clear = function () {
        this.isEmpty() ||
          (S ? this.s.clear() : ((this.items = null), (this.item_count = 0)),
      ...
      (n.prototype.count = function () {
        return S ? this.s.size : this.item_count;
      });
    var O = null,
      C = 0;
    ...
    (cr.removeArrayDuplicates = function (t) {
      ...
      cr.shallowAssignArray(t, A.valuesRef()), A.clear();
    }),
      ...
      (cr.arrayRemoveAll_arr = function (t, e) {
        var i, s, n, r;
        for (i = 0, s = 0, n = t.length; i < n; ++i)
          (r = t[i]), cr.fastIndexOf(e, r) === -1 && (t[s++] = r);
        cr.truncateArray(t, s);
      }),
      ...
      (o.prototype.set_from_quad = function (t, e, i, s, n) {
        (this.pts_cache.length = 8), (this.pts_count = 4);
      ...
      (o.prototype.contains_pt = function (t, e) {
        ...
        for (s = 0; s < l; s++)
          (n = 2 * s),
            ...
            cr.segments_intersect(d, f, t, e, a, o, h, c) && m++;
        return g % 2 === 1 || m % 2 === 1;
      }),
      (o.prototype.intersects_poly = function (t, e, i) {
        ...
        var r, a, o, h, c, l, u, p, d, f, g, m, y, _, v, b;
        for (r = 0, h = this.pts_count; r < h; r++)
          for (
            a = 2 * r,
              o = ((r + 1) % h) * 2,
              d = n[a],
            ...
            if (
              ...
              (v = s[u] + e),
              (b = s[u + 1] + i),
              cr.segments_intersect(d, f, g, m, y, _, v, b))
            )
              return !0;
        return !1;
      }),
      (o.prototype.intersects_segment = function (t, e, i, s, n, r) {
        ...
        for (o = 0, h = this.pts_count; o < h; o++)
          if (
            ...
            (d = a[l] + t),
            (f = a[l + 1] + e),
            cr.segments_intersect(i, s, n, r, u, p, d, f))
          )
            return !0;
        return !1;
      }),
      (o.prototype.mirror = function (t) {
        var e, i, s;
        for (e = 0, i = this.pts_count; e < i; ++e)
          (s = 2 * e), (this.pts_cache[s] = 2 * t - this.pts_cache[s]);
      }),
      (o.prototype.flip = function (t) {
        var e, i, s;
        for (e = 0, i = this.pts_count; e < i; ++e)
          (s = 2 * e + 1), (this.pts_cache[s] = 2 * t - this.pts_cache[s]);
      }),
      (o.prototype.diag = function () {
        var t, e, i, s, n;
        for (t = 0, e = this.pts_count; t < e; ++t)
          (i = 2 * t),
            (s = i + 1),
            (n = this.pts_cache[i]),
            (this.pts_cache[i] = this.pts_cache[s]),
            (this.pts_cache[s] = n);
      }),
      (cr.CollisionPoly = o),
      (h.prototype.totalCellCount = 0),
      (h.prototype.getCell = function (t, e, i) {
        var s,
          n = this.cells[t];
        return n
          ? ((s = n[e]),
            s ? s : i ? ((s = l(this, t, e)), (this.cells[t][e] = s), s) : null)
          : i
          ? ((s = l(this, t, e)),
            (this.cells[t] = {}),
            (this.cells[t][e] = s),
      ...
      (h.prototype.update = function (t, e, i) {
        ...
        if (e)
          for (s = e.left, n = e.right; s <= n; ++s)
            for (r = e.top, a = e.bottom; r <= a; ++r)
              (i && i.contains_pt(s, r)) ||
                ((o = this.getCell(s, r, !1)),
                o &&
                  (o.remove(t),
                  o.isEmpty() && (u(o), (this.cells[s][r] = null))));
        if (i)
          for (s = i.left, n = i.right; s <= n; ++s)
            for (r = i.top, a = i.bottom; r <= a; ++r)
              (e && e.contains_pt(s, r)) || this.getCell(s, r, !0).insert(t);
      }),
      (h.prototype.queryRange = function (t, e) {
        var i, s, n, r, a, o;
        for (
          i = this.XToCell(t.left),
            n = this.YToCell(t.top),
            s = this.XToCell(t.right),
            a = this.YToCell(t.bottom);
          i <= s;
          ++i
        )
          for (r = n; r <= a; ++r) (o = this.getCell(i, r, !1)), o && o.dump(e);
      }),
      (cr.SparseGrid = h),
      (c.prototype.totalCellCount = 0),
      (c.prototype.getCell = function (t, e, i) {
        var s,
          n = this.cells[t];
        return n
          ? ((s = n[e]),
            s ? s : i ? ((s = d(this, t, e)), (this.cells[t][e] = s), s) : null)
          : i
          ? ((s = d(this, t, e)),
            (this.cells[t] = {}),
            (this.cells[t][e] = s),
          ...
          for (s = e.left, n = e.right; s <= n; ++s)
            for (r = e.top, a = e.bottom; r <= a; ++r)
              (i && i.contains_pt(s, r)) ||
                ...
                o &&
                  (o.remove(t),
                  o.isEmpty() && (f(o), (this.cells[s][r] = null))));
        if (i)
          for (s = i.left, n = i.right; s <= n; ++s)
            for (r = i.top, a = i.bottom; r <= a; ++r)
              (e && e.contains_pt(s, r)) || this.getCell(s, r, !0).insert(t);
    ...
    (g.prototype.isEmpty = function () {
      ...
      (g.prototype.insert = function (t) {
        ...
        if (this.objects.length) {
          ...
          e.get_zindex() > t.get_zindex() && (this.is_sorted = !1),
            this.objects.push(t);
    ...
    (cr.effectToCompositeOp = function (t) {
      ...
      (cr.isCanvasInputEvent = function (t) {
        ...
        return (
          ...
          e === document ||
          e === window ||
          !(!document || !document.body || e !== document.body) ||
          !!cr.equals_nocase(e.tagName, "canvas")
        );
      });
  })();
...
(vec3.create = function (t) {
  ...
  (vec3.cross = function (t, e, i) {
    ...
    var s = t[0],
      ...
      e = e[2];
    return (
      (i[0] = n * e - t * a), (i[1] = t * r - s * e), (i[2] = s * a - n * r), i
    );
  }),
  ...
  (vec3.direction = function (t, e, i) {
    ...
    return e
      ? ((e = 1 / e), (i[0] = s * e), (i[1] = n * e), (i[2] = t * e), i)
      : ((i[0] = 0), (i[1] = 0), (i[2] = 0), i);
  }),
  ...
  (mat4.multiply = function (t, e, i) {
    ...
    return (
      ...
      (i[8] = C * s + A * o + k * u + E * g),
      (i[9] = C * n + A * h + k * p + E * m),
      (i[10] = C * r + A * c + k * d + E * y),
      (i[11] = C * a + A * l + k * f + E * t),
      (i[12] = P * s + I * o + R * u + e * g),
      (i[13] = P * n + I * h + R * p + e * m),
      (i[14] = P * r + I * c + R * d + e * y),
      (i[15] = P * a + I * l + R * f + e * t),
      i
    );
  }),
  ...
  (mat4.translate = function (t, e, i) {
    ...
    return i && t !== i
      ? ((s = t[0]),
        ...
        (i[10] = d),
        (i[11] = f),
        (i[12] = s * g + o * m + u * e + t[12]),
        (i[13] = n * g + h * m + p * e + t[13]),
        (i[14] = r * g + c * m + d * e + t[14]),
        (i[15] = a * g + l * m + f * e + t[15]),
        i)
      : ((t[12] = t[0] * g + t[4] * m + t[8] * e + t[12]),
        (t[13] = t[1] * g + t[5] * m + t[9] * e + t[13]),
        (t[14] = t[2] * g + t[6] * m + t[10] * e + t[14]),
        (t[15] = t[3] * g + t[7] * m + t[11] * e + t[15]),
        t);
  }),
  ...
  (mat4.rotate = function (t, e, i, s) {
    var n,
      ...
      O = i[1],
      i = i[2],
      C = Math.sqrt(S * S + O * O + i * i);
    return C
      ? (1 !== C && ((C = 1 / C), (S *= C), (O *= C), (i *= C)),
        (n = Math.sin(e)),
        (r = Math.cos(e)),
        (a = 1 - r),
        (e = t[0]),
    ...
    return (
      ...
      p === e[0] && d === i && t === c
        ...
        : ((i = p - e[0]),
          ...
          (n = n * i - r * l),
          (r = r * c - a * i),
          (u = Math.sqrt(e * e + n * n + r * r))
            ? ((u = 1 / u), (e *= u), (n *= u), (r *= u))
            : (r = n = e = 0),
          (a = c * r - l * n),
          (o = l * e - i * r),
          (h = i * n - c * e),
          (u = Math.sqrt(a * a + o * o + h * h))
            ? ((u = 1 / u), (a *= u), (o *= u), (h *= u))
            : (h = o = a = 0),
          (s[0] = e),
          (s[1] = a),
  ...
  (quat4.slerp = function (t, e, i, s) {
    ...
    var n,
      r,
      a = t[0] * e[0] + t[1] * e[1] + t[2] * e[2] + t[3] * e[3];
    return Math.abs(a) >= 1
      ? (s !== t &&
  ...
  (function () {
    ...
    (t.prototype.initState = function () {
      ...
      for (
        this.lastOpacity = 1,
          ...
          this.enableFrontToBack
            ? (i.enable(i.DEPTH_TEST), i.depthFunc(i.LEQUAL))
          ...
          this.vertexData = new Float32Array(
            n * (this.enableFrontToBack ? 3 : 2)
          ),
          this.texcoordData = new Float32Array(2 * n),
          this.pointData = new Float32Array(4 * a),
          ...
          this.vertexBuffers = new Array(o),
          this.texcoordBuffers = new Array(o),
          t = 0;
        t < o;
        t++
      )
        (this.vertexBuffers[t] = i.createBuffer()),
          i.bindBuffer(i.ARRAY_BUFFER, this.vertexBuffers[t]),
          i.bufferData(
            i.ARRAY_BUFFER,
            this.vertexData.byteLength,
            i.DYNAMIC_DRAW
          ),
          (this.texcoordBuffers[t] = i.createBuffer()),
          i.bindBuffer(i.ARRAY_BUFFER, this.texcoordBuffers[t]),
          i.bufferData(
            i.ARRAY_BUFFER,
      ...
      var u = this.createShaderProgram({ src: c }, l, "<default>");
      ...
      (u = this.createShaderProgram({ src: c }, p, "<point>")),
        this.shaderPrograms.push(u),
        (c = [
          "varying mediump vec2 vTex;",
          "uniform lowp sampler2D samplerFront;",
      ...
      var u = this.createShaderProgram({ src: c }, l, "<earlyz>");
      this.shaderPrograms.push(u),
        (c = [
      ...
      var u = this.createShaderProgram({ src: c }, l, "<fill>");
      this.shaderPrograms.push(u);
      for (var d in cr.shaders)
        cr.shaders.hasOwnProperty(d) &&
          this.shaderPrograms.push(
            this.createShaderProgram(cr.shaders[d], l, d)
          );
      i.activeTexture(i.TEXTURE0),
        ...
        this.enableFrontToBack && (this.depthBuffer = i.createRenderbuffer()),
        (this.tmpVec3 = vec3.create([0, 0, 0]));
      var f = i.getParameter(i.ALIASED_POINT_SIZE_RANGE);
      (this.minPointSize = f[0]),
        (this.maxPointSize = f[1]),
      ...
      (t.prototype.createShaderProgram = function (t, i, s) {
        ...
        if (
          (n.shaderSource(r, t.src),
          n.compileShader(r),
          !n.getShaderParameter(r, n.COMPILE_STATUS))
        )
          return n.deleteShader(r), null;
        ...
        if (
          ...
          return n.deleteShader(r), n.deleteShader(a), null;
        ...
        if (
          ...
          return n.deleteShader(r), n.deleteShader(a), n.deleteProgram(o), null;
        n.useProgram(o), n.deleteShader(r), n.deleteShader(a);
        var h = new e(n, o, s);
        (h.extendBoxHorizontal = t.extendBoxHorizontal || 0),
          (h.extendBoxVertical = t.extendBoxVertical || 0),
          (h.crossSampling = !!t.crossSampling),
          (h.preservesOpaqueness = !!t.preservesOpaqueness),
          (h.animated = !!t.animated),
          (h.parameters = t.parameters || []);
        var c, l;
        for (c = 0, l = h.parameters.length; c < l; c++)
          (h.parameters[c][1] = n.getUniformLocation(o, h.parameters[c][0])),
            h.lastCustomParams.push(0),
            n.uniform1f(h.parameters[c][1], 0);
        return cr.seal(h), h;
      }),
      ...
      (t.prototype.setSize = function (t, e, i) {
        if (this.width !== t || this.height !== e || i) {
          ...
          if (
            ...
            this.project(0, 0, n),
              this.project(1, 1, r),
              (this.worldScale[0] = 1 / (r[0] - n[0])),
              (this.worldScale[1] = -1 / (r[1] - n[1]));
          }
          var a, o, h;
          for (a = 0, o = this.shaderPrograms.length; a < o; a++)
            (h = this.shaderPrograms[a]),
              (h.hasCurrentMatMV = !1),
              h.locMatP &&
                (s.useProgram(h.shaderProgram),
                s.uniformMatrix4fv(h.locMatP, !1, this.matP));
          s.useProgram(this.shaderPrograms[this.lastProgram].shaderProgram),
            ...
            (this.lastTexture1 = null),
            this.depthBuffer &&
              (s.bindFramebuffer(s.FRAMEBUFFER, this.fbo),
              s.bindRenderbuffer(s.RENDERBUFFER, this.depthBuffer),
      ...
      (s.prototype.doSetOpacity = function () {
        ...
        i.locOpacity &&
          i.lpOpacity !== t &&
          ((i.lpOpacity = t), this.gl.uniform1f(i.locOpacity, t));
      }),
      ...
      (s.prototype.doUpdateModelView = function () {
        var t,
          e,
          i,
          s = this.glwrap.shaderPrograms,
          n = this.glwrap.currentProgram;
        for (t = 0, e = s.length; t < e; t++)
          (i = s[t]),
            t === n && i.locMatMV
              ? (i.updateMatMV(this.mat4param), (i.hasCurrentMatMV = !0))
              : (i.hasCurrentMatMV = !1);
      ...
      (s.prototype.doSetProgramParameters = function () {
        ...
        if (
          (i.locPixelWidth &&
            a !== i.lpPixelWidth &&
            ((i.lpPixelWidth = a), s.uniform1f(i.locPixelWidth, a)),
          (a = n[1]),
          i.locPixelHeight &&
            a !== i.lpPixelHeight &&
            ((i.lpPixelHeight = a), s.uniform1f(i.locPixelHeight, a)),
          (a = n[2]),
          (r = n[3]),
          !i.locDestStart ||
            (a === i.lpDestStartX && r === i.lpDestStartY) ||
            ((i.lpDestStartX = a),
            (i.lpDestStartY = r),
            s.uniform2f(i.locDestStart, a, r)),
          (a = n[4]),
          (r = n[5]),
          !i.locDestEnd ||
            (a === i.lpDestEndX && r === i.lpDestEndY) ||
            ((i.lpDestEndX = a),
            (i.lpDestEndY = r),
            s.uniform2f(i.locDestEnd, a, r)),
          (a = n[6]),
          i.locLayerScale &&
            a !== i.lpLayerScale &&
            ((i.lpLayerScale = a), s.uniform1f(i.locLayerScale, a)),
          (a = n[7]),
          i.locLayerAngle &&
            a !== i.lpLayerAngle &&
            ((i.lpLayerAngle = a), s.uniform1f(i.locLayerAngle, a)),
          (a = n[8]),
          (r = n[9]),
          !i.locViewOrigin ||
            (a === i.lpViewOriginX && r === i.lpViewOriginY) ||
            ((i.lpViewOriginX = a),
            (i.lpViewOriginY = r),
            s.uniform2f(i.locViewOrigin, a, r)),
          (a = n[10]),
          (r = n[11]),
          !i.locScrollPos ||
            (a === i.lpScrollPosX && r === i.lpScrollPosY) ||
            ((i.lpScrollPosX = a),
            (i.lpScrollPosY = r),
            s.uniform2f(i.locScrollPos, a, r)),
          (a = n[12]),
          i.locSeconds &&
            a !== i.lpSeconds &&
            ((i.lpSeconds = a), s.uniform1f(i.locSeconds, a)),
          i.parameters.length)
        )
          for (t = 0, e = i.parameters.length; t < e; t++)
            (a = this.shaderParams[t]),
              a !== i.lastCustomParams[t] &&
                ((i.lastCustomParams[t] = a),
                s.uniform1f(i.parameters[t][1], a));
      }),
      (t.prototype.pushBatch = function () {
        return (
          this.batchPtr === this.batch.length &&
            this.batch.push(new s(h, this)),
      ...
      (t.prototype.endBatch = function () {
        if (0 !== this.batchPtr && !this.gl.isContextLost()) {
          ...
          if (
            (this.pointPtr > 0 &&
              ...
              e &&
                e.locAPos >= 0 &&
                "<point>" === e.name &&
                t.vertexAttribPointer(e.locAPos, 4, t.FLOAT, !1, 0, 0)),
            this.vertexPtr > 0)
          ) {
            var e = this.currentShader;
            t.bindBuffer(t.ARRAY_BUFFER, this.vertexBuffers[this.curBuffer]),
              t.bufferSubData(
                t.ARRAY_BUFFER,
                0,
              ...
              e &&
                e.locATex >= 0 &&
                "<point>" !== e.name &&
                t.vertexAttribPointer(e.locATex, 2, t.FLOAT, !1, 0, 0);
          }
          var i, s, n;
          for (i = 0, s = this.batchPtr; i < s; i++)
            switch (((n = this.batch[i]), n.type)) {
              case 1:
                n.doQuad();
                break;
              case 2:
          ...
          (this.batchPtr = 0),
            ...
            (this.isBatchInEarlyZPass = !1),
            this.curBuffer++,
            this.curBuffer >= o && (this.curBuffer = 0);
        }
      }),
    ...
    (t.prototype.quad = function (t, e, i, s, n, r, a, o) {
      this.vertexPtr >= T && this.endBatch();
      ...
      if (this.hasQuadBatchTop) this.batch[this.batchPtr - 1].indexCount += 6;
        ...
        (f.type = c),
          (f.startIndex = this.enableFrontToBack ? h : (h / 2) * 3),
          (f.indexCount = 6),
      ...
      (t.prototype.quadTex = function (t, e, i, s, n, r, a, o, h) {
        ...
        if (this.hasQuadBatchTop) this.batch[this.batchPtr - 1].indexCount += 6;
          ...
          (g.type = c),
            (g.startIndex = this.enableFrontToBack ? l : (l / 2) * 3),
            (g.indexCount = 6),
            (this.hasQuadBatchTop = !0),
            (this.hasPointBatchTop = !1);
        }
      ...
      (t.prototype.quadTexUV = function (
        ...
        if (this.hasQuadBatchTop) this.batch[this.batchPtr - 1].indexCount += 6;
          ...
          (x.type = c),
            (x.startIndex = this.enableFrontToBack ? y : (y / 2) * 3),
            (x.indexCount = 6),
            (this.hasQuadBatchTop = !0),
            (this.hasPointBatchTop = !1);
        }
      ...
      (t.prototype.convexPoly = function (t) {
        ...
        for (e = 0; e < l; e += 2)
          (i = 2 * e),
            ...
            (a = t[i + 5]),
            e === u
              ? this.quad(p, d, s, n, r, a, r, a)
              : ((o = t[i + 6]),
                (h = t[i + 7]),
                this.quad(p, d, s, n, r, a, o, h));
      });
    var S = a - 4;
    (t.prototype.point = function (t, e, i, s) {
      this.pointPtr >= S && this.endBatch();
      var n = this.pointPtr,
        r = this.pointData;
      ...
      (t.prototype.setProgramParameters = function (
        ...
        var g,
          ...
          v,
          b,
          w = this.shaderPrograms[this.lastProgram];
        if (w.hasAnyOptionalUniforms || f.length) {
          if (
            ((y = this.pushBatch()),
            (y.type = _),
            y.mat4param
              ? mat4.set(this.matMV, y.mat4param)
              : (y.mat4param = mat4.create()),
            (v = y.mat4param),
            (v[0] = e),
            (v[1] = i),
            (v[2] = s),
            ...
            (v[11] = p),
            (v[12] = d),
            w.locSamplerBack ? (y.texParam = t) : (y.texParam = null),
            f.length)
          )
            for (
              b = y.shaderParams, b.length = f.length, g = 0, m = f.length;
              g < m;
              g++
            )
              b[g] = f[g];
    ...
    (t.prototype.loadTexture = function (t, e, i, s, n, r) {
      ...
      var a = t.src + "," + e + "," + i + (e ? "," + n : ""),
        o = null;
      if ("undefined" != typeof t.src && C.hasOwnProperty(a))
        return (o = C[a]), o.c2refcount++, o;
      this.endBatch();
      var h = this.gl,
      ...
      if (!c && e) {
        ...
        (d.width = cr.nextHighestPowerOfTwo(t.width)),
          (d.height = cr.nextHighestPowerOfTwo(t.height));
        var f = d.getContext("2d");
        (f.webkitImageSmoothingEnabled = i),
          (f.mozImageSmoothingEnabled = i),
          (f.msImageSmoothingEnabled = i),
          (f.imageSmoothingEnabled = i),
          f.drawImage(t, 0, 0, t.width, t.height, 0, 0, d.width, d.height),
          h.texImage2D(h.TEXTURE_2D, 0, l, u, p, d);
      ...
      (t.prototype.deleteTexture = function (t) {
        if (t) {
          if ("undefined" != typeof t.c2refcount && t.c2refcount > 1)
            return void t.c2refcount--;
          this.endBatch(),
            t === this.lastTexture0 &&
            ...
            t === this.lastTexture1 &&
              ...
              (this.lastTexture1 = null)),
            cr.arrayFindRemove(O, t),
            "undefined" != typeof t.c2texkey && delete C[t.c2texkey],
      ...
      (t.prototype.estimateVRAM = function () {
        var t,
          e,
          i,
          s = this.width * this.height * 4 * 2;
        for (t = 0, e = O.length; t < e; t++)
          (i = O[t]), (s += i.c2width * i.c2height * 4);
        return s;
      }),
  ...
  (function () {
    function t(t) {
      if (t && (t.getContext || t.dc) && !t.c2runtime) {
        ...
        (this.isCrosswalk =
          ...
          (this.isAppMobi =
            "undefined" != typeof window.AppMobi || this.isDirectCanvas),
          ...
          (this.isArcade = "undefined" != typeof window.is_scirra_arcade),
          (this.isWindows8App = !(
      ...
      try {
        ...
        (n.onupgradeneeded = a),
          ...
          (n.onsuccess = function (n) {
            ...
            r.onerror = s;
            var a = r.transaction(["saves"], "readwrite"),
              o = a.objectStore("saves"),
              h = o.put({ slot: t, data: e });
            h.onsuccess = i;
          });
      } catch (t) {
        s(t);
    ...
    function c() {
      cr.logexport("Reloading for continuous preview"),
        window.c2cocoonjs
          ? CocoonJS.App.reload()
          : window.location.search.indexOf("continuous") > -1
    ...
    (t.prototype.requestProjectData = function () {
      ...
      (this.isWindows8App ||
        ...
        t.open("GET", i, !0);
      var s = !1;
      if (!this.isDomFree && "response" in t && "responseType" in t)
        try {
          (t.responseType = "json"), (s = "json" === t.responseType);
        } catch (t) {
          s = !1;
        }
      if (!s && "responseType" in t)
        try {
          t.responseType = "text";
        } catch (t) {}
      if ("overrideMimeType" in t)
        try {
      ...
      (t.prototype.initRendererAndLoader = function () {
        ...
        try {
          this.enableWebGL &&
            ...
            (this.gl =
              this.canvas.getContext("webgl", u) ||
              this.canvas.getContext("experimental-webgl", u)));
        } catch (t) {}
        if (this.gl) {
          var d = this.gl.getExtension("WEBGL_debug_renderer_info");
          if (d) {
          ...
          for (
            this.enableFrontToBack &&
              ...
              this.canvas.addEventListener(
                ...
                function (t) {
                  l.glwrap.initState(),
                    l.glwrap.setSize(l.glwrap.width, l.glwrap.height, !0),
                    (l.layer_tex = null),
                    (l.layout_tex = null),
                    (l.fx_tex[0] = null),
                    (l.fx_tex[1] = null),
            ...
            for (
              a = this.types_by_index[t], i = 0, s = a.effect_types.length;
              i < s;
              i++
            )
              (o = a.effect_types[i]),
                (o.shaderindex = this.glwrap.getShaderIndex(o.id)),
                (o.preservesOpaqueness = this.glwrap.programPreservesOpaqueness(
                  o.shaderindex
                )),
                (this.uses_background_blending =
                  this.uses_background_blending ||
                  this.glwrap.programUsesDest(o.shaderindex));
          for (t = 0, e = this.layouts_by_index.length; t < e; t++) {
            for (
              h = this.layouts_by_index[t], i = 0, s = h.effect_types.length;
              i < s;
              i++
            )
              (o = h.effect_types[i]),
            ...
            for (
              ...
              for (
                c = h.layers[i], n = 0, r = c.effect_types.length;
                n < r;
                n++
              )
                (o = c.effect_types[n]),
                  ...
                  (o.preservesOpaqueness =
                    this.glwrap.programPreservesOpaqueness(o.shaderindex)),
                  (this.uses_background_blending =
                    this.uses_background_blending ||
                    this.glwrap.programUsesDest(o.shaderindex));
          ...
          this.ctx ||
            (this.isCocoonJs
              ? ((u = { antialias: !!this.linearSampling, alpha: p }),
                (this.ctx = this.canvas.getContext("2d", u)))
              : ((u = { alpha: p }),
                (this.ctx = this.canvas.getContext("2d", u))),
        ...
        if (
          ...
          window.navigator.pointerEnabled
            ...
            ? document.addEventListener("MSPointerDown", m)
    ...
    (t.prototype.setSize = function (t, e, i) {
      ...
      if (
        ...
        if (p || 0 !== this.fullscreen_mode || i) {
          ...
          u >= 4
            ? ((c = this.original_width / this.original_height),
              (l = t / e),
              l > c
                ? ((r = e * c),
                  5 === u
                    ? ((o = (r * d) / this.original_width),
                      o > 1
                        ? (o = Math.floor(o))
                        : o < 1 && (o = 1 / Math.ceil(1 / o)),
                      (r = (this.original_width * o) / d),
                      (a = (this.original_height * o) / d),
                      (s = (t - r) / 2),
                      (n = (e - a) / 2),
                      (t = r),
                      (e = a))
                ...
                : ((a = t / c),
                  5 === u
                    ? ((o = (a * d) / this.original_height),
                      ...
                      (e = a))
                    : ((n = (e - a) / 2), (e = a))),
              p && !this.isNWjs && ((s = 0), (n = 0)))
            : this.isNWjs &&
              this.isNodeFullscreen &&
              0 === this.fullscreen_mode_set &&
              ((s = Math.floor((t - this.original_width) / 2)),
              (n = Math.floor((e - this.original_height) / 2)),
              (t = this.original_width),
              (e = this.original_height)),
            u < 2 && (this.aspect_scale = d),
            this.isRetina &&
              this.isiPad &&
              d > 1 &&
              (t >= 1024 && (t = 1023), e >= 1024 && (e = 1023)),
            (this.cssWidth = Math.round(t)),
            (this.cssHeight = Math.round(e)),
            (this.width = Math.round(t * d)),
            ...
            this.wantFullscreenScalingQuality
              ...
              : ((this.draw_width = this.original_width),
                ...
                2 === u
                  ? ((c = this.original_width / this.original_height),
                    (l = this.lastWindowWidth / this.lastWindowHeight),
                    l < c
                      ? (this.draw_width = this.draw_height * l)
                      : l > c && (this.draw_height = this.draw_width / l))
                  : 3 === u &&
                    ((c = this.original_width / this.original_height),
                    (l = this.lastWindowWidth / this.lastWindowHeight),
                    l > c
            ...
            this.canvas &&
              ((this.canvas.width = Math.round(t * d)),
              (this.canvas.height = Math.round(e * d)),
              this.isEjecta
                ? ((this.canvas.style.left = Math.floor(s) + "px"),
                ...
                : this.isRetina &&
                  ...
                  (this.canvas.style.height = Math.round(e) + "px"))),
            this.overlay_canvas &&
              ((this.overlay_canvas.width = Math.round(t * d)),
              (this.overlay_canvas.height = Math.round(e * d)),
              (this.overlay_canvas.style.width = this.cssWidth + "px"),
              (this.overlay_canvas.style.height = this.cssHeight + "px")),
            this.glwrap &&
              this.glwrap.setSize(Math.round(t * d), Math.round(e * d)),
            this.isDirectCanvas &&
              this.ctx &&
      ...
      (t.prototype.onContextLost = function () {
        ...
        for (t = 0, e = this.types_by_index.length; t < e; t++)
          (i = this.types_by_index[t]),
            i.onLostWebGLContext && i.onLostWebGLContext();
      }),
      (t.prototype.onContextRestored = function () {
        ...
        for (t = 0, e = this.types_by_index.length; t < e; t++)
          (i = this.types_by_index[t]),
            i.onRestoreWebGLContext && i.onRestoreWebGLContext();
      }),
    ...
    (t.prototype.setSuspended = function (t) {
      ...
      if (t && !this.isSuspended)
        for (
          cr.logexport("[Construct 2] Suspending"),
            this.isSuspended = !0,
            this.raf_id !== -1 && p && p(this.raf_id),
            this.timeout_id !== -1 && clearTimeout(this.timeout_id),
            e = 0,
          ...
          this.isiOS &&
            window.setTimeout(function () {
              s.setSize(
                ...
                window.setTimeout(function () {
                  s.setSize(window.innerWidth, window.innerHeight, !0);
                }, 100);
            }, 100);
      }
    }),
      ...
      (t.prototype.loadProject = function (t) {
        ...
        if (
          ...
          (this.fullscreen_mode = e[12]),
          (this.fullscreen_mode_set = e[12]),
          (this.original_width = e[10]),
          (this.original_height = e[11]),
          ...
          (this.uses_loader_layout = e[18]),
          (this.loaderstyle = e[19]),
          0 === this.loaderstyle)
        ) {
          var i = new Image();
          (i.crossOrigin = "anonymous"),
            (i.src = "loading-logo.png"),
            (this.loaderlogos = { logo: i });
        ...
        var g, m, y, _, v, b, w, x, T, S, O, C, A;
        for (g = 0, m = e[2].length; g < m; g++)
          (w = e[2][g]),
            (O = this.GetObjectReference(w[0])),
            cr.add_common_aces(w, O.prototype),
            (C = new O(this)),
            (C.singleglobal = w[1]),
            (C.is_world = w[2]),
            (C.must_predraw = w[9]),
            ...
            this.plugins.push(C);
        for (
          this.objectRefTable = cr.getObjectRefTable(), g = 0, m = e[3].length;
          g < m;
          g++
        ) {
          for (
            w = e[3][g],
              A = this.GetObjectReference(w[1]),
              C = null,
              y = 0,
              _ = this.plugins.length;
            y < _;
            y++
          )
            if (this.plugins[y] instanceof A) {
              C = this.plugins[y];
              break;
            }
          var k = new C.Type(C);
          for (
            k.name = w[0],
              k.is_family = w[2],
              k.instvar_sids = w[3].slice(0),
              k.vars_count = w[3].length,
              k.behs_count = w[4],
              k.fx_count = w[5],
              k.sid = w[11],
              k.is_family
              ...
              k.container = null,
              w[6]
                ? ((k.texture_file = w[6][0]),
                  (k.texture_filesize = w[6][1]),
                  (k.texture_pixelformat = w[6][2]))
                : ((k.texture_file = null),
                  (k.texture_filesize = 0),
                  (k.texture_pixelformat = 0)),
              w[7] ? (k.animations = w[7]) : (k.animations = null),
              k.index = g,
              k.instances = [],
              k.deadCache = [],
              ...
              k.collision_grid = new cr.SparseGrid(
                this.original_width,
            ...
            P ||
              ...
              cr.behaviors.solid &&
                P instanceof cr.behaviors.solid &&
                (this.solidBehavior = P),
              cr.behaviors.jumpthru &&
                P instanceof cr.behaviors.jumpthru &&
                (this.jumpthruBehavior = P),
              cr.behaviors.shadowcaster &&
                P instanceof cr.behaviors.shadowcaster &&
                (this.shadowcasterBehavior = P)),
              P.my_types.indexOf(k) === -1 && P.my_types.push(k);
          ...
          if (
            ((k.tile_poly_data = w[13]),
            (this.uses_loader_layout &&
              !k.is_family &&
              !k.isOnLoaderLayout &&
              C.is_world) ||
              (k.onCreate(), cr.seal(k)),
            k.name && (this.types[k.name] = k),
            this.types_by_index.push(k),
            C.singleglobal)
          ) {
            var R = new C.Instance(k);
            (R.uid = this.next_uid++),
              (R.puid = this.next_puid++),
              (R.iid = 0),
              (R.get_iid = cr.inst_get_iid),
              (R.toString = cr.inst_toString),
              (R.properties = w[14]),
              R.onCreate(),
              cr.seal(R),
              k.instances.push(R),
        ...
        for (g = 0, m = e[4].length; g < m; g++) {
          ...
          for (y = 1, _ = L.length; y < _; y++)
            (M = this.types_by_index[L[y]]),
              M.families.push(F),
              F.members.push(M);
        }
        for (g = 0, m = e[28].length; g < m; g++) {
          ...
          for (y = 0, _ = B.length; y < _; y++)
            N.push(this.types_by_index[B[y]]);
          for (y = 0, _ = N.length; y < _; y++)
            (N[y].is_contained = !0), (N[y].container = N);
        }
        if (this.family_count > 0)
          for (g = 0, m = this.types_by_index.length; g < m; g++)
            if (
              ((T = this.types_by_index[g]), !T.is_family && T.families.length)
            ) {
              ...
              var j = [],
                ...
                W = 0,
                G = 0;
              for (y = 0, _ = T.families.length; y < _; y++)
                for (
                  S = T.families[y],
                    T.family_var_map[S.family_index] = D,
                    D += S.vars_count,
                    T.family_beh_map[S.family_index] = W,
                    W += S.behs_count,
                    T.family_fx_map[S.family_index] = G,
                    G += S.fx_count,
                    v = 0,
                    b = S.effect_types.length;
                  v < b;
                  v++
                )
                  j.push(cr.shallowCopy({}, S.effect_types[v]));
              for (
                T.effect_types = j.concat(T.effect_types),
                  y = 0,
                  _ = T.effect_types.length;
                y < _;
                y++
              )
                T.effect_types[y].index = y;
            }
        for (g = 0, m = e[5].length; g < m; g++) {
          w = e[5][g];
          var z = new cr.layout(this, w);
          cr.seal(z), (this.layouts[z.name] = z), this.layouts_by_index.push(z);
        }
        for (g = 0, m = e[6].length; g < m; g++) {
          w = e[6][g];
          var V = new cr.eventsheet(this, w);
          cr.seal(V),
            (this.eventsheets[V.name] = V),
            this.eventsheets_by_index.push(V);
        }
        for (g = 0, m = this.eventsheets_by_index.length; g < m; g++)
          this.eventsheets_by_index[g].postInit();
        for (g = 0, m = this.eventsheets_by_index.length; g < m; g++)
          this.eventsheets_by_index[g].updateDeepIncludes();
        for (g = 0, m = this.triggers_to_postinit.length; g < m; g++)
          this.triggers_to_postinit[g].postInit();
        cr.clearArray(this.triggers_to_postinit),
          (this.audio_to_preload = e[7]),
          (this.files_subfolder = e[8]),
          (this.pixel_rounding = e[9]),
          (this.aspect_scale = 1),
          (this.enableWebGL = e[13]),
          (this.linearSampling = e[14]),
          (this.alphaBackground = e[15]),
          (this.versionstr = e[16]),
          (this.useHighDpi = e[17]),
          (this.orientations = e[20]),
          (this.autoLockOrientation = this.orientations > 0),
          (this.pauseOnBlur = e[22]),
          (this.wantFullscreenScalingQuality = e[23]),
          (this.fullscreenScalingQuality = this.wantFullscreenScalingQuality),
          (this.downscalingQuality = e[24]),
          (this.preloadSounds = e[25]),
          (this.projectName = e[26]),
          (this.enableFrontToBack = e[27] && !this.isIE),
      ...
      (t.cocoonLazyLoad = !0),
        (t.onerror = function (e) {
          (t.c2error = !0),
            ...
            console &&
              console.error &&
              console.error("Error loading image '" + t.src + "': ", e);
        }),
        this.isEjecta
          ? (t.src = e)
          : t.src ||
    ...
    (t.prototype.getready = function () {
      this.audioInstance &&
        (f = this.audioInstance.setPreloadList(this.audio_to_preload));
    }),
      (t.prototype.areAllTexturesAndSoundsLoaded = function () {
        ...
        for (t = 0, e = this.wait_for_textures.length; t < e; t++) {
          ...
          (!o || o <= 0) && (o = 5e4),
            (s += o),
            i.src && (i.complete || i.loaded) && !i.c2error
              ? (n += o)
              : (a = !1);
        }
        return (
          a &&
            this.preloadSounds &&
            this.audioInstance &&
            (g || (this.audioInstance.startPreloads(), (g = !0)),
            (r = this.audioInstance.getPreloadedSize()),
            (n += r),
            r < f && (a = !1)),
          0 == s ? (this.progress = 1) : (this.progress = n / s),
          a
        );
      });
    var m = !1;
        ...
        if (
          ...
          if (t) {
            ...
            if (
              this.loaderstyle < 3 &&
              (this.isCocoonJs ||
                (i >= 500 && this.last_progress != this.progress))
            ) {
              t.clearRect(0, 0, s, n);
              var a,
                o = s / 2,
              ...
              if (c) {
                ...
                (f = g.width * r),
                  ...
                  (l = f / 2),
                  (p = a / 2),
                  t.drawImage(g, cr.floor(o - l), cr.floor(h - p), f, a);
              }
              if (this.loaderstyle <= 1)
                (h += p + (c ? 12 * r : 0)),
                  ...
                  (o = cr.floor(o) + 0.5),
                  (h = cr.floor(h) + 0.5),
                  (t.fillStyle = d ? "red" : "DodgerBlue"),
                  t.fillRect(o, h, Math.floor(f * this.progress), 6 * r),
                  (t.strokeStyle = "black"),
                  t.strokeRect(o, h, f, 6 * r),
                  (t.strokeStyle = "white"),
                  t.strokeRect(o - 1 * r, h - 1 * r, f + 2 * r, 8 * r);
              else if (2 === this.loaderstyle) {
                (t.font = this.isEjecta ? "12pt ArialMT" : "12pt Arial"),
                  (t.fillStyle = d ? "#f00" : "#999"),
                  (t.textBaseLine = "middle");
                var y = Math.round(100 * this.progress) + "%",
                  _ = t.measureText ? t.measureText(y) : null,
                  v = _ ? _.width : 0;
                t.fillText(y, o - v / 2, h);
              }
    ...
    (t.prototype.draw_c2_splash_loader = function (t) {
      if (!m) {
        for (
          var s = Math.ceil(this.width),
            n = Math.ceil(this.height),
            r = (this.devicePixelRatio, this.loaderlogos.logo),
            a = this.loaderlogos.powered,
            o = this.loaderlogos.website,
            h = 0;
          h < 4;
          ++h
        )
          if (!r[h].complete || !a[h].complete || !o[h].complete) return;
        0 === k && (y = Date.now());
        var c,
          l,
          u = Date.now(),
        ...
        w || x
          ...
          f.fillRect(0, 0, s, n),
          this.cssHeight > 256
            ? ((c = cr.clamp(0.22 * n, 105, 0.6 * s)),
              (l = 0.25 * c),
              f.drawImage(i(a, c), 0.5 * s - c / 2, 0.2 * n - l / 2, c, l),
              (c = Math.min(0.395 * n, 0.95 * s)),
              (l = c),
              f.drawImage(i(r, c), 0.5 * s - c / 2, 0.485 * n - l / 2, c, l),
              (c = cr.clamp(0.22 * n, 105, 0.6 * s)),
              (l = 0.25 * c),
              f.drawImage(i(o, c), 0.5 * s - c / 2, 0.868 * n - l / 2, c, l),
              (f.fillStyle = "#3C3C3C"),
              (c = s),
              (l = Math.max(0.005 * n, 2)),
              f.fillRect(0, 0.8 * n - l / 2, c, l),
              (f.fillStyle = d ? "red" : "#E0FF65"),
              (c = s * this.progress),
              f.fillRect(0.5 * s - c / 2, 0.8 * n - l / 2, c, l))
            : ((c = 0.55 * n),
              (l = c),
              f.drawImage(i(r, c), 0.5 * s - c / 2, 0.45 * n - l / 2, c, l),
              (f.fillStyle = "#3C3C3C"),
              (c = s),
              (l = Math.max(0.005 * n, 2)),
              f.fillRect(0, 0.85 * n - l / 2, c, l),
              (f.fillStyle = d ? "red" : "#E0FF65"),
              (c = s * this.progress),
              f.fillRect(0.5 * s - c / 2, 0.85 * n - l / 2, c, l)),
          p &&
            (w
              ? 0 === k
                ? (t.globalAlpha = 0)
                : (t.globalAlpha = Math.min((u - y) / _, 1))
              : x && (t.globalAlpha = Math.max(1 - (u - S) / v, 0)),
            t.drawImage(C, 0, 0, s, n)),
          w && u - y >= _ && k >= 2 && ((w = !1), (T = u)),
          !w && u - T >= O && !x && this.progress >= 1 && ((x = !0), (S = u)),
          ((x && u - S >= v + b) ||
            ("undefined" != typeof cr_is_preview &&
              this.progress >= 1 &&
              Date.now() - y < 500)) &&
      ...
      (t.prototype.go_loading_finished = function () {
        ...
        for (
          ...
          (i = this.types_by_index[t]), i.onAppBegin && i.onAppBegin();
        document.hidden ||
          ...
          if (i || !this.isSuspended || t) {
            ...
            var r = e || s,
              ...
              o =
                ...
                !this.isCordova;
            if (
              ((o || this.isNodeFullscreen) &&
                this.fullscreen_scaling > 0 &&
                (a = this.fullscreen_scaling),
              a > 0)
            ) {
              var h = window.innerWidth,
                c = window.innerHeight;
              (this.lastWindowWidth === h && this.lastWindowHeight === c) ||
                this.setSize(h, c);
            }
            if (
              (this.isDomFree ||
            ...
            this.logic(r),
              ...
              (this.logictime += cr.performance_now() - n);
          }
        }
      }),
      (t.prototype.logic = function (t) {
        var e, i, s, n, r, a, o, h, c;
        if (
          (t - this.last_fps_time >= 1e3 &&
        ...
        for (e = 0, i = this.types_by_index.length; e < i; e++)
          if (
            ...
            !o.is_family && (o.behaviors.length || o.families.length))
          )
            for (s = 0, n = o.instances.length; s < n; s++)
              for (
                h = o.instances[s], r = 0, a = h.behavior_insts.length;
                r < a;
                r++
              )
                h.behavior_insts[r].tick();
        for (e = 0, i = this.types_by_index.length; e < i; e++)
          if (
            ((o = this.types_by_index[e]),
            !o.is_family && (o.behaviors.length || o.families.length))
            ...
            for (s = 0, n = o.instances.length; s < n; s++)
              for (
                ...
                (c = h.behavior_insts[r]), c.posttick && c.posttick();
        for (
          g = this.objects_to_tick.valuesRef(), e = 0, i = g.length;
          e < i;
          e++
        )
          g[e].tick();
        for (
          this.isInOnDestroy--, this.handleSaveLoad(), e = 0;
          this.changelayout && e++ < 10;

        )
          this.doChangeLayout(this.changelayout);
        for (e = 0, i = this.eventsheets_by_index.length; e < i; e++)
        ...
        for (
          ...
          if (
            ...
            for (s = 0, n = o.instances.length; s < n; s++) {
              var h = o.instances[s];
              for (r = 0, a = h.behavior_insts.length; r < a; r++)
                (c = h.behavior_insts[r]), c.tick2 && c.tick2();
            }
        for (
          g = this.objects_to_tick2.valuesRef(), e = 0, i = g.length;
          e < i;
          e++
        )
          g[e].tick2();
        ...
        for (t = 0, e = this.types_by_index.length; t < e; t++)
          if (((a = this.types_by_index[t]), !a.is_family))
            for (i = 0, s = a.instances.length; i < s; i++)
              if (
                ((o = a.instances[i]),
                o.onWindowBlur && o.onWindowBlur(),
                o.behavior_insts)
              )
                for (n = 0, r = o.behavior_insts.length; n < r; n++)
                  (h = o.behavior_insts[n]), h.onWindowBlur && h.onWindowBlur();
      }),
      (t.prototype.doChangeLayout = function (t) {
        var e = this.running_layout;
        this.running_layout.stopRunning();
        var i, s, n, r, a, o, h, c, l;
        if (this.glwrap)
          for (i = 0, s = this.types_by_index.length; i < s; i++)
            (h = this.types_by_index[i]),
              h.is_family ||
                !h.unloadTextures ||
                (h.global && 0 !== h.instances.length) ||
                t.initial_types.indexOf(h) !== -1 ||
                h.unloadTextures();
        for (
          e == t && cr.clearArray(this.system.waits),
            cr.clearArray(this.registered_collisions),
            t.startRunning(),
            i = 0,
            s = this.types_by_index.length;
          i < s;
          i++
        )
          if (((h = this.types_by_index[i]), h.global || h.plugin.singleglobal))
            for (n = 0, r = h.instances.length; n < r; n++)
              if (
                ((c = h.instances[n]),
                c.onLayoutChange && c.onLayoutChange(),
                c.behavior_insts)
              )
                for (a = 0, o = c.behavior_insts.length; a < o; a++)
                  (l = c.behavior_insts[a]),
                    l.onLayoutChange && l.onLayoutChange();
      ...
      (t.prototype.getObjectByUID = function (t) {
        var e = t.toString();
        return this.objectsByUid.hasOwnProperty(e)
          ? this.objectsByUid[e]
          : null;
      });
    var E = [];
    (t.prototype.DestroyInstance = function (t) {
      ...
      (t.prototype.ClearDeathRowForType = function (t) {
        var e,
          ...
          u = l[0].type;
        for (
          cr.arrayRemoveAllFromObjectSet(u.instances, t),
            u.stale_iids = !0,
            0 === u.instances.length && (u.any_instance_parallaxed = !1),
            e = 0,
            i = u.families.length;
          e < i;
          ++e
        ...
        for (e = 0, i = this.system.waits.length; e < i; ++e)
          if (
            ((a = this.system.waits[e]),
            a.sols.hasOwnProperty(u.index) &&
              cr.arrayRemoveAllFromObjectSet(a.sols[u.index].insts, t),
            !u.is_family)
          )
            for (s = 0, r = u.families.length; s < r; ++s)
              (o = u.families[s]),
                a.sols.hasOwnProperty(o.index) &&
                  cr.arrayRemoveAllFromObjectSet(a.sols[o.index].insts, t);
        var p = l[0].layer;
        if (p) {
          if (p.useRenderCells)
            for (h = p.instances, e = 0, i = h.length; e < i; ++e)
              (c = h[e]),
                t.contains(c) &&
                  (c.update_bbox(),
                  p.render_grid.update(c, c.rendercells, null),
                  c.rendercells.set(0, 0, -1, -1));
          cr.arrayRemoveAllFromObjectSet(p.instances, t),
            p.setZIndicesStaleFrom(0);
        }
        for (e = 0; e < l.length; ++e)
          this.ClearDeathRowForSingleInstance(l[e], u);
        n(t), (this.redraw = !0);
      }),
      (t.prototype.ClearDeathRowForSingleInstance = function (t, e) {
        var i, s, n;
        for (i = 0, s = this.destroycallbacks.length; i < s; ++i)
        ...
        if ((r && r.removeFromInstanceList(t, !0), t.behavior_insts))
          for (i = 0, s = t.behavior_insts.length; i < s; ++i)
            (n = t.behavior_insts[i]),
              n.onDestroy && n.onDestroy(),
    ...
    (t.prototype.createInstanceFromInit = function (t, e, i, s, n, r) {
      ...
      for (
        u.deadCache.length
          ? ((f = u.deadCache.pop()),
            (f.recycled = !0),
            u.plugin.Instance.call(f, u))
          : ((f = new u.plugin.Instance(u)), (f.recycled = !1)),
          !i || r || this.objectsByUid.hasOwnProperty(t[2].toString())
            ? (f.uid = this.next_uid++)
            : (f.uid = t[2]),
          this.objectsByUid[f.uid.toString()] = f,
          f.puid = this.next_puid++,
          f.iid = u.instances.length,
          a = 0,
          o = this.createRow.length;
        a < o;
        ++a
      )
        this.createRow[a].type === u && f.iid++;
      ...
      if (f.recycled) cr.wipe(f.extra);
        ...
        if (((f.extra = {}), "undefined" != typeof cr_is_preview))
          for (
            f.instance_var_names = [],
              f.instance_var_names.length = g.length,
              a = 0,
              o = g.length;
            a < o;
            a++
          )
            f.instance_var_names[a] = g[a][1];
      ...
      if (p) {
        var m = t[0];
        if (
          ((f.x = cr.is_undefined(s) ? m[0] : s),
          (f.y = cr.is_undefined(n) ? m[1] : n),
          (f.z = m[2]),
          (f.width = m[3]),
          (f.height = m[4]),
          (f.depth = m[5]),
          ...
          (f.blend_mode = m[10]),
          (l = m[11]),
          !this.glwrap && u.effect_types.length && (f.blend_mode = l),
          (f.compositeOp = cr.effectToCompositeOp(f.blend_mode)),
          this.gl && cr.setGLBlend(f, f.blend_mode, this.gl),
          f.recycled)
        ) {
          for (a = 0, o = m[12].length; a < o; a++)
            for (h = 0, c = m[12][a].length; h < c; h++)
              f.effect_params[a][h] = m[12][a][h];
          f.bbox.set(0, 0, 0, 0),
            f.collcells.set(0, 0, -1, -1),
            f.rendercells.set(0, 0, -1, -1),
            f.bquad.set_from_rect(f.bbox),
            cr.clearArray(f.bbox_changed_callbacks);
        } else {
          for (
            f.effect_params = m[12].slice(0), a = 0, o = f.effect_params.length;
            a < o;
            a++
          )
            f.effect_params[a] = m[12][a].slice(0);
          (f.active_effect_types = []),
            (f.active_effect_flags = []),
            (f.active_effect_flags.length = u.effect_types.length),
            (f.bbox = new cr.rect(0, 0, 0, 0)),
            (f.collcells = new cr.rect(0, 0, -1, -1)),
            (f.rendercells = new cr.rect(0, 0, -1, -1)),
            (f.bquad = new cr.quad()),
            (f.bbox_changed_callbacks = []),
            (f.set_bbox_changed = cr.set_bbox_changed),
            (f.add_bbox_changed_callback = cr.add_bbox_changed_callback),
            (f.contains_pt = cr.inst_contains_pt),
            (f.update_bbox = cr.update_bbox),
            (f.update_render_cell = cr.update_render_cell),
            (f.update_collision_cell = cr.update_collision_cell),
            (f.get_zindex = cr.inst_get_zindex);
        }
        for (
          f.tilemap_exists = !1,
            f.tilemap_width = 0,
            ...
            14 === m.length &&
              ((f.tilemap_exists = !0),
              (f.tilemap_width = m[13][0]),
              (f.tilemap_height = m[13][1]),
              (f.tilemap_data = m[13][2])),
            a = 0,
            o = u.effect_types.length;
          a < o;
          a++
        )
          f.active_effect_flags[a] = !0;
        (f.shaders_preserve_opaqueness = !0),
          (f.updateActiveEffects = cr.inst_updateActiveEffects),
          f.updateActiveEffects(),
          (f.uses_shaders = !!f.active_effect_types.length),
          (f.bbox_changed = !0),
          (f.cell_changed = !0),
          ...
          (f.my_timescale = -1),
          (f.layer = e),
          (f.zindex = e.instances.length),
          (f.earlyz_index = 0),
          "undefined" == typeof f.collision_poly && (f.collision_poly = null),
          (f.collisionsEnabled = !0),
          (this.redraw = !0);
      }
      var y, _;
      for (cr.clearArray(P), a = 0, o = u.families.length; a < o; a++)
        P.push.apply(P, u.families[a].behaviors);
      if ((P.push.apply(P, u.behaviors), f.recycled))
        for (a = 0, o = P.length; a < o; a++) {
          var v = P[a];
          for (
            _ = f.behavior_insts[a],
              _.recycled = !0,
              v.behavior.Instance.call(_, v, f),
              y = t[4][a],
              h = 0,
              c = y.length;
            h < c;
        ...
        for (f.behavior_insts = [], a = 0, o = P.length; a < o; a++) {
          ...
          (_.recycled = !1),
            (_.properties = t[4][a].slice(0)),
            _.onCreate(),
            cr.seal(_),
            f.behavior_insts.push(_),
            v.behavior.my_instances.add(f);
        }
      if (((y = t[5]), f.recycled))
        for (a = 0, o = y.length; a < o; a++) f.properties[a] = y[a];
      else f.properties = y.slice(0);
      if (
        (this.createRow.push(f),
        (this.hasPendingInstances = !0),
        e &&
          (e.appendToInstanceList(f, !0),
        ...
        if (
          ((f.is_contained = !0),
          f.recycled ? cr.clearArray(f.siblings) : (f.siblings = []),
          !i && !r)
        ) {
            ...
            if (u.container[a] !== u) {
              ...
              f.siblings.push(
                this.createInstanceFromInit(
                  u.container[a].default_instance,
                  d,
                  !1,
                  p ? f.x : s,
                  p ? f.y : n,
          ...
          for (a = 0, o = f.siblings.length; a < o; a++)
            for (f.siblings[a].siblings.push(f), h = 0; h < o; h++)
              a !== h && f.siblings[a].siblings.push(f.siblings[h]);
        }
      } else (f.is_contained = !1), (f.siblings = null);
      for (
        f.onCreate(),
          f.recycled || cr.seal(f),
          a = 0,
          o = f.behavior_insts.length;
        a < o;
        a++
      )
        f.behavior_insts[a].postCreate && f.behavior_insts[a].postCreate();
      return f;
    }),
      ...
      (t.prototype.getCollisionCandidates = function (t, e, i, s) {
        var n,
          r,
          a,
          o = !!t && (1 !== t.parallaxX || 1 !== t.parallaxY);
        if (e.is_family)
          for (n = 0, r = e.members.length; n < r; ++n)
            (a = e.members[n]),
              o || a.any_instance_parallaxed
                ? cr.appendArray(s, a.instances)
                : (this.updateAllCells(a), a.collision_grid.queryRange(i, s));
        else
          o || e.any_instance_parallaxed
      ...
      (t.prototype.getSolidCollisionCandidates = function (t, e, i) {
        ...
        return s
          ? void this.getTypesCollisionCandidates(t, s.my_types, e, i)
          : null;
      }),
      ...
      (t.prototype.testAndSelectCanvasPointOverlap = function (t, e, i, s) {
        ...
        if (l.select_all) {
          for (
            s || ((l.select_all = !1), cr.clearArray(l.instances)),
              n = 0,
              o = t.instances.length;
            n < o;
            n++
          )
            if (
          ...
          for (r = 0, n = 0, o = l.instances.length; n < o; n++)
            if (
              ((a = l.instances[n]),
              a.update_bbox(),
              (h = a.layer.canvasToLayer(e, i, !0)),
              ...
              if (s) return !1;
              (l.instances[r] = l.instances[n]), r++;
            }
          s || (l.instances.length = r);
        }
        ...
        if (f) {
          for (
            ...
            (n = 2 * i),
              ...
              (l.pts_cache[r] = p.layerToCanvas(a + t.x, o + t.y, !1));
          for (l.update_bbox(), i = 0, s = u.pts_count; i < s; i++)
            (n = 2 * i),
              ...
              (u.pts_cache[r] = d.layerToCanvas(a + e.x, o + e.y, !1));
    ...
    (t.prototype.testTilemapOverlap = function (t, e) {
      ...
      for (i = 0, s = c.length; i < s; ++i)
        if (
          ((n = c[i]),
          (r = n.rc),
          a.intersects_rect_off(r, o, h) &&
            (I.set_from_rect(r), I.offset(o, h), I.intersects_quad(e.bquad)))
        )
          if (l) {
            if (
              (e.collision_poly.cache_poly(e.width, e.height, e.angle), n.poly)
            ) {
              if (
                n.poly.intersects_poly(
                  e.collision_poly,
                  e.x - (o + r.left),
                  e.y - (h + r.top)
                )
              )
                return cr.clearArray(M), !0;
            } else if (
              (this.temp_poly.set_from_quad(
                I,
                0,
      ...
      (t.prototype.testRectOverlap = function (t, e) {
        ...
        if (e.tilemap_exists) {
          ...
          for (s = 0, n = o.length; s < n; ++s)
            if (((r = o[s]), (a = r.rc), t.intersects_rect_off(a, h, c))) {
              if (!r.poly) return cr.clearArray(M), !0;
              if (
                (this.temp_poly.set_from_rect(t, 0, 0),
                r.poly.intersects_poly(
                  this.temp_poly,
                  -(h + a.left),
                  -(c + a.top)
                ))
        ...
        return (
          I.set_from_rect(t),
          !!e.bquad.intersects_quad(I) &&
            (!(i = e.collision_poly && !e.collision_poly.is_empty()) ||
              (e.collision_poly.cache_poly(e.width, e.height, e.angle),
              I.offset(-t.left, -t.top),
              this.temp_poly.set_from_quad(I, 0, 0, 1, 1),
      ...
      (t.prototype.testSegmentOverlap = function (t, e, i, s, n) {
        ...
        n.layer;
        if (
          (R.set(cr.min(t, i), cr.min(e, s), cr.max(t, i), cr.max(e, s)),
          !n.bbox.intersects_rect(R))
        )
          return !1;
        if (n.tilemap_exists) {
          n.getCollisionRectCandidates(R, M);
          var a,
            o,
            h,
            c,
          ...
          for (a = 0, o = l.length; a < o; ++a)
            if (
              ((h = l[a]),
              (c = h.rc),
              R.intersects_rect_off(c, u, p) &&
                (I.set_from_rect(c),
                I.offset(u, p),
                I.intersects_segment(t, e, i, s)))
            ) {
              if (!h.poly) return cr.clearArray(M), !0;
              if (h.poly.intersects_segment(u + c.left, p + c.top, t, e, i, s))
                return cr.clearArray(M), !0;
            }
          return cr.clearArray(M), !1;
        }
        return (
          ...
          (!(r = n.collision_poly && !n.collision_poly.is_empty()) ||
      ...
      (t.prototype.typeHasBehavior = function (t, e) {
        ...
        if (!t.is_family)
          for (i = 0, s = t.families.length; i < s; i++)
            for (a = t.families[i], n = 0, r = a.behaviors.length; n < r; n++)
    ...
    (t.prototype.testOverlapSolid = function (t) {
      ...
      for (
        t.update_bbox(),
          this.getSolidCollisionCandidates(t.layer, t.bbox, L),
          e = 0,
          i = L.length;
        e < i;
        ++e
      )
        if (((s = L[e]), s.extra.solidEnabled && this.testOverlap(t, s)))
          return cr.clearArray(L), s;
      return cr.clearArray(L), null;
    }),
      (t.prototype.testRectOverlapSolid = function (t) {
        var e, i, s;
        for (
          this.getSolidCollisionCandidates(null, t, L), e = 0, i = L.length;
          e < i;
          ++e
        )
          if (((s = L[e]), s.extra.solidEnabled && this.testRectOverlap(t, s)))
            return cr.clearArray(L), s;
        return cr.clearArray(L), null;
      });
    var F = [];
    (t.prototype.testOverlapJumpThru = function (t, e) {
      var i = null;
      e && ((i = F), cr.clearArray(i)),
        t.update_bbox(),
        this.getJumpthruCollisionCandidates(t.layer, t.bbox, L);
      var s, n, r;
      ...
      (t.prototype.pushOutSolid = function (t, e, i, s, n, r) {
        ...
        for (a = 0; a < o; a++)
          if (
            ...
            (t.y = c + i * a),
            t.set_bbox_changed(),
            !this.testOverlap(t, l) &&
              ((l = this.testOverlapSolid(t)),
              l && (u = l),
              !l &&
                (n &&
                  ((l = r
            ...
            return u && this.pushInFractional(t, e, i, u, 16), !0;
      ...
      (t.prototype.pushInFractional = function (t, e, i, s, n) {
        for (var r, a = 2, o = !1, h = !1, c = t.x, l = t.y; a <= n; )
          (r = 1 / a),
            (a *= 2),
            (t.x += e * r * (o ? 1 : -1)),
            (t.y += i * r * (o ? 1 : -1)),
      ...
      (t.prototype.pushOutSolidNearest = function (t, e) {
        ...
        for (; s <= i; ) {
          ...
          if (
            ...
            (t.y = cr.floor(r + h * s)),
            t.set_bbox_changed(),
            !this.testOverlap(t, c) && ((c = this.testOverlapSolid(t)), !c))
          )
            return !0;
        }
      ...
      (t.prototype.checkRegisteredCollision = function (t, e) {
        ...
        for (i = 0, s = this.registered_collisions.length; i < s; i++)
          if (
            ((n = this.registered_collisions[i]),
            (n[0] == t && n[1] == e) || (n[0] == e && n[1] == t))
          )
            return !0;
        return !1;
      }),
      (t.prototype.calculateSolidBounceAngle = function (t, e, i, s) {
        ...
        if (
          ...
          return p;
        var g,
          m = cr.angleDiff(p, u) / 2;
        g = cr.angleClockwise(p, u)
          ? cr.clamp_angle(u + m + cr.PI)
          : cr.clamp_angle(p + m);
        var y = Math.cos(o),
          _ = Math.sin(o),
          v = Math.cos(g),
    ...
    (t.prototype.trigger = function (t, e, i) {
      ...
      for (r = 0, a = h.length; r < a; ++r)
        (n = this.triggerOnSheet(t, e, h[r], i)), (o = o || n);
      return (n = this.triggerOnSheet(t, e, s, i)), (o = o || n), B--, o;
    }),
      (t.prototype.triggerOnSheet = function (t, e, i, s) {
        ...
        if (e)
          for (
            a = this.triggerOnSheetForTypeName(t, e, e.type.name, i, s),
              h = h || a,
              o = e.type.families,
              n = 0,
              r = o.length;
            ...
            (a = this.triggerOnSheetForTypeName(t, e, o[n].name, i, s)),
              (h = h || a);
        else
          (a = this.triggerOnSheetForTypeName(t, e, "system", i, s)),
            (h = h || a);
        return h;
      }),
      ...
      (t.prototype.getEventVariableByName = function (t, e) {
        for (var i, s, n, r, a, o; e; ) {
          for (i = 0, s = e.subevents.length; i < s; i++)
            if (
              ((o = e.subevents[i]),
              o instanceof cr.eventvariable && cr.equals_nocase(t, o.name))
            )
              return o;
          e = e.parent;
        }
        for (i = 0, s = this.eventsheets_by_index.length; i < s; i++)
          for (
            a = this.eventsheets_by_index[i], n = 0, r = a.events.length;
            n < r;
            n++
          )
            if (
        ...
        if (
          ...
          if (
            ...
            o(
              ...
              function () {
                cr.logexport(
                  "Saved state to IndexedDB storage (" + i.length + " bytes)"
                ),
                  (t.lastSaveJson = i),
                  t.trigger(
              ...
              function (s) {
                try {
                  localStorage.setItem("__c2save_" + e, i),
                    cr.logexport(
                      "Saved state to WebStorage (" + i.length + " bytes)"
                    ),
                    (t.lastSaveJson = i),
                    t.trigger(
                      cr.system_object.prototype.cnds.OnSaveComplete,
                  ...
                  cr.logexport("Failed to save game state: " + s + "; " + t);
                }
              }
            );
          else
        ...
        if (s.length) {
          if (r() && !this.isCocoonJs)
            h(
                  ...
                  ? ((t.loadFromJson = e),
                    cr.logexport(
                      "Loaded state from IndexedDB storage (" +
                        t.loadFromJson.length +
                        " bytes)"
                    ))
                  : ((t.loadFromJson =
                      localStorage.getItem("__c2save_" + s) || ""),
                    cr.logexport(
              ...
              function (e) {
                (t.loadFromJson = localStorage.getItem("__c2save_" + s) || ""),
                  cr.logexport(
                    "Loaded state from WebStorage (" +
                      t.loadFromJson.length +
                      " bytes)"
            ...
            try {
              (this.loadFromJson = localStorage.getItem("__c2save_" + s) || ""),
                cr.logexport(
                  "Loaded state from WebStorage (" +
      ...
      (t.prototype.saveToJSONString = function () {
        ...
        for (t = 0, e = this.types_by_index.length; t < e; t++)
          if (
            ((n = this.types_by_index[t]),
            !n.is_family && !this.typeHasNoSaveBehavior(n))
          ) {
            for (
              a = { instances: [] },
            ...
            d.types[n.sid.toString()] = a;
          }
        for (t = 0, e = this.layouts_by_index.length; t < e; t++)
          (r = this.layouts_by_index[t]),
            (d.layouts[r.sid.toString()] = r.saveToJSON());
        var f = d.events.groups;
        for (t = 0, e = this.allGroups.length; t < e; t++)
          (o = this.allGroups[t]),
            (f[o.sid.toString()] =
        ...
        for (p in this.cndsBySid)
          this.cndsBySid.hasOwnProperty(p) &&
            ((h = this.cndsBySid[p]),
            cr.hasAnyOwnProperty(h.extra) && (g[p] = { ex: l(h.extra) }));
        var m = d.events.acts;
        for (p in this.actsBySid)
          this.actsBySid.hasOwnProperty(p) &&
            ((c = this.actsBySid[p]),
            cr.hasAnyOwnProperty(c.extra) && (m[p] = { ex: l(c.extra) }));
        var y = d.events.vars;
        for (p in this.varsBySid)
          this.varsBySid.hasOwnProperty(p) &&
            ((u = this.varsBySid[p]),
            u.is_constant || (u.parent && !u.is_static) || (y[p] = u.data));
        ...
        if (e.c2save && !(e.version > 1)) {
          ...
          for (u in x)
            if (x.hasOwnProperty(u)) {
              if (
                ((p = this.getObjectTypeBySid(parseInt(u, 10))),
                !p || p.is_family || this.typeHasNoSaveBehavior(p))
              )
                continue;
              for (
                x[u].ex ? (p.extra = x[u].ex) : cr.wipe(p.extra),
                  d = p.instances,
                  f = x[u].instances,
                  r = 0,
                  a = cr.min(d.length, f.length);
                r < a;
                r++
              )
                this.loadInstanceFromJSON(d[r], f[r]);
              for (r = f.length, a = d.length; r < a; r++)
                this.DestroyInstance(d[r]);
              for (r = d.length, a = f.length; r < a; r++)
                (_ = null),
                  (p.plugin.is_world &&
                    !(_ = this.running_layout.getLayerBySid(f[r].w.l))) ||
                    ((g = this.createInstanceFromInit(
                      p.default_instance,
                      _,
                      !1,
                      0,
                    ...
                    this.loadInstanceFromJSON(g, f[r]));
              p.stale_iids = !0;
            }
          ...
          for (u in S)
            S.hasOwnProperty(u) &&
              ((v = this.getGroupBySid(parseInt(u, 10))),
              v &&
                this.groups_by_name[v.group_name] &&
                this.groups_by_name[v.group_name].setGroupActive(S[u]));
          var O = e.events.cnds;
          for (u in this.cndsBySid)
            this.cndsBySid.hasOwnProperty(u) &&
              (O.hasOwnProperty(u)
                ? (this.cndsBySid[u].extra = O[u].ex)
                : (this.cndsBySid[u].extra = {}));
          var C = e.events.acts;
          for (u in this.actsBySid)
            this.actsBySid.hasOwnProperty(u) &&
              (C.hasOwnProperty(u)
                ? (this.actsBySid[u].extra = C[u].ex)
                : (this.actsBySid[u].extra = {}));
          var A = e.events.vars;
          for (u in A)
            A.hasOwnProperty(u) &&
              this.varsBySid.hasOwnProperty(u) &&
              (this.varsBySid[u].data = A[u]);
          for (
            this.next_uid = i.next_uid,
              this.isLoadingState = !1,
              r = 0,
              a = this.fireOnCreateAfterLoad.length;
            r < a;
            ++r
          )
            (g = this.fireOnCreateAfterLoad[r]),
              this.trigger(
                Object.getPrototypeOf(g.type.plugin).cnds.OnCreated,
                g
              );
          for (
            cr.clearArray(this.fireOnCreateAfterLoad),
              ...
              r = 0,
              a = this.types_by_index.length;
            r < a;
            r++
          )
            if (
              ((p = this.types_by_index[r]),
              !p.is_family && !this.typeHasNoSaveBehavior(p))
            )
              for (o = 0, h = p.instances.length; o < h; o++) {
                if (((g = p.instances[o]), p.is_contained))
                  for (
                    b = g.get_iid(),
                      cr.clearArray(g.siblings),
                      c = 0,
                      l = p.container.length;
                    c < l;
                    c++
                  )
                    (w = p.container[c]),
                      p !== w && g.siblings.push(w.instances[b]);
                if ((g.afterLoad && g.afterLoad(), g.behavior_insts))
                  for (c = 0, l = g.behavior_insts.length; c < l; c++)
                    (m = g.behavior_insts[c]), m.afterLoad && m.afterLoad();
              }
          this.redraw = !0;
        }
      }),
      (t.prototype.saveInstanceToJSON = function (t, e) {
        ...
        if (h.is_world) {
          if (
            ...
            t.my_timescale !== -1 && (n.mts = t.my_timescale),
            o.effect_types.length)
          )
            for (n.fx = [], i = 0, s = o.effect_types.length; i < s; i++)
              (a = o.effect_types[i]),
                n.fx.push({
                  name: a.name,
        ...
        if (t.behavior_insts && t.behavior_insts.length)
          for (c.behs = {}, i = 0, s = t.behavior_insts.length; i < s; i++)
            (r = t.behavior_insts[i]),
              r.saveToJSON && (c.behs[r.type.sid.toString()] = r.saveToJSON());
        ...
        if ((e.ex ? (t.extra = e.ex) : cr.wipe(t.extra), (o = e.ivs)))
          for (s in o)
            if (o.hasOwnProperty(s)) {
              if (
                ((a = this.getInstanceVarIndexBySid(d, parseInt(s, 10))),
                a < 0 || a >= t.instance_vars.length)
              )
                continue;
              t.instance_vars[a] = o[s];
            }
        if (f.is_world) {
          if (
            ((h = e.w),
            t.layer.sid !== h.l &&
              ...
              t.layer
                ? (p.removeFromInstanceList(t, !0),
                  t.layer.appendToInstanceList(t, !0),
                  t.set_bbox_changed(),
                  t.layer.setZIndicesStaleFrom(0))
                : ((t.layer = p), i || this.DestroyInstance(t))),
            (t.x = h.x),
            (t.y = h.y),
            (t.width = h.w),
            (t.height = h.h),
            ...
            for (n = 0, r = h.fx.length; n < r; n++)
              (c = d.getEffectIndexByName(h.fx[n].name)),
                c < 0 ||
        ...
        if ((l = e.behs))
          for (s in l)
            if (l.hasOwnProperty(s)) {
              if (((u = this.getBehaviorIndexBySid(t, parseInt(s, 10))), u < 0))
                continue;
  ...
  (function () {
    function t(t, e) {
      ...
      for (this.initial_nonworld = [], i = 0, s = a.length; i < s; i++) {
        ...
        h.default_instance || (h.default_instance = o),
          ...
          this.initial_types.indexOf(h) === -1 && this.initial_types.push(h);
      }
      for (
        this.effect_types = [],
    ...
    function i(t, e) {
      ...
      for (
        ...
        o.default_instance ||
          ((o.default_instance = a), (o.default_layerindex = this.index)),
          this.initial_instances.push(a),
          this.layout.initial_types.indexOf(o) === -1 &&
    ...
    function r(t, e, i) {
      var s,
        ...
        h = t.length,
        c = e.length;
      for (i.length = h + c; r < h && a < c; ++o)
        (s = t[r]),
          (n = e[a]),
          s.zindex < n.zindex ? ((i[o] = s), ++r) : ((i[o] = n), ++a);
      for (; r < h; ++r, ++o) i[o] = t[r];
      for (; a < c; ++a, ++o) i[o] = e[a];
    }
    function a(t, e) {
      var i, a, o, h, c;
      for (i = 0, a = t.length; i < a - 1; i += 2)
        (o = t[i]),
          (h = t[i + 1]),
          (c = s()),
          r(o, h, c),
      ...
      a % 2 === 1 &&
        (e
          ? ((o = s()), cr.shallowAssignArray(o, t[a - 1]), p.push(o))
          : p.push(t[a - 1])),
        cr.shallowAssignArray(t, p),
        cr.clearArray(p);
    }
    function o(t) {
    ...
    (t.prototype.saveObjectToPersist = function (t) {
      ...
      (t.prototype.updateActiveEffects = function () {
        cr.clearArray(this.active_effect_types),
          (this.shaders_preserve_opaqueness = !0);
        var t, e, i;
        for (t = 0, e = this.effect_types.length; t < e; t++)
    ...
    (t.prototype.startRunning = function () {
      this.sheetname &&
        ...
        (this.scrollX = this.runtime.original_width / 2),
        (this.scrollY = this.runtime.original_height / 2);
      var t, i, s, n, r, a, o, l, u, p, d, f, g;
      for (t = 0, s = this.runtime.types_by_index.length; t < s; t++)
        if (((r = this.runtime.types_by_index[t]), !r.is_family))
          for (a = r.instances, i = 0, n = a.length; i < n; i++)
            if (((o = a[i]), o.layer)) {
              var m = o.layer.number;
              m >= this.layers.length && (m = this.layers.length - 1),
                (o.layer = this.layers[m]),
                o.layer.instances.indexOf(o) === -1 &&
                  o.layer.instances.push(o),
                (o.layer.zindices_stale = !0);
            }
      if (!c)
        for (t = 0, s = this.layers.length; t < s; ++t)
          this.layers[t].instances.sort(e);
      var g;
      for (
        cr.clearArray(h), this.boundScrolling(), t = 0, s = this.layers.length;
        t < s;
        t++
      )
        (g = this.layers[t]),
          g.createInitialInstances(),
      ...
      if (!this.first_visit) {
        for (d in this.persist_data)
          if (this.persist_data.hasOwnProperty(d)) {
            if (
              ((r = this.runtime.getObjectTypeBySid(parseInt(d, 10))),
              !r || r.is_family || !this.runtime.typeHasPersistBehavior(r))
            )
              continue;
            for (f = this.persist_data[d], t = 0, s = f.length; t < s; t++)
              (g = null),
                (r.plugin.is_world && !(g = this.getLayerBySid(f[t].w.l))) ||
                  ((o = this.runtime.createInstanceFromInit(
                    r.default_instance,
                    g,
                    !1,
                    0,
                  ...
                  this.runtime.loadInstanceFromJSON(o, f[t]),
                  (y = !0),
                  h.push(o));
            cr.clearArray(f);
          }
      ...
      for (
        ...
        if (((o = h[t]), o.type.is_contained))
          for (l = o.get_iid(), i = 0, n = o.type.container.length; i < n; i++)
            (u = o.type.container[i]),
              o.type !== u &&
                (u.instances.length > l
                  ? o.siblings.push(u.instances[l])
                  : u.default_instance &&
                    ((p = this.runtime.createInstanceFromInit(
                      u.default_instance,
                      o.layer,
                      !0,
                      o.x,
                    ...
                    o.siblings.push(p),
                    h.push(p)));
      for (t = 0, s = this.initial_nonworld.length; t < s; t++)
        o = this.runtime.createInstanceFromInit(
      ...
      if (
        ...
        for (t = 0, s = this.runtime.types_by_index.length; t < s; t++)
          (u = this.runtime.types_by_index[t]),
            !u.is_family &&
              u.instances.length &&
              u.preloadCanvas2D &&
              u.preloadCanvas2D(this.runtime.ctx);
      if (this.runtime.isLoadingState)
        cr.shallowAssignArray(this.runtime.fireOnCreateAfterLoad, h);
      else
      ...
      (t.prototype.createGlobalNonWorlds = function () {
        var t, e, i, s, n, r;
        for (t = 0, e = 0, i = this.initial_nonworld.length; t < i; t++)
          (s = this.initial_nonworld[t]),
            (r = this.runtime.types_by_index[s[1]]),
            r.global
              ? r.is_contained ||
                (n = this.runtime.createInstanceFromInit(s, null, !0))
              : ((this.initial_nonworld[e] = s), e++);
      ...
      (t.prototype.stopRunning = function () {
        ...
        for (t = 0, e = this.layers.length; t < e; t++) {
          for (n = this.layers[t].instances, i = 0, s = n.length; i < s; i++)
            (r = n[i]), r.type.global || this.runtime.DestroyInstance(r);
          this.runtime.ClearDeathRow(),
            cr.clearArray(n),
            (this.layers[t].zindices_stale = !0);
        }
        for (t = 0, e = this.runtime.types_by_index.length; t < e; t++)
          if (
            ((a = this.runtime.types_by_index[t]),
            !(
              a.global ||
              a.plugin.is_world ||
              a.plugin.singleglobal ||
              a.is_family
            ))
          ) {
            for (i = 0, s = a.instances.length; i < s; i++)
    ...
    (t.prototype.recreateInitialObjects = function (t, e, i, s, n) {
      l.set(e, i, s, n);
      var r, a;
      for (r = 0, a = this.layers.length; r < a; r++)
        this.layers[r].recreateInitialObjects(t, l);
    }),
      (t.prototype.draw = function (t) {
        ...
        n &&
          (this.runtime.layout_canvas ||
            ...
            (s = !0)),
          (e = this.runtime.layout_canvas),
          (i = this.runtime.layout_ctx),
          e.width !== this.runtime.draw_width &&
            ((e.width = this.runtime.draw_width), (s = !0)),
          e.height !== this.runtime.draw_height &&
            ((e.height = this.runtime.draw_height), (s = !0)),
          s &&
            ((i.webkitImageSmoothingEnabled = this.runtime.linearSampling),
            (i.mozImageSmoothingEnabled = this.runtime.linearSampling),
            (i.msImageSmoothingEnabled = this.runtime.linearSampling),
        ...
        for (r = 0, a = this.layers.length; r < a; r++)
          (o = this.layers[r]),
            ...
            o.opacity > 0 &&
            11 !== o.blend_mode &&
            (o.instances.length || !o.transparent)
              ? o.draw(i)
              : o.updateViewport(null);
      ...
      (t.prototype.drawGL_earlyZPass = function (t) {
        ...
        var e, i;
        for (e = this.layers.length - 1; e >= 0; --e)
          (i = this.layers[e]),
            i.visible &&
            1 === i.opacity &&
      ...
      (t.prototype.drawGL = function (t) {
        ...
        e
          ...
          this.runtime.alphaBackground &&
            ...
            t.clear(0, 0, 0, 0);
        var i, s, n;
        for (i = 0, s = this.layers.length; i < s; i++)
          (n = this.layers[i]),
            n.visible && n.opacity > 0 && (n.instances.length || !n.transparent)
              ? n.drawGL(t)
            ...
            if (1 === this.active_effect_types.length) {
              ...
              t.switchProgram(this.active_effect_types[0].shaderindex),
                t.setProgramParameters(
                  ...
                  this.effect_params[r]
                ),
                t.programIsAnimated(this.active_effect_types[0].shaderindex) &&
      ...
      (t.prototype.getMinLayerScale = function () {
        var t,
          e,
          i,
          s = this.layers[0].getScale();
        for (t = 1, e = this.layers.length; t < e; t++)
          (i = this.layers[t]),
            (0 === i.parallaxX && 0 === i.parallaxY) ||
              (i.getScale() < s && (s = i.getScale()));
        return s;
      }),
      ...
      (t.prototype.renderEffectChain = function (t, e, i, s) {
        var n = i
            ? i.active_effect_types
            : e
            ? e.active_effect_types
            : this.active_effect_types,
          r = 1,
          a = 0,
          o = 0,
        ...
        if (i) {
          for (u = 0, p = n.length; u < p; u++)
            (L += t.getProgramBoxExtendHorizontal(n[u].shaderindex)),
              (F += t.getProgramBoxExtendVertical(n[u].shaderindex));
          var N = i.bbox;
          if (
            ((C = e.layerToCanvas(N.left, N.top, !0, !0)),
            (k = e.layerToCanvas(N.left, N.top, !1, !0)),
            (P = e.layerToCanvas(N.right, N.bottom, !0, !0)),
            (R = e.layerToCanvas(N.right, N.bottom, !1, !0)),
            0 !== B)
          ) {
            var j = e.layerToCanvas(N.right, N.top, !0, !0),
              D = e.layerToCanvas(N.right, N.top, !1, !0),
              W = e.layerToCanvas(N.left, N.bottom, !0, !0),
              G = e.layerToCanvas(N.left, N.bottom, !1, !0);
            (f = Math.min(C, P, j, W)),
              (P = Math.max(C, P, j, W)),
              (C = f),
              (f = Math.min(k, R, D, G)),
        ...
        t.setAlphaBlend(),
          z &&
            (y[_] ||
              (y[_] = t.createEmptyTexture(b, w, this.runtime.linearSampling)),
            (y[_].c2width === b && y[_].c2height === w) ||
              (t.deleteTexture(y[_]),
              (y[_] = t.createEmptyTexture(b, w, this.runtime.linearSampling))),
            t.switchProgram(0),
            t.setRenderingToTexture(y[_]),
            (m = M - E),
            (g = w - E - m),
            t.clearRect(A, g, I - A, m),
            i
              ? i.drawGL(t)
              : (t.setTexture(this.runtime.layer_tex),
                ...
                t.translate(-x, -T),
                t.updateModelView(),
                t.quadTex(C, R, P, R, P, k, C, k, S)),
            (O.left = O.top = 0),
            (O.right = O.bottom = 1),
            i && ((f = S.top), (S.top = S.bottom), (S.bottom = f)),
            (_ = 1),
            (v = 0)),
          t.setOpacity(1);
        var d = n.length - 1,
          V =
            t.programUsesCrossSampling(n[d].shaderindex) ||
              ...
              : (t.setRenderingToTexture(y[_]),
                ...
                i
                  ...
                  : (t.setProgramParameters(
                      ...
                      (h + l) / 2,
                      this.runtime.kahanTime.sum,
                      e ? e.effect_params[U] : this.effect_params[U]
                    ),
                    t.setTexture(
        ...
        V &&
          ...
          i
            ...
            : this.runtime.fullscreenScalingQuality ||
              (t.setSize(this.runtime.width, this.runtime.height),
              (x = this.runtime.width / 2),
              (T = this.runtime.height / 2),
              (C = 0),
              (k = 0),
              (P = this.runtime.width),
      ...
      (t.prototype.saveToJSON = function () {
        ...
        for (t = 0, e = this.layers.length; t < e; t++)
          (i = this.layers[t]), (n.layers[i.sid.toString()] = i.saveToJSON());
        return n;
      }),
      (t.prototype.loadFromJSON = function (t) {
        ...
        (this.scrollX = t.sx),
          ...
          "undefined" != typeof t.fv && (this.first_visit = t.fv);
        var a = t.fx;
        for (e = 0, i = a.length; e < i; e++)
          (s = this.getEffectByName(a[e].name)),
            s &&
              ((s.active = a[e].active),
      ...
      (cr.layout = t),
      (i.prototype.updateActiveEffects = function () {
        cr.clearArray(this.active_effect_types),
          (this.shaders_preserve_opaqueness = !0);
        var t, e, i;
        for (t = 0, e = this.effect_types.length; t < e; t++)
      ...
      (i.prototype.createInitialInstances = function () {
        ...
        for (t = 0, e = 0, i = this.initial_instances.length; t < i; t++) {
          if (
            ((n = this.initial_instances[t]),
            (r = this.runtime.types_by_index[n[1]]),
            (o = this.runtime.typeHasPersistBehavior(r)),
            (a = !0),
            !o || this.layout.first_visit)
          ) {
            if (((s = this.runtime.createInstanceFromInit(n, this, !0)), !s))
              continue;
            h.push(s),
              s.type.global && ((a = !1), this.created_globals.push(s.uid));
          }
          a && ((this.initial_instances[e] = this.initial_instances[t]), e++);
        }
        (this.initial_instances.length = e),
          this.runtime.ClearDeathRow(),
          !this.runtime.glwrap &&
      ...
      (i.prototype.recreateInitialObjects = function (t, e) {
        var i,
          ...
          u,
          p,
          d = this.runtime.types_by_index,
          f = t.is_family,
          g = t.members;
        for (i = 0, s = this.initial_instances.length; i < s; ++i)
          if (
            ((n = this.initial_instances[i]),
            (a = n[0]),
            (o = a[0]),
            (h = a[1]),
            e.contains_pt(o, h))
            ...
            if (
              ((c = this.runtime.createInstanceFromInit(n, this, !1)),
              this.runtime.isInOnDestroy++,
              this.runtime.trigger(
                Object.getPrototypeOf(r.plugin).cnds.OnCreated,
                c
              ),
              c.is_contained)
            )
              for (l = 0, u = c.siblings.length; l < u; l++)
                (p = c.siblings[i]),
                  this.runtime.trigger(
                    Object.getPrototypeOf(p.type.plugin).cnds.OnCreated,
                    p
                  );
            this.runtime.isInOnDestroy--;
          }
      ...
      (i.prototype.moveInstanceAdjacent = function (t, e, i) {
        ...
        cr.arrayRemove(this.instances, s),
          ...
          n === this.instances.length
            ? this.instances.push(t)
            : this.instances.splice(n, 0, t),
          this.setZIndicesStaleFrom(s < n ? s : n);
      }),
      (i.prototype.setZIndicesStaleFrom = function (t) {
        this.zindices_stale_from === -1
          ? (this.zindices_stale_from = t)
          : t < this.zindices_stale_from && (this.zindices_stale_from = t),
    ...
    (i.prototype.getRenderCellInstancesToDraw = function () {
      ...
      (i.prototype.draw = function (t) {
        ...
        (this.disableAngle = !1),
          ...
          this.rotateViewport(r, a, i);
        var o = this.getScale();
        i.scale(o, o), i.translate(-r, -a);
        var h;
        this.useRenderCells
          ? ((this.cur_render_cells.left = this.render_grid.XToCell(
            ...
            !this.cur_render_cells.equals(this.last_render_cells)
              ? (n(this.last_render_list),
                (h = this.getRenderCellInstancesToDraw()),
                (this.render_list_stale = !1),
                this.last_render_cells.copy(this.cur_render_cells))
              : (h = this.last_render_list))
          : (h = this.instances);
        var c,
          l,
          u,
        ...
        for (c = 0, l = h.length; c < l; ++c)
          (u = h[c]), u !== p && (this.drawInstance(u, i), (p = u));
        this.useRenderCells && (this.last_render_list = h),
          i.restore(),
          this.render_offscreen &&
      ...
      (i.prototype.drawGL_earlyZPass = function (t) {
        ...
        for (a = r.length - 1; a >= 0; --a)
          (o = r[a]),
            o !== h && (this.drawInstanceGL_earlyZPass(r[a], t), (h = o));
      ...
      (i.prototype.drawGL = function (t) {
        ...
        for (h = 0, c = o.length; h < c; ++h)
          (l = o[h]), l !== u && (this.drawInstanceGL(o[h], t), (u = l));
        if (
      ...
      (i.prototype.drawInstanceWithShadersGL = function (t, e) {
        ...
        if (
          ...
          e.programUsesCrossSampling(i) ||
          e.programExtendsBox(i) ||
          ((t.angle || t.layer.getAngle()) && e.programUsesDest(i)) ||
          1 !== t.opacity ||
      ...
      (i.prototype.canvasToLayer = function (t, e, i, s) {
        ...
        var r = this.runtime.parallax_x_origin,
          ...
          u = 1 / this.getScale(!s);
        s
          ? ((c -= (this.runtime.draw_width * u) / 2),
            (l -= (this.runtime.draw_height * u) / 2))
          : ((c -= (this.runtime.width * u) / 2),
      ...
      (i.prototype.layerToCanvas = function (t, e, i, s) {
        ...
        s
          ? ((h -= (this.runtime.draw_width * f) / 2),
            (c -= (this.runtime.draw_height * f) / 2))
          : ((h -= (this.runtime.width * f) / 2),
      ...
      (i.prototype.loadFromJSON = function (t) {
        ...
        var a = new cr.ObjectSet();
        for (i = 0, n = this.created_globals.length; i < n; ++i)
          a.add(this.created_globals[i]);
        for (i = 0, s = 0, n = this.initial_instances.length; i < n; ++i)
          a.contains(this.initial_instances[i][2]) ||
            ((this.initial_instances[s] = this.initial_instances[i]), ++s);
        cr.truncateArray(this.initial_instances, s);
        var o = t.fx;
        for (i = 0, n = o.length; i < n; i++)
          (r = this.getEffectByName(o[i].name)),
            r &&
              ((r.active = o[i].active),
              (this.effect_params[r.index] = o[i].params));
        this.updateActiveEffects(),
          this.instances.sort(e),
          (this.zindices_stale = !0);
      }),
      (cr.layer = i);
  })(),
  (function () {
    function t(t, e) {
      ...
      switch (s) {
        ...
        default:
          for (i = 0; i < s; i++) if (t[i] !== e[i]) return !1;
          return !0;
      }
    }
    function e(t, e) {
    ...
    function i(i) {
      ...
      for (
        2 === i.length
          ? i[0].index > i[1].index && ((a = i[0]), (i[0] = i[1]), (i[1] = a))
          : i.length > 2 && i.sort(e),
          i.length >= m.length && (m.length = i.length + 1),
    ...
    function s(t, e) {
      ...
      for (s = 0, n = i.length; s < n; s++)
        this.init_event(i[s], null, this.events);
    }
    function n(t) {
      return !(
        !cr.plugins_.Sprite ||
        t !== cr.plugins_.Sprite.prototype.cnds.OnFrameChanged
      );
    }
    function r(t) {
      (this.type = t),
    ...
    function a(t, e, i) {
      ...
      if (8 === i.length) {
        ...
        for (s = 0, n = c.length; s < n; s++)
          this.sheet.init_event(c[s], this, this.subevents);
      }
    ...
    function o(t, e) {
      ...
      if (t && (e.indexOf(t) === -1 && e.push(t), t.is_contained))
        for (i = 0, s = t.container.length; i < s; i++)
          (n = t.container[i]), t !== n && e.indexOf(n) === -1 && e.push(n);
    }
    function h(t, e) {
      if (
        ((this.block = t),
    ...
    (s.prototype.toString = function () {
        ...
        switch (t[0]) {
          case 0:
            ...
            if ((cr.seal(s), s.orblock)) {
              i.push(s);
              var n, r;
              for (n = 0, r = s.conditions.length; n < r; n++)
      ...
      (s.prototype.postInit = function () {
        var t, e;
        for (t = 0, e = this.events.length; t < e; t++)
        ...
        for (e = 0, i = o.length; e < i; ++e)
          (s = o[e]),
            ...
            !s.isActive() ||
              t === n ||
              a.indexOf(n) > -1 ||
              (a.push(n), n.addDeepIncludes(t), r.push(n));
      }),
      ...
      (s.prototype.init_trigger = function (t, e) {
        ...
        if (o) {
          ...
          var p,
            i,
            s,
            d = u.expression.value.toLowerCase();
          for (i = 0, s = c.length; i < s; i++)
            if (c[i].method == l)
              return (
                (p = c[i].evs),
                void (p[d] ? p[d].push([t, e]) : (p[d] = [[t, e]]))
              );
          (p = {}), (p[d] = [[t, e]]), c.push({ method: l, evs: p });
        } else {
          for (i = 0, s = c.length; i < s; i++)
            if (c[i].method == l) return void c[i].evs.push([t, e]);
          n(l)
            ? c.unshift({ method: l, evs: [[t, e]] })
            : c.push({ method: l, evs: [[t, e]] });
        }
      }),
      (cr.eventsheet = s),
      (r.prototype.hasObjects = function () {
      ...
      (a.prototype.postInit = function (t) {
        ...
        for (
          ...
          for (e = 0, s = n.solModifiers.length; e < s; e++)
            this.addParentSolModifier(n.solModifiers[e]);
          n = n.parent;
        }
        (this.solModifiers = i(this.solModifiers)),
          (this.solModifiersIncludingParents = i(
            this.solModifiersIncludingParents
          ));
        var e, s;
        for (e = 0, s = this.conditions.length; e < s; e++)
          this.conditions[e].postInit();
        for (e = 0, s = this.actions.length; e < s; e++)
          this.actions[e].postInit();
        for (e = 0, s = this.subevents.length; e < s; e++)
          this.subevents[e].postInit(
            e < s - 1 && this.subevents[e + 1].is_else_block
          );
      }),
      (a.prototype.setGroupActive = function (t) {
        if (this.group_active !== !!t) {
          this.group_active = !!t;
          var e, i;
          for (e = 0, i = this.contained_includes.length; e < i; ++e)
      ...
      (a.prototype.run = function () {
        ...
        if ((this.is_else_block || (r.else_branch_ran = !1), this.orblock)) {
          for (
            0 === a.length && (s = !0), r.cndindex = 0, t = a.length;
            r.cndindex < t;
            r.cndindex++
          )
            (e = a[r.cndindex]), e.trigger || ((i = e.run()), i && (s = !0));
          (r.last_event_true = s), s && this.run_actions_and_subevents();
        } else {
          for (r.cndindex = 0, t = a.length; r.cndindex < t; r.cndindex++)
            if (((i = a[r.cndindex].run()), !i))
              return (
                (r.last_event_true = !1),
                void (
                  this.toplevelevent &&
                  n.hasPendingInstances &&
                  n.ClearDeathRow()
                )
              );
          ...
          if ((this.runtime.pushEventStack(this), this.solWriterAfterCnds))
            for (t = 0, e = this.subevents.length; t < e; t++)
              (i = this.subevents[t]),
                ...
                s && this.runtime.pushCopySol(i.solModifiers),
                i.run(),
                s
      ...
      (h.prototype.postInit = function () {
        var t, e, i;
        for (t = 0, e = this.parameters.length; t < e; t++)
          (i = this.parameters[t]),
            i.postInit(),
      ...
      (h.prototype.run_object = function () {
        ...
        if (x)
          for (e = 0, n = T.length; e < n; ++e)
            (r = T[e]), r.variesPerInstance || (S[e] = r.get(0));
        else for (e = 0, n = T.length; e < n; ++e) S[e] = T[e].get(0);
        if (f.select_all) {
          for (
            cr.clearArray(f.instances),
              cr.clearArray(f.else_instances),
              u = d.instances,
              t = 0,
              s = u.length;
            t < s;
            ...
            if (((h = u[t]), x))
              for (e = 0, n = T.length; e < n; ++e)
                (r = T[e]), r.variesPerInstance && (S[e] = r.get(t));
            w
              ? ((m = 0),
                _ && (m = h.type.family_beh_map[v]),
                (a = C.apply(h.behavior_insts[b + m], S)))
              : (a = C.apply(h, S)),
              (o = cr.xor(a, O)),
              o ? f.instances.push(h) : g && f.else_instances.push(h);
          }
          return (
            d.finish && d.finish(!0),
            (f.select_all = !1),
            d.applySolToContainer(),
            f.hasObjects()
          );
        }
        i = 0;
        var A = g && !this.block.isFirstConditionOfType(this);
        u = A ? f.else_instances : f.instances;
        var k = !1;
          ...
          if (
            ...
            if (((k = !0), A)) {
              if ((f.instances.push(h), y))
                for (e = 0, n = h.siblings.length; e < n; e++)
                  (c = h.siblings[e]), c.type.getCurrentSol().instances.push(c);
            } else {
              if (((u[i] = h), y))
                for (e = 0, n = h.siblings.length; e < n; e++)
                  (c = h.siblings[e]),
                    (c.type.getCurrentSol().instances[i] = c);
              i++;
            }
          else if (A) {
            if (((u[i] = h), y))
              for (e = 0, n = h.siblings.length; e < n; e++)
                (c = h.siblings[e]),
                  (c.type.getCurrentSol().else_instances[i] = c);
            i++;
          } else if (g && (f.else_instances.push(h), y))
            for (e = 0, n = h.siblings.length; e < n; e++)
              (c = h.siblings[e]),
                c.type.getCurrentSol().else_instances.push(c);
        }
        if ((cr.truncateArray(u, i), y))
          for (p = d.container, t = 0, s = p.length; t < s; t++)
            (l = p[t].getCurrentSol()),
              A
                ? cr.truncateArray(l.else_instances, i)
                : cr.truncateArray(l.instances, i);
        var E = k;
        if (A && !k)
          for (t = 0, s = f.instances.length; t < s; t++) {
            if (((h = f.instances[t]), x))
              for (e = 0, n = T.length; e < n; e++)
                (r = T[e]), r.variesPerInstance && (S[e] = r.get(t));
            if (
              ((a = w ? C.apply(h.behavior_insts[b], S) : C.apply(h, S)),
              cr.xor(a, O))
            ) {
              k = !0;
              break;
      ...
      (c.prototype.run_object = function () {
        ...
        if (l)
          for (e = 0, s = u.length; e < s; ++e)
            (n = u[e]), n.variesPerInstance || (p[e] = n.get(0));
        else for (e = 0, s = u.length; e < s; ++e) p[e] = u[e].get(0);
        for (t = 0, i = f.length; t < i; ++t) {
          if (((r = f[t]), l))
            for (e = 0, s = u.length; e < s; ++e)
              (n = u[e]), n.variesPerInstance && (p[e] = n.get(t));
          m
            ? ((a = 0),
              g && (a = r.type.family_beh_map[c]),
              d.apply(r.behavior_insts[h + a], p))
            : d.apply(r, p);
        }
        return !1;
      }),
    ...
    (p.prototype.postInit = function () {
      ...
      (p.prototype.maybeVaryForType = function (t) {
        if (!this.variesPerInstance && t)
          return t.plugin.singleglobal
            ? void 0
            : void (this.variesPerInstance = !0);
      }),
      ...
      (p.prototype.get_layer = function (t) {
        ...
        return (
          ...
          u(),
          e.is_number()
            ? this.runtime.getLayerByNumber(e.data)
            : this.runtime.getLayerByName(e.data)
        );
      }),
      ...
      (d.prototype.getValue = function () {
        ...
        return !this.parent || this.is_static || !t || this.is_constant
          ? this.data
          : this.localIndex >= t.length
          ? this.initial
          : "undefined" == typeof t[this.localIndex]
          ? this.initial
          : t[this.localIndex];
      }),
  ...
  (function () {
    ...
    function e() {
      return ++a, r.length === a && r.push(new cr.expvalue()), r[a];
    }
    function i() {
      --a;
    }
    ...
    (t.prototype.eval_system_exp = function (t) {
      ...
      r[0] = t;
      var a = e();
      s(n, r, a), i(), this.func.apply(this.runtime.system, r);
    }),
      (t.prototype.eval_object_exp = function (t) {
        ...
        var p = e();
        s(a, r, p),
          o && (o.get(p), p.is_number() && ((c = p.data), (u = n.instances))),
          i();
        var d = u.length;
        (c >= d || c <= -d) && (c %= d), c < 0 && (c += d);
        h.apply(u[c], r);
      ...
      (t.prototype.eval_behavior_exp = function (t) {
        ...
        var d = e();
        s(a, r, d),
          o && (o.get(d), d.is_number() && ((l = d.data), (p = n.instances))),
          i();
        var f = p.length;
        (l >= f || l <= -f) && (l %= f), l < 0 && (l += f);
        var g = p[l],
          m = 0;
        n.is_family && (m = g.type.family_beh_map[n.family_index]);
        c.apply(g.behavior_insts[h + m], r);
      }),
      (t.prototype.eval_instvar_exp = function (t) {
        ...
        if (n) {
          ...
          if ((n.get(l), l.is_number())) {
            o = l.data;
            var u = r.instances;
            0 !== u.length && ((o %= u.length), o < 0 && (o += u.length)),
              (s = r.getInstanceByIID(o));
            var p = s.instance_vars[a];
            return cr.is_string(p) ? t.set_string(p) : t.set_float(p), void i();
          }
          i();
        }
        var d = c.length;
        (o >= d || o <= -d) && (o %= d), o < 0 && (o += d), (s = c[o]);
        var f = 0;
        r.is_family && (f = s.type.family_var_map[r.family_index]);
        var p = s.instance_vars[a + f];
      ...
      (t.prototype.eval_add = function (t) {
        ...
        this.second.get(s),
          t.is_number() &&
            s.is_number() &&
            ((t.data += s.data), s.is_float() && t.make_float()),
          i();
      }),
      ...
      (t.prototype.eval_power = function (t) {
        ...
        this.second.get(s),
          t.is_number() &&
            s.is_number() &&
            ((t.data = Math.pow(t.data, s.data)),
            s.is_float() && t.make_float()),
          i();
      }),
      (t.prototype.eval_and = function (t) {
        ...
        var s = e();
        this.second.get(s),
          s.is_string() || t.is_string()
            ? this.eval_and_stringconcat(t, s)
            : this.eval_and_logical(t, s),
          i();
      }),
      ...
      (t.prototype.eval_or = function (t) {
        ...
        this.second.get(s),
          t.is_number() &&
            s.is_number() &&
            (t.data || s.data ? t.set_int(1) : t.set_int(0)),
          i();
      }),
    ...
    for (t = 0, e = this.waits.length; t < e; t++) {
      for (
        r = this.waits[t],
          ...
          r.ev.actions[r.actindex] && (c.act = r.ev.actions[r.actindex].sid),
          i = 0,
          s = r.solModifiers.length;
        i < s;
        i++
      )
        c.sm.push(r.solModifiers[i].sid);
      for (n in r.sols)
        if (r.sols.hasOwnProperty(n)) {
          for (
            a = this.runtime.types_by_index[parseInt(n, 10)],
              o = { sa: r.sols[n].sa, insts: [] },
              i = 0,
              s = r.sols[n].insts.length;
            i < s;
            i++
          )
            o.insts.push(r.sols[n].insts[i].uid);
      ...
      if (((a = f[e]), (h = this.runtime.blocksBySid[a.ev.toString()]))) {
        ...
        if (c !== -1) {
          for (
            ...
            (l = this.runtime.getObjectTypeBySid(a.sm[s])),
              l && o.solModifiers.push(l);
          for (r in a.sols)
            if (a.sols.hasOwnProperty(r)) {
              if (((l = this.runtime.getObjectTypeBySid(parseInt(r, 10))), !l))
                continue;
              for (
                u = a.sols[r],
                  p = { sa: u.sa, insts: [] },
  ...
  (function () {
    ...
    function e(t, e) {
      ...
      return cr.is_number(i) && cr.is_number(s)
        ? i - s
        : ((i = "" + i), (s = "" + s), i < s ? -1 : i > s ? 1 : 0);
    }
    function i(t, e) {
      return (
        (d && t === f && e === g) || ((d = new RegExp(t, e)), (f = t), (g = e)),
        (d.lastIndex = 0),
        d
      );
    }
    ...
    function a() {
      var t;
      return (
        _.length ? (t = _.pop()) : ((t = {}), (t.insts = [])), (t.sa = !1), t
      );
    }
    function o(t) {
    ...
    (t.prototype.EveryTick = function () {
      ...
      (t.prototype.CompareTime = function (t, e) {
        ...
        if (0 === t) {
          ...
          return (
            !s.extra.CompareTime_executed &&
            i >= e &&
            ((s.extra.CompareTime_executed = !0), !0)
          );
        }
      ...
      (t.prototype.Repeat = function (t) {
        ...
        if (n)
          for (e = 0; e < t && !r.stopped; e++)
            this.runtime.pushCopySol(s.solModifiers),
              (r.index = e),
              s.retrigger(),
              this.runtime.popSol(s.solModifiers);
        else for (e = 0; e < t && !r.stopped; e++) (r.index = e), s.retrigger();
      ...
      (t.prototype.While = function (t) {
        ...
        if (n)
          for (e = 0; !r.stopped; e++)
            this.runtime.pushCopySol(s.solModifiers),
              (r.index = e),
              s.retrigger() || (r.stopped = !0),
              this.runtime.popSol(s.solModifiers);
        else
          for (e = 0; !r.stopped; e++)
            (r.index = e), s.retrigger() || (r.stopped = !0);
        return this.runtime.popLoopStack(), !1;
      }),
    ...
    (t.prototype.ForEach = function (t) {
      ...
      if (f)
        for (s = 0, n = i.length; s < n && !g.stopped; s++) {
          if (
            (this.runtime.pushCopySol(d.solModifiers),
            (o = i[s]),
            (e = t.getCurrentSol()),
            (e.select_all = !1),
            ...
            for (r = 0, a = o.siblings.length; r < a; r++)
              (h = o.siblings[r]),
                (c = h.type.getCurrentSol()),
                (c.select_all = !1),
      ...
      (t.prototype.ForEachOrdered = function (t, i, s) {
        ...
        var a,
          ...
          d,
          f,
          g = this.runtime.getCurrentEventStack(),
          m = g.current_event,
          y = this.runtime.getCurrentCondition(),
          _ = g.isModifierAfterCnds(),
          v = this.runtime.pushLoopStack();
        for (a = 0, o = r.length; a < o; a++)
          r[a].extra.c2_feo_val = y.parameters[1].get(a);
        r.sort(e), 1 === s && r.reverse();
        var b = t.is_contained;
        if (_)
          for (a = 0, o = r.length; a < o && !v.stopped; a++) {
            if (
              (this.runtime.pushCopySol(m.solModifiers),
              (l = r[a]),
              (n = t.getCurrentSol()),
              (n.select_all = !1),
              cr.clearArray(n.instances),
              (n.instances[0] = l),
              b)
            )
              for (h = 0, c = l.siblings.length; h < c; h++)
                (d = l.siblings[h]),
                  (f = d.type.getCurrentSol()),
                  (f.select_all = !1),
                  cr.clearArray(f.instances),
                  (f.instances[0] = d);
          ...
          for (
            n.select_all = !1, cr.clearArray(n.instances), a = 0, o = r.length;
            a < o && !v.stopped;
            a++
          ) {
            if (((l = r[a]), (n.instances[0] = l), b))
              for (h = 0, c = l.siblings.length; h < c; h++)
                (d = l.siblings[h]),
                  (f = d.type.getCurrentSol()),
                  (f.select_all = !1),
      ...
      (t.prototype.PickByComparison = function (t, e, i, s) {
        ...
        if (t) {
          ...
          for (n = 0, a = 0, r = h.length; n < r; n++)
            (o = h[n]),
              (h[a] = o),
              (e = l.parameters[1].get(n)),
              (s = l.parameters[3].get(n)),
              cr.do_cmp(e, i, s) ? a++ : c.else_instances.push(o);
          return (
            cr.truncateArray(h, a),
            (c.select_all = !1),
      ...
      (t.prototype.PickByEvaluate = function (t, e) {
        ...
        if (t) {
          ...
          for (i = 0, n = 0, s = a.length; i < s; i++)
            (r = a[i]),
              (a[n] = r),
              (e = h.parameters[1].get(i)),
              e ? n++ : o.else_instances.push(r);
          return (
            cr.truncateArray(a, n),
            (o.select_all = !1),
            cr.shallowAssignArray(o.instances, a),
            cr.clearArray(a),
            p--,
            t.applySolToContainer(),
            !!o.instances.length
      ...
      (t.prototype.TriggerOnce = function () {
        ...
        "undefined" == typeof t.TriggerOnce_lastTick &&
          (t.TriggerOnce_lastTick = -1);
      ...
      (t.prototype.Every = function (t) {
        ...
        "undefined" == typeof e.extra.Every_seconds &&
      ...
      (t.prototype.PickNth = function (t, e) {
        ...
        var i = t.getCurrentSol(),
          s = i.getObjects();
        if (((e = cr.floor(e)), e < 0 || e >= s.length)) return !1;
        var n = s[e];
    ...
    (t.prototype.PickOverlappingPoint = function (t, e, i) {
      ...
      for (
        o.select_all
          ? (cr.shallowAssignArray(m, h),
            cr.clearArray(o.else_instances),
            (o.select_all = !1),
            cr.clearArray(o.instances))
          : l
          ? (cr.shallowAssignArray(m, o.else_instances),
            cr.clearArray(o.else_instances))
          : (cr.shallowAssignArray(m, h), cr.clearArray(o.instances)),
          s = 0,
          n = m.length;
        s < n;
        ++s
        ...
        (r = m[s]),
          r.update_bbox(),
          (a = cr.xor(r.contains_pt(e, i), u.inverted)),
          a ? o.instances.push(r) : o.else_instances.push(r);
      ...
      (t.prototype.IsBetweenAngles = function (t, e, i) {
        var s = cr.to_clamped_radians(t),
          ...
          a = !cr.angleClockwise(r, n);
        return a
          ? !(!cr.angleClockwise(s, n) && cr.angleClockwise(s, r))
          : cr.angleClockwise(s, n) && !cr.angleClockwise(s, r);
      }),
      ...
      (l.cnds = new t()),
      (s.prototype.GoToLayout = function (t) {
      ...
      (s.prototype.NextPrevLayout = function (t) {
        if (!this.runtime.isloading && !this.runtime.changelayout) {
          var e = this.runtime.layouts_by_index.indexOf(
        ...
        if (e && t) {
          ...
          if (n) {
            ...
            if (
              ...
              for (r = 0, a = n.siblings.length; r < a; r++)
                (o = n.siblings[r]),
                  this.runtime.trigger(
                    Object.getPrototypeOf(o.type.plugin).cnds.OnCreated,
                    o
      ...
      (s.prototype.ScrollToObject = function (t) {
        ...
        e &&
          (this.runtime.running_layout.scrollToX(e.x),
      ...
      (s.prototype.SetObjectTimescale = function (t, e) {
        ...
        if ((i < 0 && (i = 0), t)) {
          var s,
            ...
            r = t.getCurrentSol(),
            a = r.getObjects();
          for (s = 0, n = a.length; s < n; s++) a[s].my_timescale = i;
        }
      }),
    ...
    (s.prototype.Wait = function (t) {
      if (!(t < 0)) {
        var e,
          ...
          c = n();
        for (
          c.time = this.runtime.kahanTime.sum + t,
            c.signaltag = "",
            c.signalled = !1,
            c.ev = h.current_event,
            c.actindex = h.actindex + 1,
            e = 0,
            i = this.runtime.types_by_index.length;
          e < i;
          e++
        )
          (r = this.runtime.types_by_index[e]),
            (s = r.getCurrentSol()),
            (s.select_all && h.current_event.solModifiers.indexOf(r) === -1) ||
              (c.solModifiers.push(r),
              (o = a()),
              (o.sa = s.select_all),
              cr.shallowAssignArray(o.insts, s.instances),
              (c.sols[e.toString()] = o));
      ...
      (s.prototype.Signal = function (t) {
        var e,
          ...
          s,
          n = t.toLowerCase();
        for (e = 0, i = this.waits.length; e < i; ++e)
          (s = this.waits[e]),
            s.time === -1 && s.signaltag === n && (s.signalled = !0);
      }),
      ...
      (s.prototype.ResetGlobals = function () {
        var t, e, i;
        for (t = 0, e = this.runtime.all_global_vars.length; t < e; t++)
          (i = this.runtime.all_global_vars[t]), (i.data = i.initial);
      }),
        ...
        if (t && (t.parallaxX !== e / 100 || t.parallaxY !== i / 100)) {
          if (
            ...
            var s,
              ...
              r = t.instances;
            for (s = 0, n = r.length; s < n; ++s)
              r[s].type.any_instance_parallaxed = !0;
          }
          this.runtime.redraw = !0;
        }
      }),
      ...
      (s.prototype.RestartLayout = function (t) {
        if (
          ...
          var e, i, s;
          for (e = 0, i = this.runtime.allGroups.length; e < i; e++)
            (s = this.runtime.allGroups[e]),
              s.setGroupActive(s.initially_activated);
        }
      }),
      ...
      (s.prototype.SetCanvasSize = function (t, e) {
        if (!(t <= 0 || e <= 0)) {
          ...
          s &&
            this.runtime.fullscreen_scaling > 0 &&
          ...
          if (s) {
            ...
            (e = Math.floor(e)),
              e < 0 ||
                ...
                n[e] !== i &&
                  ((n[e] = i), s.active && (this.runtime.redraw = !0)));
          }
        }
      }),
          ...
          if (n) {
            ...
            (i = Math.floor(i)),
              i < 0 ||
                ...
                r[i] !== s &&
                  ((r[i] = s), n.active && (this.runtime.redraw = !0)));
          }
        }
      }),
      ...
      (s.prototype.SetFullscreenQuality = function (t) {
        var e =
          ...
          document.fullScreen ||
          this.isNodeFullscreen;
        (e || 0 !== this.runtime.fullscreen_mode) &&
      ...
      (s.prototype.ResetPersisted = function () {
        var t, e;
        for (t = 0, e = this.runtime.layouts_by_index.length; t < e; ++t)
      ...
      (h.prototype.max = function (t) {
        ...
        "number" != typeof e && (e = 0);
        var i, s, n;
        for (i = 2, s = arguments.length; i < s; i++)
          (n = arguments[i]), "number" == typeof n && e < n && (e = n);
        t.set_float(e);
      }),
      ...
      (h.prototype.lerp = function (t, e, i, s) {
        t.set_float(cr.lerp(e, i, s));
      }),
      (h.prototype.qarp = function (t, e, i, s, n) {
        t.set_float(cr.qarp(e, i, s, n));
      }),
      (h.prototype.cubic = function (t, e, i, s, n, r) {
        t.set_float(cr.cubic(e, i, s, n, r));
      }),
      (h.prototype.cosp = function (t, e, i, s) {
      ...
      (h.prototype.clamp = function (t, e, i, s) {
      ...
      (h.prototype.findcase = function (t, e, i) {
        cr.is_string(e) && cr.is_string(i)
      ...
      (h.prototype.mid = function (t, e, i, s) {
        t.set_string(cr.is_string(e) ? e.substr(i, s) : "");
      }),
      (h.prototype.tokenat = function (t, e, i, s) {
      ...
      (h.prototype.replace = function (t, e, i, s) {
      ...
      (h.prototype.rgb = function (t, e, i, s) {
      ...
      (h.prototype.anglelerp = function (t, e, i, s) {
      ...
      (h.prototype.anglerotate = function (t, e, i, s) {
        (e = cr.to_radians(e)),
          (i = cr.to_radians(i)),
          (s = cr.to_radians(s)),
      ...
      (h.prototype.unlerp = function (t, e, i, s) {
      ...
      (h.prototype.canvastolayerx = function (t, e, i, s) {
        var n = this.runtime.getLayer(e);
        t.set_float(n ? n.canvasToLayer(i, s, !0) : 0);
      }),
      (h.prototype.canvastolayery = function (t, e, i, s) {
        var n = this.runtime.getLayer(e);
        t.set_float(n ? n.canvasToLayer(i, s, !1) : 0);
      }),
      (h.prototype.layertocanvasx = function (t, e, i, s) {
        var n = this.runtime.getLayer(e);
        t.set_float(n ? n.layerToCanvas(i, s, !0) : 0);
      }),
      (h.prototype.layertocanvasy = function (t, e, i, s) {
        var n = this.runtime.getLayer(e);
      ...
      (h.prototype.regexsearch = function (t, e, s, n) {
        var r = i(s, n);
        t.set_int(e ? e.search(r) : -1);
      }),
      (h.prototype.regexreplace = function (t, e, s, n, r) {
        var a = i(s, n);
        t.set_string(e ? e.replace(a, r) : "");
      });
    var v = [],
      b = "",
      w = "",
      x = "";
    (h.prototype.regexmatchcount = function (t, e, s, n) {
      i(s, n);
      c(e, s, n), t.set_int(v ? v.length : 0);
    }),
      (h.prototype.regexmatchat = function (t, e, s, n, r) {
        r = Math.floor(r);
        i(s, n);
        c(e, s, n),
          !v || r < 0 || r >= v.length ? t.set_string("") : t.set_string(v[r]);
      }),
      (h.prototype.infinity = function (t) {
        t.set_float(1 / 0);
      }),
      (h.prototype.setbit = function (t, e, i, s) {
        (e |= 0),
          (i |= 0),
          (s = 0 !== s ? 1 : 0),
          t.set_int((e & ~(1 << i)) | (s << i));
      ...
      (l.runWaits = function () {
        var t,
          ...
          a,
          h,
          c = this.runtime.getCurrentEventStack();
        for (t = 0, i = this.waits.length; t < i; t++) {
          if (((s = this.waits[t]), s.time === -1)) {
          ...
          for (n in s.sols)
            s.sols.hasOwnProperty(n) &&
              ((a =
                this.runtime.types_by_index[parseInt(n, 10)].getCurrentSol()),
              (h = s.sols[n]),
              (a.select_all = h.sa),
              cr.shallowAssignArray(a.instances, h.insts),
              o(h));
          s.ev.resume_actions_and_subevents(),
            this.runtime.clearSol(s.solModifiers),
            (s.deleteme = !0);
        }
        for (t = 0, e = 0, i = this.waits.length; t < i; t++)
          (s = this.waits[t]), (this.waits[e] = s), s.deleteme ? r(s) : e++;
      ...
      s &&
        ...
        (l.SetPosToObject = function (t, e) {
          ...
          if (i) {
            var s, n;
            i.getImagePoint
              ? ((s = i.getImagePoint(e, !0)), (n = i.getImagePoint(e, !1)))
              : ((s = i.x), (n = i.y)),
              (this.x === s && this.y === n) ||
                ((this.x = s), (this.y = n), this.set_bbox_changed());
          }
        }),
        ...
        r &&
          ...
          (c.IsBetweenAngles = function (t, e) {
            ...
            return r
              ? !(!cr.angleClockwise(n, i) && cr.angleClockwise(n, s))
              : cr.angleClockwise(n, i) && !cr.angleClockwise(n, s);
          }),
          (l.SetAngle = function (t) {
            var e = cr.to_radians(cr.clamp_angle_degrees(t));
            isNaN(e) ||
              (this.angle !== e && ((this.angle = e), this.set_bbox_changed()));
          }),
          ...
          (l.RotateTowardAngle = function (t, e) {
            var i = cr.angleRotate(
              this.angle,
              cr.to_radians(e),
              cr.to_radians(t)
            );
            isNaN(i) ||
              (this.angle !== i && ((this.angle = i), this.set_bbox_changed()));
          }),
          (l.RotateTowardPosition = function (t, e, i) {
            ...
            isNaN(a) ||
              (this.angle !== a && ((this.angle = a), this.set_bbox_changed()));
          }),
          (l.SetTowardPosition = function (t, e) {
            var i = t - this.x,
              ...
              n = Math.atan2(s, i);
            isNaN(n) ||
              (this.angle !== n && ((this.angle = n), this.set_bbox_changed()));
          }),
          (u.Angle = function (t) {
        ...
        i ||
          ...
          (c.PickByUID = function (t) {
            ...
            if (h.inverted) {
              if (((o = this.getCurrentSol()), o.select_all)) {
                for (
                  ...
                  (n = a[e]),
                    n.uid === t
                      ? o.else_instances.push(n)
                      : o.instances.push(n);
                return this.applySolToContainer(), !!o.instances.length;
              }
              for (e = 0, s = 0, i = o.instances.length; e < i; e++)
                (n = o.instances[e]),
                  (o.instances[s] = n),
                  n.uid === t ? o.else_instances.push(n) : s++;
              return (
                cr.truncateArray(o.instances, s),
            ...
            if (
              ((o = this.getCurrentSol()),
              !o.select_all && o.instances.indexOf(n) === -1)
            )
              return !1;
            if (this.is_family) {
              for (r = n.type.families, e = 0, i = r.length; e < i; e++)
                if (r[e] === this)
                  return o.pick_one(n), this.applySolToContainer(), !0;
            } else if (n.type === this)
              return o.pick_one(n), this.applySolToContainer(), !0;
            return !1;
          }),
          ...
          l.LoadFromJsonString ||
            (l.LoadFromJsonString = function (t) {
              var e, i, s, n;
              try {
                e = JSON.parse(t);
              } catch (t) {
              ...
              if (
                ...
                for (i = 0, s = this.behavior_insts.length; i < s; ++i)
                  (n = this.behavior_insts[i]), n.afterLoad && n.afterLoad();
            }),
          (u.Count = function (t) {
            var e,
              i,
              s,
              n = t.object_class.instances.length;
            for (e = 0, i = this.runtime.createRow.length; e < i; e++)
              (s = this.runtime.createRow[e]),
                t.object_class.is_family
                  ? s.type.families.indexOf(t.object_class) >= 0 && n++
                  : s.type === t.object_class && n++;
            t.set_int(n);
          }),
        ...
        a &&
          ...
          (l.SetOpacity = function (t) {
            ...
            e < 0 ? (e = 0) : e > 1 && (e = 1),
              e !== this.opacity &&
                ((this.opacity = e), (this.runtime.redraw = !0));
          }),
        ...
        o &&
          ...
          (c.PickTopBottom = function (t) {
            ...
            var s,
              ...
              r = i[0],
              a = r;
            for (s = 1, n = i.length; s < n; s++)
              (r = i[s]),
                0 === t
                  ? (r.layer.index > a.layer.index ||
                      (r.layer.index === a.layer.index &&
                        r.get_zindex() > a.get_zindex())) &&
                    (a = r)
                  : (r.layer.index < a.layer.index ||
                      (r.layer.index === a.layer.index &&
                        r.get_zindex() < a.get_zindex())) &&
          ...
          (l.ZMoveToObject = function (t, e) {
            ...
            if (e) {
              ...
              s &&
                s.uid !== this.uid &&
                (this.layer.index !== s.layer.index &&
                  (this.layer.removeFromInstanceList(this, !0),
                  (this.layer = s.layer),
                  s.layer.appendToInstanceList(this, !0)),
                this.layer.moveInstanceAdjacent(this, s, i),
                (this.runtime.redraw = !0));
            }
          }),
        ...
        h &&
          ((l.SetEffectEnabled = function (t, e) {
            if (this.runtime.glwrap) {
              var i = this.type.getEffectIndexByName(e);
              if (!(i < 0)) {
                var s = 1 === t;
                this.active_effect_flags[i] !== s &&
                  ((this.active_effect_flags[i] = s),
                  this.updateActiveEffects(),
                  (this.runtime.redraw = !0));
              }
              ...
              if (!(s < 0)) {
                ...
                (e = Math.floor(e)),
                  e < 0 ||
                    ...
                    r[e] !== i &&
                      ((r[e] = i), n.active && (this.runtime.redraw = !0)));
              }
            }
          }));
    }),
    ...
    (cr.update_render_cell = function () {
      if (this.layer.useRenderCells) {
        ...
        t.set(
          ...
          this.rendercells.equals(t) ||
            (this.rendercells.right < this.rendercells.left
              ? e.update(this, null, t)
              : e.update(this, this.rendercells, t),
      ...
      (cr.update_collision_cell = function () {
        if (this.cell_changed && this.collisionsEnabled) {
          ...
          t.set(
            ...
            this.collcells.equals(t) ||
              (this.collcells.right < this.collcells.left
                ? e.update(this, null, t)
                : e.update(this, this.collcells, t),
      ...
      (cr.inst_updateActiveEffects = function () {
        ...
        var t,
          ...
          i,
          s = !0;
        for (t = 0, e = this.active_effect_flags.length; t < e; t++)
          this.active_effect_flags[t] &&
            ((i = this.type.effect_types[t]),
            this.active_effect_types.push(i),
            i.preservesOpaqueness || (s = !1));
        (this.uses_shaders = !!this.active_effect_types.length),
          (this.shaders_preserve_opaqueness = s);
      }),
      ...
      (cr.type_updateIIDs = function () {
        if (this.stale_iids && !this.is_family) {
          var t, e;
          for (t = 0, e = this.instances.length; t < e; t++)
      ...
      (cr.type_pushCopySol = function () {
        ...
        e.select_all
          ? ((t.select_all = !0), cr.clearArray(t.else_instances))
          : ((t.select_all = !1),
      ...
      (cr.type_getBehaviorByName = function (t) {
        ...
        if (!this.is_family)
          for (e = 0, i = this.families.length; e < i; e++)
            for (
              r = this.families[e], s = 0, n = r.behaviors.length;
              s < n;
              s++
            ) {
              if (t === r.behaviors[s].name)
                return (this.extra.lastBehIndex = a), r.behaviors[s];
              a++;
            }
        for (e = 0, i = this.behaviors.length; e < i; e++) {
          if (t === this.behaviors[e].name)
            return (this.extra.lastBehIndex = a), this.behaviors[e];
          a++;
        }
        return null;
      }),
        ...
        if (this.is_contained && !this.is_family) {
          ...
          for (t = 0, e = this.container.length; t < e; t++)
            if (
              ...
              for (
                cr.clearArray(a.instances), i = 0, s = r.instances.length;
                i < s;
                ++i
              )
                a.instances[i] = n.getInstanceByIID(r.instances[i].iid);
              if (c)
                for (
                  cr.clearArray(a.else_instances),
                    i = 0,
                    s = r.else_instances.length;
                  i < s;
                  ++i
                )
                  a.else_instances[i] = n.getInstanceByIID(
                    r.else_instances[i].iid
                  );
            }
        }
      }),
  ...
  (function () {
    ...
    function n(t) {
      return (
        (t = t.toLowerCase()),
        ut.hasOwnProperty(t) && ut[t].length
          ? ut[t][0].getInputNode()
          : q.destination
      );
    }
    function r() {
      return q.createGain ? q.createGain() : q.createGainNode();
    }
    function a(t) {
      return q.createDelay ? q.createDelay(t) : q.createDelayNode(t);
    }
    function o(t) {
    ...
    function u(t, e, i, s, n, a) {
      (this.type = "filter"),
        (this.params = [t, e, i, s, n, a]),
        (this.inputNode = r()),
        (this.wetNode = r()),
        (this.wetNode.gain.value = a),
        (this.dryNode = r()),
        (this.dryNode.gain.value = 1 - a),
        (this.filterNode = q.createBiquadFilter()),
        "number" == typeof this.filterNode.type
          ? (this.filterNode.type = t)
          : (this.filterNode.type = pt[t]),
    ...
    function d(t, e, i, s) {
      (this.type = "convolve"),
        ...
        (this.dryNode = r()),
        (this.dryNode.gain.value = 1 - i),
        (this.convolveNode = q.createConvolver()),
        t &&
    ...
    function f(t, e, i, s, n) {
      (this.type = "flanger"),
        ...
        (this.delayNode = a(t + e)),
        (this.delayNode.delayTime.value = t),
        (this.oscNode = q.createOscillator()),
    ...
    function g(t, e, i, s, n, a) {
      (this.type = "phaser"),
        (this.params = [t, e, i, s, n, a]),
        (this.inputNode = r()),
        (this.dryNode = r()),
        (this.dryNode.gain.value = 1 - a / 2),
        (this.wetNode = r()),
        (this.wetNode.gain.value = a / 2),
        (this.filterNode = q.createBiquadFilter()),
        "number" == typeof this.filterNode.type
    ...
    function v(t, e, s, n, a) {
      (this.type = "distortion"),
        (this.params = [t, e, s, n, a]),
        (this.inputNode = r()),
        (this.preGain = r()),
        (this.postGain = r()),
        this.setDrive(s, i(n)),
        ...
        (this.dryNode = r()),
        (this.dryNode.gain.value = 1 - a),
        (this.waveShaper = q.createWaveShaper()),
    ...
    function w(t, e, i, s, n) {
      (this.type = "compressor"),
        (this.params = [t, e, i, s, n]),
        (this.node = q.createDynamicsCompressor());
      try {
    ...
    function S(t, e) {
      ...
      (this.outNode = null),
        ...
        (this.failedToLoad = !1),
        (this.wasEverReady = !1),
        U === G && e && ((this.myapi = W), (this.outNode = r())),
      ...
      switch (this.myapi) {
        case W:
          (this.bufferObject = new Audio()),
            ...
            U === G &&
              q.createMediaElementSource &&
              !/wiiu/i.test(navigator.userAgent) &&
              ((this.supportWebAudioAPI = !0),
              this.bufferObject.addEventListener("canplay", function () {
                i.mediaSourceNode ||
                  ((i.mediaSourceNode = q.createMediaElementSource(
                    i.bufferObject
                  )),
                  i.mediaSourceNode.connect(i.outNode));
              })),
    ...
    function O(t, e) {
          ...
          if (!i.is_paused && !i.resume_me) {
            ...
            e || (e = t.target),
              e === i.active_buffer &&
                ...
                (i.stopped = !0),
                (j = i.tag),
                B.trigger(cr.plugins_.Audio.prototype.cnds.OnEnded, N));
          }
        }),
        (this.active_buffer = null),
        (this.isTimescaled = (1 === Q && !this.is_music) || 2 === Q),
        (this.mutevol = 1),
        (this.startTime = this.isTimescaled ? B.kahanTime.sum : B.wallTime.sum),
        (this.gainNode = null),
      ...
      switch (
        ...
        case G:
          (this.gainNode = r()),
            this.gainNode.connect(n(e)),
            this.buffer.myapi === G
              ? t.bufferObject &&
                ((this.instanceObject = q.createBufferSource()),
    ...
    function A(t, e) {
      if ((cr.clearArray(_t), !t.length))
        return !H || H.hasEnded()
          ? void 0
          : (cr.clearArray(_t), void (_t[0] = H));
      var i, s, n;
      for (i = 0, s = J.length; i < s; i++)
        (n = J[i]), cr.equals_nocase(t, n.tag) && _t.push(n);
      e && _t.sort(C);
    }
    function k(t) {
      var e,
        ...
        n,
        r = q.destination;
      if (ut.hasOwnProperty(t) && ((s = ut[t]), s.length))
        for (r = s[0].getInputNode(), e = 0, i = s.length; e < i; e++)
          (n = s[e]),
            e + 1 === i
              ? n.connectTo(q.destination)
              : n.connectTo(s[e + 1].getInputNode());
      for (A(t), e = 0, i = _t.length; e < i; e++) _t[e].reconnect(r);
      ot && ht === t && (ot.disconnect(), ot.connect(r));
    }
    function E(t, e) {
      ut.hasOwnProperty(t) ? ut[t].push(e) : (ut[t] = [e]), k(t);
    }
    function P() {}
    function I() {}
    function R() {}
    ...
    (u.prototype.connectTo = function (t) {
        ...
        switch (t) {
          case 0:
            (e /= 100),
              ...
              e > 1 && (e = 1),
              (this.params[5] = e),
              l(this.wetNode.gain, e, i, s),
              l(this.dryNode.gain, 1 - e, i, s);
            break;
          case 1:
        ...
        switch (e) {
          case 0:
            (i /= 100),
              ...
              i > 1 && (i = 1),
              (this.params[2] = i),
              l(this.wetNode.gain, i, s, n),
              l(this.dryNode.gain, 1 - i, s, n);
            break;
          case 4:
        ...
        switch (t) {
          case 0:
            (e /= 100),
              ...
              e > 1 && (e = 1),
              (this.params[4] = e),
              l(this.wetNode.gain, e / 2, i, s),
              l(this.dryNode.gain, 1 - e / 2, i, s);
            break;
          case 6:
          ...
          case 8:
            (this.params[3] = e / 100),
              l(this.feedbackNode.gain, e / 100, i, s);
        }
      }),
      ...
      (m.prototype.setParam = function (e, i, s, n) {
        switch (e) {
          case 4:
        ...
        switch (t) {
          case 0:
            (e /= 100),
              ...
              e > 1 && (e = 1),
              (this.params[1] = e),
              l(this.node.gain.value, 1 - e / 2, i, s),
              l(this.oscGainNode.gain.value, e / 2, i, s);
            break;
          case 7:
      ...
      (v.prototype.shape = function (t, e, i) {
        var s = 1.05 * i * e,
          ...
          r = t < 0 ? -1 : 1,
          a = t < 0 ? -t : t,
          o = a < e ? a : e + n * b(a - e, 1 / n);
        return (o *= r);
      }),
      (v.prototype.generateColortouchCurve = function (t, e) {
        for (
          var s = i(t), n = i(e), r = 65536, a = r / 2, o = 0, h = 0;
          h < a;
          ++h
        )
          (o = h / a),
      ...
      (w.prototype.setParam = function (t, e, i, s) {}),
      (x.prototype.tick = function () {
        ...
        var t = this.node.fftSize,
          i = 0;
        this.peak = 0;
        for (var s = 0, n = 0; i < t; i++)
          (n = (this.signal[i] - 128) / 128),
            n < 0 && (n = -n),
    ...
    (T.prototype.setObject = function (t) {
      (this.obj = t),
        this.obj && ((this.lastX = this.obj.x), (this.lastY = this.obj.y)),
        cr.clearArray(this.speeds);
    }),
      (T.prototype.hasObject = function () {
        return !!this.obj;
      }),
      (T.prototype.tick = function (t) {
        if (this.obj && 0 !== t) {
          this.moveAngle = cr.angleTo(
            this.lastX,
            this.lastY,
            this.obj.x,
            this.obj.y
          ...
          var e =
            cr.distanceTo(this.lastX, this.lastY, this.obj.x, this.obj.y) / t;
          this.speeds.length < dt
            ? this.speeds.push(e)
            : (this.speeds.shift(), this.speeds.push(e)),
      ...
      (T.prototype.getVelocityX = function () {
        return Math.cos(this.moveAngle) * this.getSpeed();
      }),
      (T.prototype.getVelocityY = function () {
        return Math.sin(this.moveAngle) * this.getSpeed();
      });
    var ft = !1;
    (S.prototype.decodeAudioBuffer = function () {
      if (!this.bufferObject && this.audioData) {
        var t = this;
        if (q.decodeAudioData)
          q.decodeAudioData(
            this.audioData,
            function (e) {
              (t.bufferObject = e), (t.audioData = null);
              var i, s, n, r;
              if (cr.is_undefined(t.playTagWhenReady) || K) {
                ...
                for (s = 0, n = t.panWhenReady.length; s < n; s++)
                  if (
                    ((i = t.panWhenReady[s]),
                    (r = new O(t, i.thistag)),
                    r.setPannerEnabled(!0),
                    "undefined" == typeof i.objUid ||
                      ((i.obj = B.getObjectByUID(i.objUid)), i.obj))
                  ) {
                    if (i.obj) {
                      var o = cr.rotatePtAround(
                          i.obj.x,
                          i.obj.y,
                          -i.obj.layer.getAngle(),
                          $,
                          tt,
                          !0
                        ),
                      ...
                      r.setPan(
                        o,
                        h,
                        cr.to_degrees(i.obj.angle - i.obj.layer.getAngle()),
                        i.ia,
                        i.oa,
                        i.og
                      ),
                    ...
                    r.play(t.loopWhenReady, t.volumeWhenReady, t.seekWhenReady),
                      t.pauseWhenReady && r.pause(),
                      J.push(r);
                  }
                cr.clearArray(t.panWhenReady);
              } else
                (r = new O(t, t.playTagWhenReady || "")),
                  r.play(t.loopWhenReady, t.volumeWhenReady, t.seekWhenReady),
                  t.pauseWhenReady && r.pause(),
                  J.push(r);
            },
      ...
      (S.prototype.isLoadedAndDecoded = function () {
        switch (this.myapi) {
          case W:
      ...
      (S.prototype.hasFailedToLoad = function () {
        switch (this.myapi) {
          case W:
      ...
      (O.prototype.setPannerEnabled = function (t) {
        if (U === G)
          if (!this.pannerEnabled && t) {
            ...
            this.pannerNode ||
              ((this.pannerNode = q.createPanner()),
              "number" == typeof this.pannerNode.panningModel
                ? (this.pannerNode.panningModel = it)
              ...
              "number" == typeof this.pannerNode.distanceModel
                ? (this.pannerNode.distanceModel = st)
                : (this.pannerNode.distanceModel = [
                    "linear",
                    "inverse",
                    "exponential",
                  ][st]),
              (this.pannerNode.refDistance = nt),
              (this.pannerNode.maxDistance = rt),
              (this.pannerNode.rolloffFactor = at)),
              this.gainNode.disconnect(),
              this.gainNode.connect(this.pannerNode),
              this.pannerNode.connect(n(this.tag)),
              (this.pannerEnabled = !0);
          } else if (this.pannerEnabled && !t) {
            if (!this.gainNode) return;
            this.pannerNode.disconnect(),
              this.gainNode.disconnect(),
              this.gainNode.connect(n(this.tag)),
              (this.pannerEnabled = !1);
          }
      }),
      ...
      (O.prototype.setObject = function (t) {
        this.pannerEnabled &&
          U === G &&
          (this.objectTracker || (this.objectTracker = new T()),
      ...
      (O.prototype.tick = function (t) {
        if (
          ...
          var n = 0;
          "undefined" != typeof this.objectTracker.obj.angle &&
            ((n = e.angle - e.layer.getAngle()),
            ...
            this.pannerNode.setVelocity(i, s, 0);
        }
      }),
      (O.prototype.play = function (t, e, i) {
        ...
        switch (this.myapi) {
          case W:
            if (
              (1 !== s.playbackRate && (s.playbackRate = 1),
              s.volume !== e * Z && (s.volume = e * Z),
              s.loop !== t && (s.loop = t),
              s.muted && (s.muted = !1),
              s.currentTime !== n)
            )
          ...
          case G:
            if (
              ((this.muted = !1), (this.mutevol = 1), this.buffer.myapi === G)
            )
              (this.gainNode.gain.value = e * Z),
                this.fresh ||
                  ((this.instanceObject = q.createBufferSource()),
                ...
                0 === n
                  ? o(this.instanceObject)
                  : h(this.instanceObject, n, this.getDuration());
            else {
              if (
                (1 !== s.playbackRate && (s.playbackRate = 1),
                s.loop !== t && (s.loop = t),
              ...
              this.is_music && ct && !B.isInUserInputEvent
                ? lt.push(this)
                : s.play();
            }
            break;
          case z:
            ((!this.fresh && this.stopped) || 0 !== n) && s.seekTo(n),
              s.play(),
              (this.hasPlaybackEnded = !1);
            break;
          case V:
            B.isDirectCanvas
              ? AppMobi.context.playSound(this.src, t)
              : AppMobi.player.playSound(this.src, t);
        }
        (this.playbackRate = 1),
          (this.startTime =
            (this.isTimescaled ? B.kahanTime.sum : B.wallTime.sum) - n),
          (this.fresh = !1),
          (this.stopped = !1),
          (this.is_paused = !1);
      }),
            ...
            case G:
              this.buffer.myapi === G
                ? ((this.instanceObject = q.createBufferSource()),
                  ...
                  (this.gainNode.gain.value = Z * this.volume * this.mutevol),
                  this.updatePlaybackRate(),
                  (this.startTime =
                    (this.isTimescaled ? B.kahanTime.sum : B.wallTime.sum) -
      ...
      (O.prototype.getDuration = function (t) {
        ...
        switch (this.myapi) {
          case W:
            "undefined" != typeof this.instanceObject.duration &&
      ...
      (O.prototype.getPlaybackTime = function (t) {
        ...
        switch (this.myapi) {
          case W:
            "undefined" != typeof this.instanceObject.currentTime &&
        ...
        return (
          t && (i *= this.playbackRate), !this.looping && i > e && (i = e), i
        );
      }),
      ...
      (O.prototype.updateVolume = function () {
        ...
        switch ((isFinite(t) || (t = 0), this.myapi)) {
          case W:
            "undefined" != typeof this.instanceObject.volume &&
      ...
      (L.Instance = function (t) {
        (this.type = t),
          ...
          "undefined" != typeof AudioContext
            ? ((U = G), (q = new AudioContext()))
            : "undefined" != typeof webkitAudioContext &&
              ((U = G), (q = new webkitAudioContext())),
          this.runtime.isiOS &&
            q &&
            (q.close && q.close(),
            "undefined" != typeof AudioContext
              ? (q = new AudioContext())
              : "undefined" != typeof webkitAudioContext &&
                (q = new webkitAudioContext()));
        var e =
          (this.runtime.isAndroid,
          function () {
            if (!et && q.createBuffer) {
              var t = q.createBuffer(1, 220, 22050),
                e = q.createBufferSource();
              (e.buffer = t), e.connect(q.destination), o(e);
            }
          });
        if (ct) {
          var i = function () {
            ...
            if (ct) {
              if (!K)
                for (t = 0, e = lt.length; t < e; ++t)
                  (i = lt[t]),
                    i.stopped || i.is_paused || i.instanceObject.play();
              cr.clearArray(lt);
            }
          };
          document.addEventListener(
        ...
        if (
          (U !== G &&
            (this.runtime.isCordova && "undefined" != typeof window.Media
              ? (U = z)
              : this.runtime.isAppMobi && (U = V)),
          U === z)
        ) {
          D = location.href;
          var s = D.lastIndexOf("/");
        ...
        if (
          ...
          if (this.runtime.isDirectCanvas) Y = this.runtime.isAndroid;
          else
            try {
    ...
    (gt.onCreate = function () {
      (this.runtime.audioInstance = this),
        ...
        (it = this.properties[3]),
        (st = this.properties[4]),
        (this.listenerZ = -this.properties[5]),
        (nt = this.properties[6]),
        (rt = this.properties[7]),
        (at = this.properties[8]),
        (this.listenerTracker = new T());
      var t = this.runtime.draw_width || this.runtime.width,
        e = this.runtime.draw_height || this.runtime.height;
      U === G &&
        ("undefined" != typeof q.listener.dopplerFactor &&
          (q.listener.dopplerFactor = 0),
        q.listener.setPosition(t / 2, e / 2, this.listenerZ),
        q.listener.setOrientation(0, 0, 1, 0, -1, 0),
        (window.c2OnAudioMicStream = function (t, e) {
          ot && ot.disconnect(),
            (ht = e.toLowerCase()),
            (ot = q.createMediaStreamSource(t)),
            ot.connect(n(ht));
        })),
      ...
      (gt.onInstanceDestroyed = function (t) {
        ...
        for (e = 0, i = J.length; e < i; e++)
          (s = J[e]),
            s.objectTracker &&
              s.objectTracker.obj === t &&
              ((s.objectTracker.obj = null),
              s.pannerEnabled && s.isPlaying() && s.looping && s.stop());
      ...
      (gt.saveToJSON = function () {
        var t,
          ...
          h = o.playing;
        for (t = 0, e = J.length; t < e; t++)
          (i = J[t]),
            i.shouldSave() &&
              3 !== this.saveload &&
              ((i.is_music && 1 === this.saveload) ||
                ((i.is_music || 2 !== this.saveload) &&
                  ((a = i.getPlaybackTime()),
                  ...
                  i.pannerEnabled &&
                    ((s.pan = {}),
                    (r = s.pan),
                    i.objectTracker && i.objectTracker.hasObject()
                      ? (r.objUid = i.objectTracker.obj.uid)
                      : ((r.x = i.panX), (r.y = i.panY), (r.a = i.panAngle)),
                    (r.ia = i.panConeInner),
                    (r.oa = i.panConeOuter),
                    (r.og = i.panConeOuterGain)),
                  h.push(s))));
        var c,
          l = o.effects;
        for (n in ut)
          if (ut.hasOwnProperty(n)) {
            for (c = [], t = 0, e = ut[n].length; t < e; t++)
              c.push({ type: ut[n][t].type, params: ut[n][t].params });
            l[n] = c;
          }
        return o;
      });
    ...
    (gt.loadFromJSON = function (t) {
      ...
      var i = t.listenerUid;
      i !== -1 &&
        ((this.listenerTracker.loadUid = i), mt.push(this.listenerTracker));
      var s,
        n,
        r,
        a,
        ...
        P = t.playing;
      if (3 !== this.saveload)
        for (s = 0, n = J.length; s < n; s++)
          (O = J[s]),
            (O.is_music && 1 === this.saveload) ||
              ((O.is_music || 2 !== this.saveload) && O.stop());
      var I, R, M, L;
      for (C in ut)
        if (ut.hasOwnProperty(C))
          for (s = 0, n = ut[C].length; s < n; s++) ut[C][s].remove();
      cr.wipe(ut);
      for (C in t.effects)
        if (t.effects.hasOwnProperty(C))
          for (I = t.effects[C], s = 0, n = I.length; s < n; s++)
            switch (((R = I[s].type), (M = I[s].params), R)) {
              case "filter":
                E(C, new u(M[0], M[1], M[2], M[3], M[4], M[5]));
                break;
              case "delay":
                E(C, new p(M[0], M[1], M[2]));
                break;
              case "convolve":
                (a = M[2]),
                  (S = this.getAudioBuffer(a, !1)),
                  S.bufferObject
                    ? (L = new d(S.bufferObject, M[0], M[1], a))
                    : ((L = new d(null, M[0], M[1], a)),
                      (S.normalizeWhenReady = M[0]),
                      (S.convolveWhenReady = L)),
                  E(C, L);
                break;
              case "flanger":
                E(C, new f(M[0], M[1], M[2], M[3], M[4]));
                break;
              case "phaser":
                E(C, new g(M[0], M[1], M[2], M[3], M[4], M[5]));
                break;
              case "gain":
                E(C, new m(M[0]));
                break;
              ...
              case "ringmod":
                ...
                break;
              case "distortion":
                E(C, new v(M[0], M[1], M[2], M[3], M[4]));
                break;
              case "compressor":
                E(C, new w(M[0], M[1], M[2], M[3], M[4]));
                break;
              case "analyser":
                E(C, new x(M[0], M[1]));
            }
      for (s = 0, n = P.length; s < n; s++)
        3 !== this.saveload &&
          ...
          (b = r.volume),
          (A = r.pan),
          (k = A && A.hasOwnProperty("objUid") ? A.objUid : -1),
          (o && 1 === this.saveload) ||
            ((o || 2 !== this.saveload) &&
              ((O = this.getAudioInstance(a, h, o, l, b)),
              O
                ? ((O.resume_position = r.resume_position),
                  O.setPannerEnabled(!!A),
                  O.play(l, b, c),
                  O.updatePlaybackRate(),
                  O.updateVolume(),
                  O.doSetMuted(O.is_muted || O.is_silent),
                  r.paused && O.pause(),
                  r.muted && O.setMuted(!0),
                  O.doSetMuted(O.is_muted || O.is_silent),
                  A &&
                    (k !== -1
                      ? ((O.objectTracker = O.objectTracker || new T()),
                        (O.objectTracker.loadUid = k),
                        mt.push(O.objectTracker))
                      : O.setPan(A.x, A.y, A.a, A.ia, A.oa, A.og)))
                : ((S = this.getAudioBuffer(a, o)),
                  (S.seekWhenReady = c),
                  (S.pauseWhenReady = r.paused),
                  A &&
                    (k !== -1
                      ? S.panWhenReady.push({
                          objUid: k,
      ...
      if (e && !K) {
        for (s = 0, n = J.length; s < n; s++) J[s].setSilent(!0);
        K = !0;
      } else if (!e && K) {
        for (s = 0, n = J.length; s < n; s++) J[s].setSilent(!1);
        K = !1;
      }
    }),
      (gt.afterLoad = function () {
        var t, e, i, s;
        for (t = 0, e = mt.length; t < e; t++)
          (i = mt[t]),
            (s = this.runtime.getObjectByUID(i.loadUid)),
            i.setObject(s),
            (i.loadUid = -1),
            s && (($ = s.x), (tt = s.y));
        cr.clearArray(mt);
      ...
      (gt.onSuspend = function (t) {
        if (!this.playinbackground) {
          !t && q && q.resume && (q.resume(), (et = !1));
          var e, i;
          for (e = 0, i = J.length; e < i; e++) J[e].setSuspended(t);
          t && q && q.suspend && (q.suspend(), (et = !0));
        }
      }),
      (gt.tick = function () {
        var t,
          ...
          s = this.runtime.dt;
        for (t = 0, e = J.length; t < e; t++)
          (i = J[t]), i.tick(s), 0 !== Q && i.updatePlaybackRate();
        var n, r, a;
        for (n in ut)
          if (ut.hasOwnProperty(n))
            for (r = ut[n], t = 0, e = r.length; t < e; t++)
              (a = r[t]), a.tick && a.tick();
        U === G &&
          this.listenerTracker.hasObject() &&
          (this.listenerTracker.tick(s),
          ($ = this.listenerTracker.obj.x),
          (tt = this.listenerTracker.obj.y),
          q.listener.setPosition(
            this.listenerTracker.obj.x,
            this.listenerTracker.obj.y,
            this.listenerZ
          ),
          q.listener.setVelocity(
    ...
    (gt.setPreloadList = function (t) {
      ...
      for (e = 0, i = t.length; e < i; ++e)
        (s = t[e]),
          (n = s[0]),
          (r = 2 * s[1]),
          (a = n.length > 4 && ".ogg" === n.substr(n.length - 4)),
          ((a && Y) || (!a && !Y)) &&
            (yt.push({ filename: n, size: r, obj: null }), (o += r));
      return o;
    }),
      (gt.startPreloads = function () {
        var t, e, i, s;
        for (t = 0, e = yt.length; t < e; ++t)
          (i = yt[t]),
            (s = this.runtime.files_subfolder + i.filename),
            (i.obj = this.getAudioBuffer(s, !1));
      }),
      (gt.getPreloadedSize = function () {
        ...
        for (t = 0, e = yt.length; t < e; ++t)
          (i = yt[t]),
            i.obj.isLoadedAndDecoded() ||
            i.obj.hasFailedToLoad() ||
            this.runtime.isDomFree ||
            this.runtime.isAndroidStockBrowser
              ? (s += i.size)
              : i.obj.isLoaded() && (s += Math.floor(i.size / 2));
        return s;
      }),
      (gt.getAudioBuffer = function (t, e) {
        var i,
          ...
          n,
          r = null;
        for (i = 0, s = X.length; i < s; i++)
          if (((n = X[i]), n.src === t)) {
            r = n;
            break;
          }
        return r || ((r = new S(t, e)), X.push(r)), r;
      }),
      (gt.getAudioInstance = function (t, e, i, s, n) {
        var r, a, o;
        for (r = 0, a = J.length; r < a; r++)
          if (((o = J[r]), o.src === t && (o.canBeRecycled() || i)))
            return (o.tag = e), o;
        var h = this.getAudioBuffer(t, i);
        return h.bufferObject
          ? ((o = new O(h, e)), J.push(o), o)
          : ("<preload>" !== e &&
    ...
    (P.prototype.OnEnded = function (t) {
      ...
      (P.prototype.PreloadsComplete = function () {
        ...
        for (t = 0, e = X.length; t < e; t++)
          if (!X[t].isLoadedAndDecoded() && !X[t].hasFailedToLoad()) return !1;
        return !0;
      }),
      ...
      (P.prototype.IsAnyPlaying = function () {
        var t, e;
        for (t = 0, e = J.length; t < e; t++) if (J[t].isPlaying()) return !0;
        return !1;
      }),
      (P.prototype.IsTagPlaying = function (t) {
        A(t);
        var e, i;
        for (e = 0, i = _t.length; e < i; e++) if (_t[e].isPlaying()) return !0;
        return !1;
      }),
      (L.cnds = new P()),
      (I.prototype.Play = function (e, i, s, n) {
        if (!K) {
          var r = t(s),
            a = e[1],
            o = this.runtime.files_subfolder + e[0] + (Y ? ".ogg" : ".m4a");
          (H = this.getAudioInstance(o, n, a, 0 !== i, r)),
            H && (H.setPannerEnabled(!1), H.play(0 !== i, r));
        }
      }),
      (I.prototype.PlayAtPosition = function (e, i, s, n, r, a, o, h, c, l) {
        if (!K) {
          var u = t(s),
            p = e[1],
            d = this.runtime.files_subfolder + e[0] + (Y ? ".ogg" : ".m4a");
          if (((H = this.getAudioInstance(d, l, p, 0 !== i, u)), !H)) {
          ...
          H.setPannerEnabled(!0),
            H.setPan(n, r, a, o, h, t(c)),
            H.play(0 !== i, u);
        }
      }),
      (I.prototype.PlayAtObject = function (e, i, s, n, r, a, o, h) {
        if (!K && n) {
          var c = n.getFirstPicked();
          if (c) {
            var l = t(s),
              u = e[1],
              p = this.runtime.files_subfolder + e[0] + (Y ? ".ogg" : ".m4a");
            if (((H = this.getAudioInstance(p, h, u, 0 !== i, l)), !H)) {
        ...
        if (!K) {
          var a = t(n),
            ...
            h =
              ...
              i.toLowerCase() +
              (Y ? ".ogg" : ".m4a");
          (H = this.getAudioInstance(h, r, o, 0 !== s, a)),
            H && (H.setPannerEnabled(!1), H.play(0 !== s, a));
        }
      }),
      (I.prototype.PlayAtPositionByName = function (
        e,
        i,
        s,
        n,
        ...
        if (!K) {
          var p = t(n),
            ...
            f =
              ...
              i.toLowerCase() +
              (Y ? ".ogg" : ".m4a");
          if (((H = this.getAudioInstance(f, u, d, 0 !== s, p)), !H)) {
          ...
          H.setPannerEnabled(!0),
            H.setPan(r, a, o, h, c, t(l)),
            H.play(0 !== s, p);
        }
      }),
      (I.prototype.PlayAtObjectByName = function (e, i, s, n, r, a, o, h, c) {
        if (!K && r) {
          ...
          if (l) {
            var u = t(n),
              ...
              d =
                ...
                i.toLowerCase() +
                (Y ? ".ogg" : ".m4a");
            if (((H = this.getAudioInstance(d, c, p, 0 !== s, u)), !H)) {
              var f = this.getAudioBuffer(d, p);
              return void f.panWhenReady.push({
                obj: l,
                ia: a,
            ...
            H.setPan(
              g,
              m,
              cr.to_degrees(l.angle - l.layer.getAngle()),
              a,
              o,
              t(h)
            ),
      ...
      (I.prototype.SetLooping = function (t, e) {
        A(t);
        var i, s;
        for (i = 0, s = _t.length; i < s; i++) _t[i].setLooping(0 === e);
      }),
      (I.prototype.SetMuted = function (t, e) {
        A(t);
        var i, s;
        for (i = 0, s = _t.length; i < s; i++) _t[i].setMuted(0 === e);
      }),
      (I.prototype.SetVolume = function (e, i) {
        ...
        var s,
          n,
          r = t(i);
        for (s = 0, n = _t.length; s < n; s++) _t[s].setVolume(r);
      }),
      (I.prototype.Preload = function (t) {
        if (!K) {
          var e = t[1],
            i = this.runtime.files_subfolder + t[0] + (Y ? ".ogg" : ".m4a");
          return U === V
            ? void (this.runtime.isDirectCanvas
                ? AppMobi.context.loadSound(i)
                : AppMobi.player.loadSound(i))
            : void (U !== z && this.getAudioInstance(i, "<preload>", e, !1));
        }
      }),
      (I.prototype.PreloadByName = function (t, e) {
        if (!K) {
          ...
          return U === V
            ? void (this.runtime.isDirectCanvas
                ? AppMobi.context.loadSound(s)
                : AppMobi.player.loadSound(s))
            : void (U !== z && this.getAudioInstance(s, "<preload>", i, !1));
        }
      }),
      (I.prototype.SetPlaybackRate = function (t, e) {
        A(t), e < 0 && (e = 0);
        var i, s;
        for (i = 0, s = _t.length; i < s; i++) _t[i].setPlaybackRate(e);
      }),
      ...
      (I.prototype.StopAll = function () {
        var t, e;
        for (t = 0, e = J.length; t < e; t++) J[t].stop();
      }),
      (I.prototype.SetPaused = function (t, e) {
        A(t);
        var i, s;
        for (i = 0, s = _t.length; i < s; i++)
          0 === e ? _t[i].pause() : _t[i].resume();
      }),
      (I.prototype.Seek = function (t, e) {
        A(t);
        var i, s;
        for (i = 0, s = _t.length; i < s; i++) _t[i].seek(e);
      }),
      (I.prototype.SetSilent = function (t) {
        var e, i;
        if ((2 === t && (t = K ? 1 : 0), 0 !== t || K)) {
          if (1 === t && K) {
            for (e = 0, i = J.length; e < i; e++) J[e].setSilent(!1);
            K = !1;
          }
        } else {
          for (e = 0, i = J.length; e < i; e++) J[e].setSilent(!0);
          K = !0;
        }
      }),
      (I.prototype.SetMasterVolume = function (e) {
        Z = t(e);
        var i, s;
        for (i = 0, s = J.length; i < s; i++) J[i].updateVolume();
      }),
      (I.prototype.AddFilterEffect = function (t, e, i, s, n, r, a) {
        U !== G ||
          e < 0 ||
          e >= pt.length ||
      ...
      (I.prototype.AddFlangerEffect = function (t, e, i, s, n, r) {
        U === G &&
          ...
          r < 0 && (r = 0),
          r > 1 && (r = 1),
          E(t, new f(e / 1e3, i / 1e3, s, n / 100, r)));
      }),
      (I.prototype.AddPhaserEffect = function (t, e, i, s, n, r, a) {
        U === G &&
          q.createOscillator &&
          ((t = t.toLowerCase()),
          (a /= 100),
          a < 0 && (a = 0),
          a > 1 && (a = 1),
          E(t, new g(e, i, s, n, r, a)));
      }),
      (I.prototype.AddConvolutionEffect = function (t, e, i, s) {
        if (U === G && q.createConvolver) {
          var n = 0 === i,
            r = this.runtime.files_subfolder + e[0] + (Y ? ".ogg" : ".m4a"),
            a = this.getAudioBuffer(r, !1);
          (t = t.toLowerCase()), (s /= 100), s < 0 && (s = 0), s > 1 && (s = 1);
          var o;
          a.bufferObject
            ? (o = new d(a.bufferObject, n, s, r))
            : ((o = new d(null, n, s, r)),
              (a.normalizeWhenReady = n),
              (a.convolveWhenReady = o)),
            E(t, o);
        }
      }),
      (I.prototype.AddGainEffect = function (e, i) {
        U === G && ((e = e.toLowerCase()), E(e, new m(t(i))));
      }),
      (I.prototype.AddMuteEffect = function (t) {
        U === G && ((t = t.toLowerCase()), E(t, new m(0)));
      }),
      ...
      (I.prototype.AddCompressorEffect = function (t, e, i, s, n, r) {
        U === G &&
          q.createDynamicsCompressor &&
          ((t = t.toLowerCase()), E(t, new w(e, i, s, n / 1e3, r / 1e3)));
      }),
      (I.prototype.AddAnalyserEffect = function (t, e, i) {
        U === G && ((t = t.toLowerCase()), E(t, new x(e, i)));
      }),
      ...
      (I.prototype.SetEffectParameter = function (t, e, i, s, n, r) {
        if (U === G) {
          ...
          var a;
          ut.hasOwnProperty(t) &&
            ((a = ut[t]), e < 0 || e >= a.length || a[e].setParam(i, s, n, r));
        }
      }),
      ...
      (L.acts = new I()),
      (R.prototype.Duration = function (t, e) {
        A(e, !0), _t.length ? t.set_float(_t[0].getDuration()) : t.set_float(0);
      }),
      (R.prototype.PlaybackTime = function (t, e) {
        A(e, !0),
          _t.length ? t.set_float(_t[0].getPlaybackTime(!0)) : t.set_float(0);
      }),
      (R.prototype.Volume = function (t, i) {
        if ((A(i, !0), _t.length)) {
          var s = _t[0].getVolume();
          t.set_float(e(s));
        } else t.set_float(0);
      }),
      (R.prototype.MasterVolume = function (t) {
        t.set_float(e(Z));
      }),
      (R.prototype.EffectCount = function (t, e) {
        e = e.toLowerCase();
        var i = null;
        ut.hasOwnProperty(e) && (i = ut[e]), t.set_int(i ? i.length : 0);
      }),
      (R.prototype.AnalyserFreqBinCount = function (t, e, i) {
        (e = e.toLowerCase()), (i = Math.floor(i));
        var s = M(e, i);
        t.set_int(s ? s.node.frequencyBinCount : 0);
      }),
      (R.prototype.AnalyserFreqBinAt = function (t, e, i, s) {
        (e = e.toLowerCase()), (i = Math.floor(i)), (s = Math.floor(s));
        var n = M(e, i);
        n
          ? s < 0 || s >= n.node.frequencyBinCount
            ? t.set_float(0)
            : t.set_float(n.freqBins[s])
          : t.set_float(0);
      }),
      (R.prototype.AnalyserPeakLevel = function (t, e, i) {
        (e = e.toLowerCase()), (i = Math.floor(i));
        var s = M(e, i);
        s ? t.set_float(s.peak) : t.set_float(0);
      }),
      (R.prototype.AnalyserRMSLevel = function (t, e, i) {
        (e = e.toLowerCase()), (i = Math.floor(i));
        var s = M(e, i);
        s ? t.set_float(s.rms) : t.set_float(0);
      }),
      (R.prototype.SampleRate = function (t) {
        t.set_int(q ? q.sampleRate : 0);
      }),
      (L.exps = new R());
  })(),
  ...
  (function () {
    ...
    (Acts.prototype.RequestFullScreen = function (t) {
      ...
      (Acts.prototype.Vibrate = function (t) {
        try {
          ...
          navigator.vibrate
            ...
            ? navigator.mozVibrate(s)
            : navigator.webkitVibrate
            ? navigator.webkitVibrate(s)
            : navigator.msVibrate && navigator.msVibrate(s);
        } catch (t) {}
      }),
      ...
      (Acts.prototype.ExecJs = function (js_) {
        try {
          ...
          console &&
            console.error &&
            console.error("Error executing Javascript: ", t);
        }
      });
    var orientations = [
      "portrait",
    ...
    (Acts.prototype.LockOrientation = function (t) {
      if (((t = Math.floor(t)), !(t < 0 || t >= orientations.length))) {
        ...
        screen.orientation && screen.orientation.lock
          ? screen.orientation.lock(e)
          : screen.lockOrientation
          ? screen.lockOrientation(e)
          : screen.webkitLockOrientation
          ? screen.webkitLockOrientation(e)
          : screen.mozLockOrientation
      ...
      (Exps.prototype.QueryParam = function (t, e) {
        ...
        i
          ? t.set_string(decodeURIComponent(i[1].replace(/\+/g, " ")))
          : t.set_string("");
      }),
      (Exps.prototype.Bandwidth = function (t) {
        var e =
          ...
          navigator.webkitConnection;
        e
          ? "undefined" != typeof e.bandwidth
            ? t.set_float(e.bandwidth)
            : "undefined" != typeof e.downlinkMax
    ...
    (l.onCreate = function () {
      ...
      window.c2_callFunction = function (i, s) {
        var r,
          ...
          o,
          h = e();
        if (((h.name = i.toLowerCase()), (h.retVal = 0), s))
          for (h.params.length = s.length, r = 0, a = s.length; r < a; ++r)
            (o = s[r]),
      ...
      (r.prototype.CompareParam = function (t, e, s) {
        ...
        return (
          !!n &&
          ((t = cr.floor(t)),
          !(t < 0 || t >= n.params.length) && cr.do_cmp(n.params[t], e, s))
        );
      }),
      (h.cnds = new r()),
      (a.prototype.CallFunction = function (t, i) {
        var s = e();
        (s.name = t.toLowerCase()),
          (s.retVal = 0),
          cr.shallowAssignArray(s.params, i);
        this.runtime.trigger(
          cr.plugins_.Function.prototype.cnds.OnFunction,
          this,
          s.name
      ...
      (a.prototype.CallExpression = function (t) {}),
      (h.acts = new a()),
      (o.prototype.ReturnValue = function (t) {
        var e = s();
      ...
      (o.prototype.Param = function (t, e) {
        e = cr.floor(e);
        var s = i();
        s && e >= 0 && e < s.params.length
          ? t.set_any(s.params[e])
          : t.set_int(0);
      }),
      (o.prototype.Call = function (t, i) {
        ...
        var r, a;
        for (r = 2, a = arguments.length; r < a; r++)
          s.params.push(arguments[r]);
        this.runtime.trigger(
          cr.plugins_.Function.prototype.cnds.OnFunction,
          this,
          s.name
    ...
    !(function () {
          ...
          e =
            function (t) {
              ...
              for (
                ...
                "exports" === h[u] ? l.push((a = {})) : l.push(e(i(h[u])));
        ...
        function i(t) {
          ...
          return new e(function (e, i) {
            ...
            for (var c = 0; c < t.length; c++)
              (a = t[c]), a && n(a.then) ? a.then(s(c), i) : r(c, a);
          });
        }
        var s = t.isArray,
          n = t.isFunction;
      ...
      t(
        ...
        function (t, e, i, s, n, r, a, o) {
          ...
          function p(t, e) {
            for (
              var i, s, n = t._subscribers, r = t._detail, a = 0;
              a < n.length;
              a += 3
            )
              (i = n[a]), (s = n[a + e]), l(e, i, s, r);
            t._subscribers = null;
          }
          function d(t, e) {
            var i,
          ...
          function g(t, e) {
            t._state === A && ((t._state = k), (t._detail = e), v.async(y, t));
          }
          function m(t, e) {
            t._state === A && ((t._state = k), (t._detail = e), v.async(_, t));
          }
          function y(t) {
            p(t, (t._state = E));
          }
        ...
        function i(t) {
          ...
          return new e(function (e, i) {
            for (var s, n = 0; n < t.length; n++)
              (s = t[n]),
                s && "function" == typeof s.then ? s.then(e, i) : e(s);
          });
        }
        var s = t.isArray;
        e.race = i;
    ...
    (function (t, e) {
      ...
      return (function (t) {
        function e(s) {
          ...
          return (
            t[s].call(n.exports, n, n.exports, e), (n.loaded = !0), n.exports
          );
        }
        var i = {};
          ...
          var n = (function (t) {
            ...
            var a = {},
              ...
              d = (function () {
                function t(e) {
                  s(this, t),
                    (this.INDEXEDDB = o.INDEXEDDB),
                    (this.LOCALSTORAGE = o.LOCALSTORAGE),
                    (this.WEBSQL = o.WEBSQL),
                    (this._defaultConfig = n({}, l)),
                    (this._config = n({}, this._defaultConfig, e)),
                    ...
                    var s = new Promise(function (e, i) {
                      try {
                        var s = t._driver,
                          ...
                          o = new Error(
                            "Custom driver name already in use: " + t._driver
                          );
                        if (!t._driver) return void i(n);
                        if (r(t._driver)) return void i(o);
                        for (
                          var h = c.concat("_initStorage"), l = 0;
                          l < h.length;
                          l++
                        ) {
                          var p = h[l];
                    ...
                    function n(t) {
                      return function () {
                        function e() {
                          ...
                          return (
                            (r._driverSet = Promise.reject(a)), r._driverSet
                          );
                        }
                        var i = 0;
                        return e();
                    ...
                    return (
                      (this._driverSet = o
                        ...
                        .catch(function () {
                          ...
                          return (
                            (r._driverSet = Promise.reject(t)), r._driverSet
                          );
                        })),
          ...
          var i = (function (t) {
              ...
              return new Promise(function (e, i) {
                ...
                s.open("GET", t),
                  ...
                  (s.onreadystatechange = function () {
                    return 4 === s.readyState
                      ? 200 === s.status
                        ? e({
                            response: s.response,
                            type: s.getResponseHeader("Content-Type"),
                          })
                        : void i({ status: s.status, response: s.response })
                      : void 0;
                  }),
                  s.send();
              });
            ...
            function n(t) {
              return new Promise(function (i, n) {
                var r = e([""], { type: "image/png" }),
                  a = t.transaction([E], "readwrite");
                a.objectStore(E).put(r, "key"),
            ...
            function p(t) {
              ...
              r ||
                ...
                (k[s.name] = r)),
                r.forages.push(i),
                i._initReady || ((i._initReady = i.ready), (i.ready = c));
              for (var a = [], o = 0; o < r.forages.length; o++) {
                var h = r.forages[o];
              ...
              return Promise.all(a)
                ...
                .then(function (t) {
                  return (s.db = t), m(s, i._defaultConfig.version) ? f(s) : t;
                })
                .then(function (t) {
                  ...
                  for (var e = 0; e < l.length; e++) {
                    var n = l[e];
                    n !== i &&
                      ((n._dbInfo.db = s.db), (n._dbInfo.version = s.version));
                  }
                });
            }
            function d(t) {
            ...
            function y(e, i) {
              var s = this;
              "string" != typeof e &&
                (t.console.warn(e + " used as a key, but it is not a string."),
                (e = String(e)));
              var n = new Promise(function (t, i) {
                s.ready()
                  .then(function () {
                    var n = s._dbInfo,
                      r = n.db
                        .transaction(n.storeName, "readonly")
                        .objectStore(n.storeName),
                      a = r.get(e);
                    (a.onsuccess = function () {
                      var e = a.result;
            ...
            if (C) {
              var A,
                k,
                E = "local-forage-detect-blob-support",
                P = {
        ...
        function (t, e, i) {
          ...
          var s = (function (t) {
            function e(t) {
              ...
              return (
                (s.keyPrefix = s.name + "/"),
                s.storeName !== e._defaultConfig.storeName &&
                  (s.keyPrefix += s.storeName + "/"),
                (e._dbInfo = s),
            ...
            function s(t) {
              var e = this,
                i = e.ready().then(function () {
                  for (
                    var t = e._dbInfo.keyPrefix, i = p.length - 1;
                    i >= 0;
                    i--
                  ) {
                    var s = p.key(i);
            ...
            function o(t) {
              var e = this,
                i = e.ready().then(function () {
                  for (
                    var t = e._dbInfo, i = p.length, s = [], n = 0;
                    i > n;
                    n++
                  )
                    0 === p.key(n).indexOf(t.keyPrefix) &&
                      s.push(p.key(n).substring(t.keyPrefix.length));
                  return s;
                });
              return u(i, t), i;
            }
            ...
            function l(e, i, s) {
              ...
              var r = n.ready().then(function () {
                ...
                return new Promise(function (s, r) {
                  var a = n._dbInfo;
                  a.serializer.serialize(i, function (i, n) {
                    if (n) r(n);
                    else
                      try {
                        p.setItem(a.keyPrefix + e, i), s(t);
                      } catch (t) {
        ...
        function (t, e) {
          ...
          var i = (function (t) {
              ...
              if (
                ...
                t &&
                  ("[object ArrayBuffer]" === t.toString() ||
                    (t.buffer &&
                      "[object ArrayBuffer]" === t.buffer.toString())))
              ) {
                var s,
                  n = c;
            ...
            function s(t) {
              ...
              if (r === p && h.test(s)) {
                var a = s.match(h);
                (i = a[1]), (s = s.substring(a[0].length));
              }
              var o = n(s);
              switch (r) {
                case u:
        ...
        function (t, e, i) {
          ...
          var s = (function (t) {
            function e(t) {
              ...
              if (t)
                for (var n in t)
                  s[n] = "string" != typeof t[n] ? t[n].toString() : t[n];
                    ...
                    .then(function () {
                      ...
                      s.db.transaction(function (e) {
                        e.executeSql(
                          ...
                          [],
                          function (e, i) {
                            for (var s = [], n = 0; n < i.rows.length; n++)
                              s.push(i.rows.item(n).key);
                            t(s);
                          },
                          function (t, e) {
                            i(e);
...
(cr.plugins_.LocalStorage = function (t) {
  ...
  (function () {
    ...
    (n.prototype.OnItemSet = function (t) {
      ...
      (d.cnds = new n()),
      (r.prototype.SetItem = function (i, s) {
        if ((commitScore(+s.split(",")[0]), localForageInitFailed))
          return void e(
            this,
      ...
      (r.prototype.GetAllKeyNames = function () {
        ...
        localforage.keys(function (e, r) {
          ...
          if (e)
            ...
            for (cr.clearArray(c), a = 0, o = r.length; a < o; ++a)
              (h = r[a]), i(h) && c.push(s(h));
            n.runtime.trigger(
      ...
      (d.acts = new r()),
      (a.prototype.ItemValue = function (t) {
        t.set_any(h);
      }),
  ...
  (function () {
    ...
    function e() {}
    function i() {}
    var s = cr.plugins_.Mouse.prototype;
    s.Type = function (t) {
      (this.plugin = t), (this.runtime = t.runtime);
    };
    ...
    (r.onMouseMove = function (t) {
      ...
      (r.mouseInGame = function () {
        return (
          this.runtime.fullscreen_mode > 0 ||
          (this.mouseXcanvas >= 0 &&
            this.mouseYcanvas >= 0 &&
    ...
    (e.prototype.SetCursor = function (t) {
      if (!this.runtime.isDomFree) {
        ...
        o !== e && ((o = e), (document.body.style.cursor = e));
      }
    }),
            ...
            if (o !== i) {
              ...
              var s = i.getDataUri(),
                n =
                  ...
                  s +
                  ") " +
                  Math.round(i.hotspotX * i.width) +
                  " " +
                  Math.round(i.hotspotY * i.height) +
                  ", auto";
      ...
      (s.acts = new e()),
      (i.prototype.X = function (t, e) {
        var i, s, n, r, a;
        cr.is_undefined(e)
          ? ((i = this.runtime.getLayerByNumber(0)),
            (s = i.scale),
            (n = i.zoomRate),
            (r = i.parallaxX),
            (a = i.angle),
  ...
  (function () {
    ...
    var s = function () {
      ...
      n = s.prototype;
    (n.alloc = function (t, e) {
      var i;
      return (
        this.lines.length > 0
          ? ((i = this.lines.pop()), i.Reset())
          : (i = t.CreateTimer(e)),
        i
      );
    }),
      ...
      (cr.plugins_.Rex_TimeLine.timer_cache = new s());
    var r = cr.plugins_.Rex_TimeLine.prototype;
    r.Type = function (t) {
      (this.plugin = t), (this.runtime = t.runtime);
    };
    var a = r.Type.prototype;
    (a.onCreate = function () {}),
      (r.Instance = function (t) {
        (this.type = t), (this.runtime = t.runtime);
      });
    var o = r.Instance.prototype,
      h = 0,
      c = 1,
      l = 2,
      u = 3,
    ...
    (o.onCreate = function () {
      if (
        ((this.update_manually = 0 == this.properties[0]),
        (this.update_with_game_time = 1 == this.properties[0]),
        (this.update_with_real_time = 2 == this.properties[0]),
        this.update_with_real_time)
      ) {
        var t = new Date();
        this.last_real_time = t.getTime();
      } else this.last_real_time = null;
      (this.my_timescale = -1),
        (this.timeline = new cr.plugins_.Rex_TimeLine.TimeLine()),
        (this.update_with_game_time || this.update_with_real_time) &&
          this.runtime.tickMe(this),
        (this.check_name = "TIMELINE"),
        this.recycled || (this.timers = {}),
      ...
      (o.onDestroy = function () {
        ...
        var t;
        for (t in this.timers) this.destroy_local_timer(t);
      }),
      (o.tick = function () {
        if (this.update_with_game_time) {
          ...
          var e = new Date(),
            i = e.getTime(),
            t = (i - this.last_real_time) / 1e3;
          this.timeline.Dispatch(t), (this.last_real_time = i);
        }
      }),
      (o.CreateTimer = function (t) {
        var e = new cr.plugins_.Rex_TimeLine.Timer(this.timeline);
        return e.TimeoutHandlerSet(t), e;
      }),
      (o.LoadTimer = function (t, e) {
        var i = this.CreateTimer(e);
        return i.loadFromJSON(t), i.afterLoad(), i;
      }),
      (o.setup_callback = function (t, e) {
        if (null == e) {
          if (this.cache_RexFnExt()) return;
          if (this.cache_RexFn2()) return;
          if (this.cache_Fn()) return;
          this._fnobj_type = c;
        } else
          switch (((this._fnobj_type = h), e)) {
            case l:
              this.cache_RexFnExt();
              break;
            case u:
      ...
      (o.cache_RexFnExt = function () {
        if (!cr.plugins_.Rex_FnExt) return !1;
        var t,
          e,
          i = this.runtime.types;
        for (t in i)
          if (
            ((e = i[t].instances[0]),
            e instanceof cr.plugins_.Rex_FnExt.prototype.Instance)
          )
            return (
              (this._fnobj = e),
              (this._act_call_fn =
                cr.plugins_.Rex_FnExt.prototype.acts.CallFunction),
      ...
      (o.cache_RexFn2 = function () {
        if (!cr.plugins_.Rex_Function2) return !1;
        var t,
          e,
          i = this.runtime.types;
        for (t in i)
          if (
            ((e = i[t].instances[0]),
            e instanceof cr.plugins_.Rex_Function2.prototype.Instance)
          )
            return (
              (this._fnobj = e),
              (this._act_call_fn =
                cr.plugins_.Rex_Function2.prototype.acts.CallFunction),
      ...
      (o.cache_Fn = function () {
        if (!cr.plugins_.Function) return !1;
        var t,
          e,
          i = this.runtime.types;
        for (t in i)
          if (
            ((e = i[t].instances[0]),
            e instanceof cr.plugins_.Function.prototype.Instance)
          )
            return (
              (this._fnobj = e),
              (this._act_call_fn =
      ...
      (o.RunCallback = function (t, e, i) {
        switch (
          (this._fnobj_type == h && this.setup_callback(i), this._fnobj_type)
        ) {
          case l:
            this._fnobj.CallFunction(t, e);
            break;
          case u:
          case p:
            this._act_call_fn.call(this._fnobj, t, e);
        }
        return this._fnobj_type != c;
      }),
      (o.Call = function (t, e) {
        switch (
          (this._fnobj_type == h && this.setup_callback(e), this._fnobj_type)
        ) {
          case l:
          case u:
          case p:
            this._exp_call.apply(this._fnobj, t);
        }
        return this._fnobj_type != c;
      }),
      (o.TimeGet = function () {
      ...
      (o.create_local_timer = function (t) {
        var e = this.timers[t];
        return (
          null != e
            ? e.Remove()
            : ((e = this.timer_cache.alloc(this, f)),
              (e.plugin = this),
              (this.timers[t] = e)),
          e
        );
      }),
      (o.destroy_local_timer = function (t) {
        var e = this.timers[t];
        null != e &&
          (e.Remove(), delete this.timers[t], this.timer_cache.free(e));
      }),
      (o.timer_cache_clean = function () {
        this.timer_cache.lines.length = 0;
      });
    var f = function () {
      var t = this.plugin;
      t.exp_triggered_timer_name = this._cb.name;
      var e = this._cb.command,
        i = this._cb.params;
      t.RunCallback(e, i, !0);
      0 === this._repeat_count
        ? this.Start()
        : this._repeat_count > 1 && ((this._repeat_count -= 1), this.Start());
    };
    (o._get_timer_cb_params = function (t) {
      var e = { name: t, command: "" };
      return this._fnobj_type == d ? (e.params = {}) : (e.params = []), e;
    }),
      ...
      (o.loadFromJSON = function (t) {
        (this.my_timescale = t.ts),
          this.timeline.loadFromJSON(t.tl),
          (this.timers_save = t.timers),
          (this.last_real_time = t.lrt),
          (this._fnobj_type = t.fnType),
          this.onDestroy(),
          this.timer_cache_clean();
      }),
      (o.afterLoad = function () {
        var t, e, i;
        for (t in this.timers_save)
          (e = this.timers_save[t]),
            (i = this.LoadTimer(e.tim, f)),
            (i.plugin = this),
            (i._cb = this._get_timer_cb_params(t)),
            (i._cb.command = e.cmd),
            (i._cb.params = e.pams),
            (i._repeat_count = e.rc);
        (this.timers_save = null), this.setup_callback(!1, this._fnobj_type);
      }),
      (r.cnds = new t()),
      (t.prototype.IsRunning = function (t) {
        var e = this.timers[t];
        return !!e && e.IsActive();
      }),
      (r.acts = new e()),
      (e.prototype.PushTimeLine = function (t) {
        this.update_manually && this.timeline.Dispatch(t);
      }),
      (e.prototype.Setup_deprecated = function () {}),
      (e.prototype.CreateTimer_deprecated = function () {}),
      (e.prototype.StartTimer = function (t, e, i) {
        var s = this.timers[t];
        s && ((s._repeat_count = i), s.Start(e));
      }),
      (e.prototype.StartTrgTimer = function (t) {
        var e = this.exp_triggered_timer_name,
          i = this.timers[e];
        i && i.Start(t);
      }),
      (e.prototype.PauseTimer = function (t) {
        var e = this.timers[t];
        e && e.Suspend();
      }),
      (e.prototype.ResumeTimer = function (t) {
        var e = this.timers[t];
        e && e.Resume();
      }),
      ...
      (e.prototype.CleanTimeLine = function () {
        this.timeline.CleanAll();
      }),
      (e.prototype.DeleteTimer = function (t) {
        this.destroy_local_timer(t);
      }),
      (e.prototype.SetTimerParameter = function (t, e, i) {
        var s = this.timers[t];
        s && (s._cb.params[e] = i);
      }),
      (e.prototype.PauseTimeLine = function () {
        this.update_with_game_time = !1;
      }),
      (e.prototype.ResumeTimeLine = function () {
        this.update_with_game_time = !0;
      }),
      (e.prototype.CreateTimer = function (t, e, i) {
        var s = this.create_local_timer(t);
        (s._cb = this._get_timer_cb_params(t)),
          (s._cb.command = e),
          cr.shallowAssignArray(s._cb.params, i);
      }),
      (e.prototype.SetTimerParameters = function (t, e) {
        var i = this.timers[t];
        i && cr.shallowAssignArray(i._cb.params, e);
      }),
      (e.prototype.SetTrgTimerParameters = function (t) {
        var e = this.exp_triggered_timer_name,
          i = this.timers[e];
        i && cr.shallowAssignArray(i._cb.params, t);
      }),
      (e.prototype.DeleteTrgTimer = function () {
        this.destroy_local_timer(this.exp_triggered_timer_name);
      }),
      (e.prototype.PushTimeLineTo = function (t) {
        if (this.update_manually) {
          var e = t - this.timeline.ABS_Time;
          e < 0 || this.timeline.Dispatch(e);
        }
      }),
      (e.prototype.SetupCallback = function (t) {
        var e,
          i,
          s = this.runtime.types;
        if (0 === t) {
          if (!cr.plugins_.Function) return;
          for (e in s)
            if (
              ((i = s[e].instances[0]),
              i instanceof cr.plugins_.Function.prototype.Instance)
            )
              return (
                (this._fnobj = i),
                (this._act_call_fn =
                  cr.plugins_.Function.prototype.acts.CallFunction),
                (this._exp_call = cr.plugins_.Function.prototype.exps.Call),
                void (this._fnobj_type = p)
              );
        } else if (1 === t) {
          if (!cr.plugins_.Rex_Function2) return;
          for (e in s)
            if (
              ((i = s[e].instances[0]),
              i instanceof cr.plugins_.Rex_Function2.prototype.Instance)
            )
              return (
                (this._fnobj = i),
                (this._act_call_fn =
                  cr.plugins_.Rex_Function2.prototype.acts.CallFunction),
                (this._exp_call =
                  cr.plugins_.Rex_Function2.prototype.exps.Call),
                void (this._fnobj_type = u)
              );
        }
      }),
      (r.exps = new i()),
      (i.prototype.TimerRemainder = function (t, e) {
        var i = this.timers[e],
          s = i ? i.RemainderTimeGet() : 0;
        t.set_float(s);
      }),
      (i.prototype.TimerElapsed = function (t, e) {
        var i = this.timers[e],
          s = i ? i.ElapsedTimeGet() : 0;
        t.set_float(s);
      }),
      (i.prototype.TimerRemainderPercent = function (t, e) {
        var i = this.timers[e],
          s = i ? i.RemainderTimePercentGet() : 0;
        t.set_float(s);
      }),
      (i.prototype.TimerElapsedPercent = function (t, e) {
        var i = this.timers[e],
          s = i ? i.ElapsedTimePercentGet() : 0;
        t.set_float(s);
      }),
      (i.prototype.TimeLineTime = function (t) {
        t.set_float(this.timeline.ABS_Time);
      }),
      (i.prototype.TriggeredTimerName = function (t) {
        t.set_string(this.exp_triggered_timer_name);
      }),
      (i.prototype.TimerDelayTime = function (t) {
  ...
  (function () {
    ...
    (t.CleanAll = function () {
      ...
      (t.RemoveTimer = function (t) {
        this._remove_timer_from_lists(t, !1), t._idle();
      }),
      (t.Dispatch = function (t) {
        (this.ABS_Time += t), this._waiting_timer_queue.sort(e);
        var i,
          s,
          n = this._waiting_timer_queue.length,
          r = 0;
        for (i = 0; i < n; i++)
          (s = this._waiting_timer_queue[i]),
            this._is_timer_time_out(s) &&
              (this._process_timer_queue.push(s), (r += 1));
        if (r) {
          for (i = r; i < n; i++)
            this._waiting_timer_queue[i - r] = this._waiting_timer_queue[i];
          this._waiting_timer_queue.length -= r;
        }
        for (; this._process_timer_queue.length > 0; )
          this._process_timer_queue.sort(e),
      ...
      (t.SuspendTimer = function (t) {
        var e = this._remove_timer_from_lists(t, !0);
        return e && (this._suspend_timer_queue.push(t), t.__suspend__()), e;
      }),
      (t.ResumeTimer = function (t) {
        var e = !1,
          i = this._suspend_timer_queue.indexOf(t);
        return (
          i != -1 &&
            (cr.arrayRemove(this._suspend_timer_queue, i),
            t.__resume__(),
            this.RegistTimer(t),
            (e = !0)),
          e
      ...
      (t.SetTimescale = function (t, e) {
        t._set_timescale(e);
        var i = this._remove_timer_from_lists(t, !0);
      ...
      (t._is_timer_time_out = function (t) {
        return t.abs_time <= this.ABS_Time;
      }),
      (t._add_timer_to_activate_lists = function (t) {
        var e = this._is_timer_time_out(t)
          ? this._process_timer_queue
          : this._waiting_timer_queue;
        e.push(t);
      }),
      (t._remove_timer_from_lists = function (t, e) {
        var i,
          s,
          n,
          r = !1,
          a = e ? this.activate_queue : this.all_queues,
          o = a.length;
        for (i = 0; i < o; i++)
          if (((s = a[i]), (n = s.indexOf(t)), n != -1)) {
            cr.arrayRemove(s, n), (r = !0);
            break;
          }
        return r;
      }),
      (cr.plugins_.Rex_TimeLine.Timer = function (t) {
        (this.timeline = t), this.Reset(), (this.extra = {});
      });
    ...
    (i.Reset = function () {
      (this.delay_time = 0),
        ...
        (this.timescale = 1),
        this._idle(),
        this._abs_timeout_set(0);
    }),
      (i.Restart = function (t) {
        null != t && (this.delay_time = t);
        var e = this.delay_time * this.timescale;
        this._abs_timeout_set(e),
          this._is_alive
            ? this._is_active ||
              ((this._remainder_time = this.abs_time), this.Resume())
            : (this.timeline.RegistTimer(this), this._run());
      }),
      (i.Start = i.Restart),
      (i.Suspend = function () {
      ...
      (i.SetTimescale = function (t) {
        t != this.timescale && this.timeline.SetTimescale(this, t);
      }),
      (i.ChangeRate = function (t) {
        this.timeline.ChangeTimerRate(this, t);
      }),
      (i.Remove = function () {
        this._is_alive && this.timeline.RemoveTimer(this);
      }),
      (i.IsAlive = function () {
      ...
      (i.RemainderTimeGet = function () {
        var t = 0;
        return (
          this.IsActive()
            ? (t = this.abs_time - this.timeline.CurrentTimeGet())
            : this.IsAlive() && (t = this._remainder_time),
          t
        );
      }),
      (i.RemainderTimeSet = function (t) {
        if (this.IsAlive()) {
          var e = cr.clamp(t, 0, this.delay_time);
          (this._remainder_time = e),
            (this.abs_time = this.timeline.CurrentTimeGet() + e);
        }
      }),
      ...
      (i.loadFromJSON = function (t) {
        (this.delay_time = t.dt),
          (this._is_alive = t.alive),
          (this._is_active = t.active),
          (this.timescale = t.hasOwnProperty("ts") ? t.ts : 1),
          (this.extra = t.ex),
          this.RemainderTimeSet(t.rt);
      }),
      (i.afterLoad = function () {
        this.IsAlive() &&
          (this.timeline.RegistTimer(this),
          this.IsActive() || this.timeline.SuspendTimer(this));
      }),
      (i._idle = function () {
        (this._is_alive = !1), (this._is_active = !1);
      }),
      (i._run = function () {
        (this._is_alive = !0), (this._is_active = !0);
      }),
      (i._abs_timeout_set = function (t) {
        this.abs_time = this.timeline.CurrentTimeGet() + t;
      }),
      ...
      (i.__resume__ = function () {
        this._abs_timeout_set(this._remainder_time), (this._is_active = !0);
      }),
      (i._set_timescale = function (t) {
        if (!(t < 0)) {
          var e = !1;
          if (
            (0 == t && this._is_active
              ...
              : t > 0 && !this._is_active
              ? (this.Resume(), (e = !0))
              : t > 0 && this._is_active && (e = !0),
            e)
          ) {
            var i = t / this.timescale;
            this._change_rate(i), (this.timescale = t);
          }
        }
      }),
      (i._change_rate = function (t) {
        if (this._is_active) {
          var e = this.timeline.CurrentTimeGet(),
            i = this.abs_time - e;
          this.abs_time = e + i * t;
        } else this._remainder_time *= t;
      });
  })(),
  ...
  (function () {
    ...
    function o(t, e) {
      ...
      for (i in t)
        t.hasOwnProperty(i) &&
          ((n = t[i]), (n[0] !== r && n[1] !== r) || (s(t[i]), delete t[i]));
    }
    function h(t, e, i) {
      var s = n(e.uid, i.uid);
      return t.hasOwnProperty(s) ? ((y = t[s][2]), !0) : ((y = -2), !1);
    }
    function c(t, e, i) {
      if (!t) return !1;
      var s,
      ...
      for (
        f.select_all
          ? (this.update_bbox(),
            T.copy(this.bbox),
            T.offset(e, i),
            this.runtime.getCollisionCandidates(this.layer, t, T, x),
            (h = x))
          : (h = g
              ? this.runtime.isCurrentConditionFirst() &&
                !f.else_instances.length &&
                f.instances.length
                ? f.instances
                : f.else_instances
              : f.instances),
      ...
      return (
        c && ((this.x = s), (this.y = n), this.set_bbox_changed()),
        cr.clearArray(x),
        l
      );
    }
    ...
    (d.onCreate = function () {
        ...
        for (
          ...
          for (
            ...
            (a = r[7][s]),
              ...
              (c = this.runtime.findWaitingTexture(a[0])),
              c
                ? (h.texture_img = c)
                : ((h.texture_img = new Image()),
      ...
      (d.updateAllCurrentTexture = function () {
        ...
        for (t = 0, e = this.instances.length; t < e; t++)
          (i = this.instances[t]),
            (i.curWebGLTexture = i.curFrame.webGL_texture);
      }),
      (d.onLostWebGLContext = function () {
        if (!this.is_family) {
          var t, e, i;
          for (t = 0, e = this.all_frames.length; t < e; ++t)
            (i = this.all_frames[t]),
              (i.texture_img.c2webGL_texture = null),
      ...
      (d.onRestoreWebGLContext = function () {
        if (!this.is_family && this.instances.length) {
          ...
          for (t = 0, e = this.all_frames.length; t < e; ++t)
            (i = this.all_frames[t]),
              (i.webGL_texture = this.runtime.glwrap.loadTexture(
                i.texture_img,
                !1,
                this.runtime.linearSampling,
                i.pixelformat
    ...
    (d.preloadCanvas2D = function (t) {
      var e, i, s;
      for (cr.clearArray(f), e = 0, i = this.all_frames.length; e < i; ++e)
        (s = this.all_frames[e].texture_img),
          f.indexOf(s) === -1 && (t.drawImage(s, 0, 0), f.push(s));
    }),
      (p.Instance = function (t) {
        (this.type = t), (this.runtime = t.runtime);
        var e = this.type.animations[0].frames[0].poly_pts;
        this.recycled
          ? this.collision_poly.set_pts(e)
          : (this.collision_poly = new cr.CollisionPoly(e));
      });
    ...
    (g.onCreate = function () {
      (this.visible = 0 === this.properties[0]),
        ...
        (1 === this.type.animations.length &&
          ...
          0 === this.type.animations[0].speed ||
      ...
      for (e = 0, i = this.type.animations.length; e < i; e++)
        for (
          r = this.type.animations[e], s = 0, n = r.frames.length;
          s < n;
          s++
        )
          (a = r.frames[s]),
            0 === a.width &&
              ((a.width = a.texture_img.width),
              (a.height = a.texture_img.height)),
            a.spritesheeted &&
              ((h = a.texture_img),
              (o = a.sheetTex),
              (o.left = a.offx / h.width),
              (o.top = a.offy / h.height),
              (o.right = (a.offx + a.width) / h.width),
              (o.bottom = (a.offy + a.height) / h.height),
              0 === a.offx &&
                0 === a.offy &&
                a.width === h.width &&
                a.height === h.height &&
      ...
      (g.tick = function () {
        ...
        this.animPlaying &&
          ...
          (this.frameStart += n),
          this.cur_frame >= i.frames.length &&
            (i.pingpong
              ? ((this.animForwards = !1),
                (this.cur_frame = i.frames.length - 2))
              : i.loop
              ? (this.cur_frame = this.cur_anim_repeatto)
              : (this.animRepeats++,
                this.animRepeats >= i.repeatcount
          ...
          this.cur_frame < 0
            ? (this.cur_frame = 0)
            : this.cur_frame >= i.frames.length &&
              (this.cur_frame = i.frames.length - 1),
          e >
            this.frameStart +
              i.frames[this.cur_frame].duration / this.cur_anim_speed &&
            (this.frameStart = e),
          (t = i.frames[this.cur_frame]),
          this.OnFrameChanged(s, t),
          (this.runtime.redraw = !0));
      }),
      (g.getAnimationByName = function (t) {
        var e, i, s;
        for (e = 0, i = this.type.animations.length; e < i; e++)
          if (((s = this.type.animations[e]), cr.equals_nocase(s.name, t)))
            return s;
        return null;
      }),
      ...
      (g.OnFrameChanged = function (t, e) {
        ...
        var a, o, h;
        for (a = 0, o = this.behavior_insts.length; a < o; a++)
          (h = this.behavior_insts[a]),
            h.onSpriteFrameChanged && h.onSpriteFrameChanged(t, e);
        this.runtime.trigger(
      ...
      (g.draw = function (t) {
        ...
        if (0 === this.angle && a >= 0 && o >= 0)
          (n -= this.hotspotX * a),
            ...
            i
              ? t.drawImage(s, e.offx, e.offy, e.width, e.height, n, r, a, o)
              : t.drawImage(s, n, r, a, o);
        else {
          this.runtime.pixel_rounding &&
            ((n = Math.round(n)), (r = Math.round(r))),
            t.save();
          ...
          i
            ...
            : t.drawImage(s, l, u, cr.abs(a), cr.abs(o)),
            t.restore();
        }
      }),
      ...
      (g.drawGL = function (t) {
        ...
        if (this.runtime.pixel_rounding) {
          ...
          e.spritesheeted
            ...
            : t.quad(i.tlx, i.tly, i.trx, i.try_, i.brx, i.bry, i.blx, i.bly);
      }),
      ...
      (g.getImagePoint = function (t, e) {
        var i,
          ...
          n = s.image_points;
        if (
          ((i = cr.is_string(t) ? this.getImagePointIndexByName(t) : t - 1),
          (i = cr.floor(i)),
          i < 0 || i >= n.length)
        )
        ...
        var o = Math.cos(this.angle),
          ...
          c = r * o - a * h;
        return (
          (a = a * o + r * h), (r = c), (r += this.x), (a += this.y), e ? r : a
        );
      });
    var m = [],
      y = -2,
      ...
      for (l = 0; l < x.length; l++) {
        for (
          u = x[l],
            w.select_all
              ? (u.update_bbox(),
                this.runtime.getCollisionCandidates(u.layer, t, u.bbox, _),
                (c = _))
              : (c = w.getObjects()),
            p = 0;
          p < c.length;
          ...
          (d = c[p]),
            e.testOverlap(u, d) || e.checkRegisteredCollision(u, d)
              ? ((m = h(n, u, d)),
                (v = !m || y < S),
                r(n, u, d, T),
                v &&
                  (e.pushCopySol(O.solModifiers),
                  (f = s.getCurrentSol()),
                  (g = t.getCurrentSol()),
                  (f.select_all = !1),
                  (g.select_all = !1),
                  s === t
                    ? ((f.instances.length = 2),
                      (f.instances[0] = u),
                      (f.instances[1] = d),
    ...
    (d.finish = function (t) {
      if (w) {
        if (t) {
          var e,
            i,
            s,
            n = this.runtime.getCurrentEventStack().current_event.orblock,
            r = v.getCurrentSol(),
            a = b.valuesRef();
          if (r.select_all) {
            for (
              r.select_all = !1,
                cr.clearArray(r.instances),
                e = 0,
                i = a.length;
              e < i;
              ++e
            ...
            if (n)
              for (
                cr.clearArray(r.else_instances), e = 0, i = v.instances.length;
                e < i;
                ++e
              )
                (s = v.instances[e]), b.contains(s) || r.else_instances.push(s);
          } else if (n) {
            var o = r.instances.length;
            for (e = 0, i = a.length; e < i; ++e)
              (r.instances[o + e] = a[e]),
                cr.arrayFindRemove(r.else_instances, a[e]);
      ...
      (p.cnds = new e()),
      (l.prototype.Spawn = function (t, e, i) {
        if (t && e) {
          var s = this.runtime.createInstance(
            t,
            e,
          ...
          if (s) {
            "undefined" != typeof s.angle &&
              ((s.angle = this.angle), s.set_bbox_changed()),
              this.runtime.isInOnDestroy++;
            var n, r, a;
            if (
              (this.runtime.trigger(
              ...
              for (n = 0, r = s.siblings.length; n < r; n++)
                (a = s.siblings[n]),
                  this.runtime.trigger(
                    Object.getPrototypeOf(a.type.plugin).cnds.OnCreated,
                    a
                  );
            this.runtime.isInOnDestroy--;
            var o = this.runtime.getCurrentAction(),
              h = !1;
            (cr.is_undefined(o.extra.Spawn_LastExec) ||
              o.extra.Spawn_LastExec < this.runtime.execcount) &&
              ((h = !0), (o.extra.Spawn_LastExec = this.runtime.execcount));
            var c;
            if (
              t != this.type &&
              ((c = t.getCurrentSol()),
              (c.select_all = !1),
              h
                ? (cr.clearArray(c.instances), (c.instances[0] = s))
                : c.instances.push(s),
              s.is_contained)
            )
              for (n = 0, r = s.siblings.length; n < r; n++)
                (a = s.siblings[n]),
                  (c = a.type.getCurrentSol()),
                  (c.select_all = !1),
                  h
                    ? (cr.clearArray(c.instances), (c.instances[0] = a))
                    : c.instances.push(a);
          }
        }
      }),
      ...
      (l.prototype.SetScale = function (t) {
        ...
        (this.width === n && this.height === r) ||
          ((this.width = n), (this.height = r), this.set_bbox_changed());
      }),
      (l.prototype.LoadURL = function (t, e) {
        var i = new Image(),
          ...
          n = this.curFrame;
        (i.onload = function () {
          return n.texture_img.src === i.src
            ? (s.runtime.glwrap &&
                s.curFrame === n &&
                (s.curWebGLTexture = n.webGL_texture),
              0 === e &&
                ((s.width = i.width),
                (s.height = i.height),
                s.set_bbox_changed()),
              (s.runtime.redraw = !0),
              void s.runtime.trigger(
            ...
            : ((n.texture_img = i),
              ...
              s.runtime.glwrap &&
                (n.webGL_texture &&
                  s.runtime.glwrap.deleteTexture(n.webGL_texture),
                (n.webGL_texture = s.runtime.glwrap.loadTexture(
                  i,
                  !1,
                  s.runtime.linearSampling
                )),
                s.curFrame === n && (s.curWebGLTexture = n.webGL_texture),
                s.type.updateAllCurrentTexture()),
              0 === e &&
                ((s.width = i.width),
                (s.height = i.height),
                s.set_bbox_changed()),
          ...
          "data:" !== t.substr(0, 5) && (i.crossOrigin = "anonymous"),
          (i.src = t);
      }),
      ...
      (p.acts = new l()),
      (u.prototype.AnimationFrame = function (t) {
  ...
  (function () {
    ...
    function n(e, i, s) {
      ...
      (s = t(s)),
        ...
        (n = a[i]),
        (n.text = s),
        (n.width = e.measureWidth(s)),
        (e.textWidth = cr.max(e.textWidth, n.width));
    }
    function r() {
      return e(b, Object);
    }
    ...
    function h(t, i, s, n, r, a) {
      void 0 === t[i] && (t[i] = e(w, Object)),
        (t[i].x = s),
        (t[i].y = n),
        (t[i].w = r),
        (t[i].h = a);
    ...
    function l(t, i, s, n, r, a) {
      void 0 === t[i] && (t[i] = e(x, cr.rect)),
        (t[i].left = s),
        (t[i].top = n),
        (t[i].right = r),
        (t[i].bottom = a);
    ...
    _.SplitSheet = function () {
      for (
        var t = this.texture_img,
          e = t.width,
          i = t.height,
          s = this.characterWidth,
          n = this.characterHeight,
          r = s / e,
          a = n / i,
          o = this.characterSet,
          c = Math.floor(e / s),
        ...
        var d = p % c,
          ...
          g = o.charAt(p);
        this.runtime.glwrap
          ? l(this.clipUV, g, d * r, f * a, (d + 1) * r, (f + 1) * a)
          : h(this.clipList, g, d * s, f * n, s, n);
      }
    };
    var T = [];
    (m.TokeniseWords = function (t) {
      ...
      (m.WordWrap = function (t) {
        ...
        var s = t.width;
        if (s <= 2) return void o(i);
        var n = t.characterWidth,
          a = t.characterScale,
          h = t.characterSpacing;
        if (e.length * (n * a + h) - h <= s && e.indexOf("\n") === -1) {
          ...
          if (c <= s)
            return (
              ...
              (i[0].width = c),
              (t.textWidth = c),
              void (t.textHeight = t.characterHeight * a + t.lineHeight)
            );
        }
        t.wrapbyword;
        this.WrapText(t),
          (t.textHeight = i.length * (t.characterHeight * a + t.lineHeight));
      }),
      (m.WrapText = function (e) {
        var i,
          ...
          o = e.lines,
          h = e.width;
        s ? (this.TokeniseWords(r), (i = T)) : (i = r);
        var c,
          l,
          u,
          p = "",
          ...
          "\n" !== i[u]
            ? ((f = !1),
              ...
              l > h &&
                ...
                s || " " !== p || (p = "")))
            : (f === !0 ? (f = !1) : (n(e, d, p), d++), (p = ""));
        for (t(p).length && (n(e, d, p), d++), u = d; u < o.length; u++)
          a(o[u]);
        o.length = d;
      }),
    ...
    _.draw = function (t, e) {
      ...
      if ("" !== this.text && null != i) {
        ...
        var c,
          ...
          y = this.lines,
          _ = this.textHeight,
          v = p * cr.max(0, this.height - _),
          b = -(this.hotspotX * this.width),
          w = -(this.hotspotY * this.height);
        w += v;
        for (var x, T, O, C = w, A = 0; A < y.length; A++) {
          var k = y[A].text,
            E = y[A].width;
          if (
            ((l = u * cr.max(0, this.width - E)),
            (x = b + l),
            (C += g),
            n + C + f < a)
          )
            ...
            for (var P = 0; P < k.length; P++) {
              var I = k.charAt(P);
              c = this.getCharacterWidth(I);
              var R = this.clipList[I];
              if (s + x + c * d + m < r) x += c * d + m;
              else {
                if (x + c * d > this.width + S) break;
                if (
                  (void 0 !== R &&
                    ((T = x),
                    (O = C),
            ...
            if (((C += f), C + f + g > this.height || n + C > h)) break;
          }
        }
        t.restore();
      }
    ...
    (_.drawGL = function (t) {
        ...
        for (
          ...
          if (
            ...
            for (var L = 0; L < R.length; L++) {
              ...
              var B = this.clipUV[F];
              if (k + x + n * g + _ < o) x += n * g + _;
              else {
                if (x + n * g > this.width + S) break;
                if (void 0 !== B) {
                  var N = this.characterWidth * g,
                    j = this.characterHeight * g;
                  (T = x),
                    (C = P),
                    0 === u && ((T = Math.round(T)), (C = Math.round(C))),
                    (O.tlx = T),
                    (O.tly = C),
                    (O.trx = T + N),
                    (O.try_ = C),
            ...
            if (((P += m), P + m + y > this.height || E + P > l)) break;
          }
        }
      }
    }),
      ...
      (m.acts = new f()),
      (g.prototype.CharacterWidth = function (t, e) {
  ...
  (function () {
    ...
    function i(t) {
      var i, s;
      for (i = 0, s = t.length; i < s; i++) e(t[i]);
      cr.clearArray(t);
    }
    function s(t) {
    ...
    var h = o.Type.prototype;
    (h.onCreate = function () {}),
      (h.onLostWebGLContext = function () {
        if (!this.is_family) {
          var t, e, i;
          for (t = 0, e = this.instances.length; t < e; t++)
            (i = this.instances[t]),
    ...
    (c.onCreate = function () {
      ...
      (c.draw = function (t, e) {
        ...
        var i = 1;
        e && ((i = this.layer.getScale()), t.save(), t.scale(i, i)),
          (this.text_changed || this.width !== this.lastwrapwidth) &&
        ...
        var r = n + this.height,
          a = this.pxHeight;
        a += this.line_height_offset;
        var o, h;
        for (
          1 === this.valign
            ? (n += Math.max(this.height / 2 - (this.lines.length * a) / 2, 0))
            : 2 === this.valign &&
              (n += Math.max(this.height - this.lines.length * a - 2, 0)),
            h = 0;
          h < this.lines.length &&
          ((o = s),
          1 === this.halign
            ? (o = s + (this.width - this.lines[h].width) / 2)
            : 2 === this.halign && (o = s + (this.width - this.lines[h].width)),
          t.fillText(this.lines[h].text, o, n),
          (n += a),
          !(n >= r - a));
          h++
        );
      ...
      (c.drawGL = function (t) {
        if (!(this.width < 1 || this.height < 1)) {
          ...
          this.myctx ||
            ...
            t.updateModelView();
          var u = this.bquad,
            p = this.layer.layerToCanvas(u.tlx, u.tly, !0, !0),
            d = this.layer.layerToCanvas(u.tlx, u.tly, !1, !0),
            f = this.layer.layerToCanvas(u.trx, u.try_, !0, !0),
            g = this.layer.layerToCanvas(u.trx, u.try_, !1, !0),
            m = this.layer.layerToCanvas(u.brx, u.bry, !0, !0),
            y = this.layer.layerToCanvas(u.brx, u.bry, !1, !0),
            _ = this.layer.layerToCanvas(u.blx, u.bly, !0, !0),
          ...
          0 === this.angle && 0 === s
            ? ((f = p + o),
              ...
              (n.right = 1),
              (n.bottom = 1))
            : ((n.right = r / o), (n.bottom = a / h)),
            t.quadTex(p, d, f, g, m, y, _, v, n),
            t.resetModelView(),
            t.scale(i, i),
    ...
    var p = [];
    (o.WordWrap = function (e, s, n, r, a) {
      if (!e || !e.length) return void i(s);
      if (r <= 2) return void i(s);
      if (e.length <= 100 && e.indexOf("\n") === -1) {
        var o = n.measureText(e).width;
        if (o <= r)
          return i(s), s.push(t()), (s[0].text = e), void (s[0].width = o);
      }
      this.WrapText(e, s, n, r, a);
    }),
      (o.WrapText = function (i, n, r, a, o) {
        var h;
        o ? (this.TokeniseWords(i), (h = u)) : (h = i);
        var c,
          l,
          p,
          d,
      ...
      (r.prototype.SetWebFont = function (t, e) {
        ...
        if (l.hasOwnProperty(e)) {
          ...
          for (var r = 1; r < 10; r++)
            setTimeout(s, 100 * r), setTimeout(s, 1e3 * r);
        } else {
      ...
      (a.prototype.FaceName = function (t) {
        t.set_string(this.facename);
      }),
      (a.prototype.FaceSize = function (t) {
      ...
      (a.prototype.TextWidth = function (t) {
        var e,
          ...
          s,
          n = 0;
        for (e = 0, i = this.lines.length; e < i; e++)
          (s = this.lines[e].width), n < s && (n = s);
        t.set_int(n);
      }),
    ...
    (r.onCreate = function () {
      ...
      (r.draw = function (t) {
        ...
        r < 0 && (r += this.texture_img.width),
          ...
          t.rotate(this.angle),
          t.translate(r, a),
          t.fillRect(s - r, n - a, this.width, this.height),
          t.restore();
      }),
        ...
        (e.onload = function () {
          (i.texture_img = e),
            i.runtime.glwrap
              ? (i.has_own_texture &&
                  i.webGL_texture &&
                  i.runtime.glwrap.deleteTexture(i.webGL_texture),
                (i.webGL_texture = i.runtime.glwrap.loadTexture(
                  e,
                  !0,
                  i.runtime.linearSampling
                )))
              : (i.pattern = i.runtime.ctx.createPattern(e, "repeat")),
            (i.has_own_texture = !0),
            (i.runtime.redraw = !0),
            i.runtime.trigger(
          ...
          "data:" !== t.substr(0, 5) && (e.crossOrigin = "anonymous"),
          (e.src = t);
      }),
      (s.acts = new e()),
      (i.prototype.ImageWidth = function (t) {
  ...
  (cr.plugins_.Tilemap = function (t) {
    this.runtime = t;
  }),
  (function () {
    function t() {
    ...
    function e() {
      return x.length ? x.pop() : new t();
    }
    function i(t) {
      x.length < 1e4 && x.push(t);
    }
    function s() {
      (this.id = -1), (this.rc = new cr.rect(0, 0, 0, 0)), (this.poly = null);
    }
    function n() {
      return T.length ? T.pop() : new s();
    }
    function r(t) {
      T.length < 1e4 && T.push(t);
    }
    function a(t, e, i) {
      var s;
      return S.length
        ? ((s = S.pop()),
          ...
          (s.x = e),
          (s.y = i),
          (s.left = s.x * s.inst.cellwidth * s.inst.tilewidth),
          (s.top = s.y * s.inst.cellheight * s.inst.tileheight),
          s.clear(),
          (s.quadmap_valid = !1),
          s)
        : new h(t, e, i);
    ...
    function o(t) {
      var e, s;
      for (e = 0, s = t.quads.length; e < s; ++e) i(t.quads[e]);
      for (
        cr.clearArray(t.quads), e = 0, s = t.collision_rects.length;
        e < s;
        ++e
      )
        r(t.collision_rects[e]);
      cr.clearArray(t.collision_rects), S.length < 1e3 && S.push(t);
    }
    function h(t, e, i) {
      (this.inst = t),
        (this.x = e),
        ...
        (this.quadmap_valid = !1);
      var s, n, r, a, o;
      for (s = 0, n = this.inst.cellheight; s < n; ++s) {
        for (o = [], r = 0, a = this.inst.cellwidth; r < a; ++r) o.push(-1);
        this.tiles.push(o);
      }
    }
    function c(t) {
      ...
      for (e = 0, i = c.length; e < i; ++e)
        if (((s = c[e]), (n = s.indexOf("x")), n > -1))
          for (
            r = parseInt(s.substring(0, n), 10),
              o = s.substring(n + 1),
              a = parseInt(o, 10),
              o.indexOf("h") > -1 && (a |= y),
              o.indexOf("v") > -1 && (a |= _),
    ...
    function p() {}
    function d() {}
    var f = cr.plugins_.Tilemap.prototype;
    f.Type = function (t) {
      (this.plugin = t), (this.runtime = t.runtime);
    };
    var g = f.Type.prototype;
    (g.onCreate = function () {
      var t, e, i;
      if (
        !this.is_family &&
        ...
        this.runtime.waitForImageLoad(this.texture_img, this.texture_file),
        (this.cut_tiles = []),
        (this.cut_tiles_valid = !1),
        (this.tile_polys = []),
        (this.tile_polys_cached = !1),
        this.tile_poly_data && this.tile_poly_data.length)
      )
        for (t = 0, e = this.tile_poly_data.length; t < e; ++t)
          (i = this.tile_poly_data[t]),
            i
      ...
      (g.cacheTilePoly = function (t, e, i, s, n, r) {
        if (!(t < 0 || t >= this.tile_polys.length) && this.tile_polys[t]) {
          var a = this.tile_polys[t].poly,
            o = this.tile_polys[t].flipmap,
            h = new cr.CollisionPoly(a);
          h.cache_poly(e, i, 0),
            r && h.diag(),
            s && h.mirror(e / 2),
            n && h.flip(i / 2),
            (o[s ? 1 : 0][n ? 1 : 0][r ? 1 : 0] = h);
        }
      }),
      (g.getTilePoly = function (t) {
        if (t === -1) return null;
        var e = t & w;
        if (e < 0 || e >= this.tile_polys.length) return null;
        if (!this.tile_polys[e]) return null;
        var i = t & y ? 1 : 0,
          s = t & _ ? 1 : 0,
          n = t & v ? 1 : 0;
        return this.tile_polys[e].flipmap[i][s][n];
      }),
      (g.freeCutTiles = function () {
        var t,
          e,
          i = this.runtime.glwrap;
        if (i)
          for (t = 0, e = this.cut_tiles.length; t < e; ++t)
            i.deleteTexture(this.cut_tiles[t]);
        cr.clearArray(this.cut_tiles), (this.cut_tiles_valid = !1);
      }),
      (g.maybeCutTiles = function (t, e, i, s, n, r, a) {
        if (!this.cut_tiles_valid && !(t <= 0 || e <= 0)) {
          this.freeCutTiles();
          var o,
            h,
            c = this.texture_img.width,
            l = this.texture_img.height;
          for (h = s; h + e <= l; h += e + r)
            for (o = i; o + t <= c; o += t + n)
              this.cut_tiles.push(this.CutTileImage(o, h, t, e, a));
          this.cut_tiles_valid = !0;
        }
      }),
      (g.CutTileImage = function (t, e, i, s, n) {
        if (this.runtime.glwrap)
          return this.DoCutTileImage(t, e, i, s, !1, !1, !1, n);
        var r = [
          [
            [null, null],
            [null, null],
        ...
        return (
          (r[0][0][0] = this.DoCutTileImage(t, e, i, s, !1, !1, !1, n)),
          { flipmap: r, x: t, y: e, w: i, h: s }
        );
      }),
      (g.GetFlippedTileImage = function (t, e, i, s, n) {
        if (t < 0 || t >= this.cut_tiles.length) return null;
        var r = this.cut_tiles[t],
          a = r.flipmap,
          o = e ? 1 : 0,
          h = i ? 1 : 0,
          c = s ? 1 : 0,
      ...
      (g.DoCutTileImage = function (t, e, i, s, n, r, a, o) {
        var h = i,
          c = s;
        this.runtime.glwrap &&
          !o &&
          (cr.isPOT(h) || (h = cr.nextHighestPowerOfTwo(h)),
          cr.isPOT(c) || (c = cr.nextHighestPowerOfTwo(c)));
        var l = document.createElement("canvas");
        (l.width = h), (l.height = c);
        ...
        if (this.runtime.ctx)
          return (
            n
              ? r
                ? a
                  ? (u.rotate(Math.PI / 2), u.scale(-1, 1), u.translate(-h, -c))
                  : (u.scale(-1, -1), u.translate(-h, -c))
                : a
                ? (u.rotate(Math.PI / 2), u.translate(0, -c))
                : (u.scale(-1, 1), u.translate(-h, 0))
              : r
              ? a
                ? (u.rotate(-Math.PI / 2), u.translate(-h, 0))
                : (u.scale(1, -1), u.translate(0, -c))
              : a && (u.scale(-1, 1), u.rotate(Math.PI / 2)),
            u.drawImage(this.texture_img, t, e, i, s, 0, 0, h, c),
            o ? l : this.runtime.ctx.createPattern(l, "repeat")
          );
        u.drawImage(this.texture_img, t, e, i, s, 0, 0, h, c);
        var p = this.runtime.glwrap.createEmptyTexture(
          h,
          c,
          this.runtime.linearSampling,
          !1,
        ...
        return this.runtime.glwrap.videoToTexture(l, p), p;
      }),
      (g.onLostWebGLContext = function () {
        this.is_family || this.freeCutTiles();
      }),
      (g.onRestoreWebGLContext = function () {}),
      (g.loadTextures = function () {}),
      (g.unloadTextures = function () {
        this.is_family || this.instances.length || this.freeCutTiles();
      }),
      (g.preloadCanvas2D = function (t) {}),
      (f.Instance = function (t) {
        (this.type = t), (this.runtime = t.runtime);
      });
    var m = f.Instance.prototype,
      y = -2147483648,
      _ = 1073741824,
      v = 536870912,
      b = 3758096384,
    ...
    (h.prototype.clear = function () {
      var t, e, i, s, n;
      for (
        this.tiles.length = this.inst.cellheight, t = 0, e = this.tiles.length;
        t < e;
        ++t
      )
        for (
      ...
      (h.prototype.maybeBuildQuadMap = function () {
        if (!this.quadmap_valid) {
          var t = this.inst.tilewidth,
            s = this.inst.tileheight;
          if (!(t <= 0 || s <= 0)) {
            var a, o, h, c, l, u, p, d, f, g, m;
            for (a = 0, h = this.quads.length; a < h; ++a) i(this.quads[a]);
            for (a = 0, h = this.collision_rects.length; a < h; ++a)
              r(this.collision_rects[a]);
            cr.clearArray(this.quads), cr.clearArray(this.collision_rects);
            var b = Math.floor(this.inst.width / t),
              x = Math.floor(this.inst.height / s);
            (b -= this.left / t),
              (x -= this.top / s),
              b > this.inst.cellwidth && (b = this.inst.cellwidth),
              x > this.inst.cellheight && (x = this.inst.cellheight);
            var T = this.inst.seamless,
              S = null;
            for (c = 0, l = x; c < l; ++c) {
              for (d = this.tiles[c], u = 0, p = b; u < p; ++u)
                (f = d[u]),
                  f !== -1
                    ? T || !S || f !== S.id
                      ? (S && this.quads.push(S),
                        ...
                        (S.diag_flip = 0 !== (f & v)),
                        (S.any_flip =
                          S.horiz_flip || S.vert_flip || S.diag_flip),
                        (S.rc.left = u * t + this.left),
                        (S.rc.top = c * s + this.top),
                        (S.rc.right = S.rc.left + t),
                        (S.rc.bottom = S.rc.top + s))
                      : (S.rc.right += t)
                    : S && (this.quads.push(S), (S = null));
              S && (this.quads.push(S), (S = null));
            }
            var O,
              C,
            ...
            for (c = 0, l = x; c < l; ++c) {
              for (d = this.tiles[c], u = 0, p = b; u < p; ++u)
                (f = d[u]),
                  f !== -1
                    ? ((O = f & w),
                      (C = this.inst.type.getTilePoly(f)),
                      !k || C || E
                        ? (k && (this.collision_rects.push(k), (k = null)),
                          (k = n()),
                          (k.id = f),
                          (k.poly = C ? C : null),
                          (A = k.rc),
                          (A.left = u * t + this.left),
                          (A.top = c * s + this.top),
                          (A.right = A.left + t),
                          (A.bottom = A.top + s),
                          (E = !!C))
                        : (k.rc.right += t))
                    : k && (this.collision_rects.push(k), (k = null), (E = !1));
              k && (this.collision_rects.push(k), (k = null), (E = !1));
            }
            if (!T)
              for (h = this.quads.length, a = 0; a < h; ++a)
                for (m = this.quads[a], o = a + 1; o < h; ++o)
                  if (((g = this.quads[o]), !(g.rc.top < m.rc.bottom))) {
                    if (g.rc.top > m.rc.bottom) break;
                    if (g.rc.right > m.rc.right || g.rc.left > m.rc.left) break;
                    g.id === m.id &&
                      g.rc.left === m.rc.left &&
                      g.rc.right === m.rc.right &&
                      (i(this.quads[o]),
                      this.quads.splice(o, 1),
                      --h,
                      (m.rc.bottom += s),
                      --o);
                  }
            h = this.collision_rects.length;
            var P, I;
            for (a = 0; a < h; ++a)
              if (((m = this.collision_rects[a]), !m.poly))
                for (I = m.rc, o = a + 1; o < h; ++o)
                  if (
                    ((g = this.collision_rects[o]),
                    (P = g.rc),
                    !(P.top < I.bottom))
                  ) {
                    if (P.top > I.bottom) break;
                    if (P.right > I.right || P.left > I.left) break;
                    g.poly ||
                      (P.left === I.left &&
                        P.right === I.right &&
                        (r(this.collision_rects[o]),
                        this.collision_rects.splice(o, 1),
                        --h,
                        (I.bottom += s),
                        --o));
                  }
            this.quadmap_valid = !0;
          }
        }
      }),
      (h.prototype.setTileAt = function (t, e, i) {
        this.tiles[e][t] !== i &&
          ((this.tiles[e][t] = i),
          (this.quadmap_valid = !1),
          (this.inst.any_quadmap_changed = !0),
          (this.inst.physics_changed = !0),
          (this.inst.runtime.redraw = !0));
      }),
      (m.onCreate = function () {
        var t, e, i;
        (this.visible = 0 === this.properties[0]),
          ...
          (this.seamless = 0 !== this.properties[7]),
          (this.mapwidth = this.tilemap_width),
          (this.mapheight = this.tilemap_height),
          (this.lastwidth = this.width),
          (this.lastheight = this.height);
        var s = this.tilewidth,
          n = this.tileheight;
        if (
          (0 === s && (s = 1),
          0 === n && (n = 1),
          (this.cellwidth = Math.ceil(this.runtime.original_width / s)),
          (this.cellheight = Math.ceil(this.runtime.original_height / n)),
          !this.type.tile_polys_cached)
        )
          for (
            this.type.tile_polys_cached = !0,
              t = 0,
              e = this.type.tile_polys.length;
            t < e;
            ++t
          )
            (i = this.type.tile_polys[t]),
              i &&
                (this.type.cacheTilePoly(t, s, n, !1, !1, !1),
                this.type.cacheTilePoly(t, s, n, !1, !1, !0),
                this.type.cacheTilePoly(t, s, n, !1, !0, !1),
                this.type.cacheTilePoly(t, s, n, !1, !0, !0),
                this.type.cacheTilePoly(t, s, n, !0, !1, !1),
                this.type.cacheTilePoly(t, s, n, !0, !1, !0),
                this.type.cacheTilePoly(t, s, n, !0, !0, !1),
                this.type.cacheTilePoly(t, s, n, !0, !0, !0));
        this.recycled || (this.tilecells = []),
          this.maybeResizeTilemap(!0),
          ...
          (this.physics_changed = !1),
          (this.any_quadmap_changed = !0),
          this.maybeBuildAllQuadMap();
      }),
      (m.maybeBuildAllQuadMap = function () {
        if (this.any_quadmap_changed) {
          var t, e, i, s, n;
          for (t = 0, e = this.tilecells.length; t < e; ++t)
            for (n = this.tilecells[t], i = 0, s = n.length; i < s; ++i)
              n[i].maybeBuildQuadMap();
          this.any_quadmap_changed = !1;
        }
      }),
      (m.setAllQuadMapChanged = function () {
        var t, e, i, s, n;
        for (t = 0, e = this.tilecells.length; t < e; ++t)
          for (n = this.tilecells[t], i = 0, s = n.length; i < s; ++i)
            n[i].quadmap_valid = !1;
      ...
      (m.maybeResizeTilemap = function (t) {
        var e = cr.floor(this.width / this.tilewidth),
          i = cr.floor(this.height / this.tileheight);
        if (!(e <= this.mapwidth && i <= this.mapheight) || t) {
          var s, n;
          t
            ? ((s = Math.ceil(this.mapheight / this.cellheight)),
              (n = Math.ceil(this.mapwidth / this.cellwidth)))
            : ((s = this.tilecells.length),
              (n = Math.ceil(this.mapwidth / this.cellwidth)),
              i > this.mapheight &&
                ((this.mapheight = i),
                (s = Math.ceil(this.mapheight / this.cellheight))),
              ...
              (this.physics_changed = !0),
              (this.runtime.redraw = !0));
          var r, o, h;
          for (r = 0; r < s; ++r)
            if ((h = this.tilecells[r]))
              for (o = h.length; o < n; ++o) h.push(a(this, o, r));
            else {
              for (h = [], o = 0; o < n; ++o) h.push(a(this, o, r));
              this.tilecells[r] = h;
            }
        }
      }),
      (m.cellAt = function (t, e) {
        if (t < 0 || e < 0) return null;
        var i = cr.floor(e / this.cellheight);
        if (i >= this.tilecells.length) return null;
        var s = this.tilecells[i],
          n = cr.floor(t / this.cellwidth);
        return n >= s.length ? null : s[n];
      }),
      (m.cellAtIndex = function (t, e) {
        if (t < 0 || e < 0 || e >= this.tilecells.length) return null;
        var i = this.tilecells[e];
        return t >= i.length ? null : i[t];
      }),
      (m.setTilesFromRLECSV = function (t) {
        var e,
          i,
          s,
          n,
          r = c(t),
          a = 0;
        for (e = 0; e < this.mapheight; ++e)
          for (i = 0; i < this.mapwidth; ++i)
            (s = r[a++]),
              (n = this.cellAt(i, e)),
              n && n.setTileAt(i % this.cellwidth, e % this.cellheight, s);
      }),
      (m.getTilesAsRLECSV = function () {
        var t = "";
        if (this.mapwidth <= 0 || this.mapheight <= 0) return t;
        var e,
          i,
          s,
          n,
          ...
          c,
          l = 1,
          u = this.getTileAt(0, 0);
        for (
          n = cr.floor(this.width / this.tilewidth),
            i = cr.floor(this.height / this.tileheight),
            e = 0;
          e < i;
          ++e
      ...
      (m.getTileAt = function (t, e) {
        if (
          ((t = Math.floor(t)),
          (e = Math.floor(e)),
          t < 0 || e < 0 || t >= this.mapwidth || e >= this.mapheight)
        )
          return -1;
        var i = this.cellAt(t, e);
        return i ? i.tiles[e % this.cellheight][t % this.cellwidth] : -1;
      }),
      (m.setTileAt = function (t, e, i) {
        if (
          ((t = Math.floor(t)),
          (e = Math.floor(e)),
          t < 0 || e < 0 || t >= this.mapwidth || e >= this.mapheight)
          ...
          return -1;
        var s = this.cellAt(t, e);
        return s
          ? void s.setTileAt(t % this.cellwidth, e % this.cellheight, i)
          : -1;
      }),
      (m.worldToCellX = function (t) {
        return Math.floor((t - this.x) / (this.cellwidth * this.tilewidth));
      }),
      (m.worldToCellY = function (t) {
        return Math.floor((t - this.y) / (this.cellheight * this.tileheight));
      }),
      (m.getCollisionRectCandidates = function (t, e) {
        var i,
          s,
          n,
          r = this.worldToCellX(t.left),
          a = this.worldToCellY(t.top),
          o = this.worldToCellX(t.right),
          h = this.worldToCellY(t.bottom);
        for (i = r; i <= o; ++i)
          for (s = a; s <= h; ++s)
            (n = this.cellAtIndex(i, s)),
              n &&
                (n.maybeBuildQuadMap(), cr.appendArray(e, n.collision_rects));
      }),
      (m.getAllCollisionRects = function (t) {
        var e, i, s, n, r, a;
        for (e = 0, i = this.tilecells.length; e < i; ++e)
          for (r = this.tilecells[e], s = 0, n = r.length; s < n; ++s)
            (a = r[s]),
              a.maybeBuildQuadMap(),
              cr.appendArray(t, a.collision_rects);
      }),
      (m.onDestroy = function () {
        var t, e, i, s, n;
        for (t = 0, e = this.tilecells.length; t < e; ++t) {
          for (n = this.tilecells[t], i = 0, s = n.length; i < s; ++i) o(n[i]);
          cr.clearArray(n);
        }
        cr.clearArray(this.tilecells);
      }),
      (m.saveToJSON = function () {
        this.maybeResizeTilemap();
        var t = cr.floor(this.width / this.tilewidth),
          e = cr.floor(this.height / this.tileheight);
        return { w: t, h: e, d: this.getTilesAsRLECSV() };
      }),
      (m.loadFromJSON = function (t) {
        (this.mapwidth = t.w),
          (this.mapheight = t.h),
          this.maybeResizeTilemap(!0),
          this.setTilesFromRLECSV(t.d),
          (this.physics_changed = !0),
          this.setAllQuadMapChanged();
      }),
      (m.draw = function (t) {
        if (!(this.tilewidth <= 0 || this.tileheight <= 0)) {
          ...
          var l = this.cellwidth * this.tilewidth,
            u = this.cellheight * this.tileheight,
            p = Math.floor((s - o) / l),
            d = Math.floor((r - o) / l),
            f = Math.floor((n - h) / u),
            g = Math.floor((a - h) / u),
          ...
          this.seamless && ((m = 0), (y = 0)),
            (0 === m && 0 === y) ||
              ...
              (r -= m),
              (a -= y));
          var _, v, b, w, x, T, S, O, C, A, k;
          for (_ = p; _ <= d; ++_)
            for (v = f; v <= g; ++v)
              if ((b = this.cellAtIndex(_, v)))
                for (
                  b.maybeBuildQuadMap(), w = 0, x = b.quads.length;
                  w < x;
                  ++w
                )
                  (T = b.quads[w]),
                    T.id !== -1 &&
                      ...
                      S > r ||
                        ...
                        O > a ||
                        A < n ||
                        ((k = this.type.GetFlippedTileImage(
                          T.tileid,
                          T.horiz_flip,
                          T.vert_flip,
                          T.diag_flip,
                        ...
                        c
                          ? t.drawImage(k, S, O)
                          : ((t.fillStyle = this.type.GetFlippedTileImage(
                              T.tileid,
                              T.horiz_flip,
                              T.vert_flip,
                              T.diag_flip,
                            ...
                            t.fillRect(S, O, C - S, A - O))));
          (0 === m && 0 === y) || t.restore();
        }
      });
    var O = new cr.rect(0, 0, 1, 1);
    (m.drawGL_earlyZPass = function (t) {
      this.drawGL(t);
    }),
      (m.drawGL = function (t) {
        if (!(this.tilewidth <= 0 || this.tileheight <= 0)) {
          ...
          var l,
            ...
            k,
            E,
            P = this.cellwidth * this.tilewidth,
            I = this.cellheight * this.tileheight,
            R = Math.floor((n - h) / P),
            M = Math.floor((a - h) / P),
            L = Math.floor((r - c) / I),
            F = Math.floor((o - c) / I);
          for (A = R; A <= M; ++A)
            for (k = L; k <= F; ++k)
              if ((E = this.cellAtIndex(A, k)))
                for (
                  E.maybeBuildQuadMap(), l = 0, u = E.quads.length;
                  l < u;
                  ++l
                )
                  (p = E.quads[l]),
                    p.id !== -1 &&
                      ...
                      d > a ||
                        ...
                        f > o ||
                        m < r ||
                        (t.setTexture(i[p.tileid]),
                        (O.right = (g - d) / this.tilewidth),
                        (O.bottom = (m - f) / this.tileheight),
                        p.any_flip
                          ? (p.diag_flip &&
                              ((C = O.right),
                              (O.right = O.bottom),
                          ...
                          : t.quadTex(d, f, g, f, g, m, d, m, O)));
        }
      }),
      (l.prototype.CompareTileAt = function (t, e, i, s) {
        var n = this.getTileAt(t, e);
        return n !== -1 && (n &= w), cr.do_cmp(n, i, s);
      }),
      (l.prototype.CompareTileStateAt = function (t, e, i) {
        var s = this.getTileAt(t, e),
          n = 0;
        return s !== -1 && (n = s & b), n === u(i);
      }),
      (l.prototype.OnURLLoaded = function () {
        return !0;
      }),
      (f.cnds = new l()),
      (p.prototype.EraseTile = function (t, e) {
        this.maybeResizeTilemap(), this.setTileAt(t, e, -1);
      }),
      (p.prototype.SetTile = function (t, e, i, s) {
        this.maybeResizeTilemap(), this.setTileAt(t, e, (i & w) | u(s));
      }),
      (p.prototype.SetTileState = function (t, e, i) {
        var s = this.getTileAt(t, e);
        s !== -1 &&
          (this.maybeResizeTilemap(), this.setTileAt(t, e, (s & w) | u(i)));
      }),
      (p.prototype.EraseTileRange = function (t, e, i, s) {
        var n,
          r,
          a = Math.floor(cr.max(t, 0)),
          o = Math.floor(cr.max(e, 0)),
          h = Math.floor(cr.min(t + i, this.mapwidth)),
          c = Math.floor(cr.min(e + s, this.mapheight));
        for (r = o; r < c; ++r)
          for (n = a; n < h; ++n) this.setTileAt(n, r, -1);
      }),
      (p.prototype.SetTileRange = function (t, e, i, s, n, r) {
        this.maybeResizeTilemap();
        var a,
          o,
          h = Math.floor(cr.max(t, 0)),
          c = Math.floor(cr.max(e, 0)),
          l = Math.floor(cr.min(t + i, this.mapwidth)),
          p = Math.floor(cr.min(e + s, this.mapheight)),
          d = (n & w) | u(r);
        for (o = c; o < p; ++o) for (a = h; a < l; ++a) this.setTileAt(a, o, d);
      }),
      (p.prototype.SetTileStateRange = function (t, e, i, s, n) {
        this.maybeResizeTilemap();
        var r,
          a,
          o,
        ...
        for (a = c; a < p; ++a)
          for (r = h; r < l; ++r)
            (o = this.getTileAt(r, a)),
              o !== -1 && this.setTileAt(r, a, (o & w) | d);
      }),
      (p.prototype.LoadFromJSON = function (t) {
        var e;
        try {
          e = JSON.parse(t);
        } catch (t) {
        ...
        e.c2tilemap &&
          ...
          this.maybeResizeTilemap(!0),
          this.setTilesFromRLECSV(e.data),
          this.setAllQuadMapChanged(),
          (this.physics_changed = !0));
      }),
      (p.prototype.JSONDownload = function (t) {
        ...
        if ("undefined" == typeof e.download) {
          ...
          (e.textContent = t),
            (e.href =
              "data:application/json," + encodeURIComponent(JSON.stringify(i))),
            (e.download = t),
            n.appendChild(e);
      ...
      (f.acts = new p()),
      (d.prototype.TileAt = function (t, e, i) {
        var s = this.getTileAt(e, i);
        t.set_int(s === -1 ? -1 : s & w);
      }),
      (d.prototype.PositionToTileX = function (t, e) {
        t.set_float(Math.floor((e - this.x) / this.tilewidth));
      }),
      (d.prototype.PositionToTileY = function (t, e) {
        t.set_float(Math.floor((e - this.y) / this.tileheight));
      }),
      (d.prototype.TileToPositionX = function (t, e) {
        t.set_float(e * this.tilewidth + this.x + this.tilewidth / 2);
      }),
      (d.prototype.TileToPositionY = function (t, e) {
        t.set_float(e * this.tileheight + this.y + this.tileheight / 2);
      }),
      (d.prototype.SnapX = function (t, e) {
        t.set_float(
          Math.floor((e - this.x) / this.tilewidth) * this.tilewidth +
            this.x +
            this.tilewidth / 2
        );
      }),
      (d.prototype.SnapY = function (t, e) {
        t.set_float(
          Math.floor((e - this.y) / this.tileheight) * this.tileheight +
            this.y +
            this.tileheight / 2
        );
      }),
      (d.prototype.TilesJSON = function (t) {
        this.maybeResizeTilemap();
        var e = cr.floor(this.width / this.tilewidth),
          i = cr.floor(this.height / this.tileheight);
        t.set_string(
    ...
    (s.prototype.init = function (t, e, i, s) {
      ...
      (s.prototype.update = function (t, e, i, s, n, r) {
        (this.lasttime = this.time),
          ...
          (this.pressure = r),
          !this.tooFarForHold &&
            cr.distanceTo(this.startx, this.starty, this.x, this.y) >= g &&
    ...
    (s.prototype.maybeTriggerTap = function (t, e) {
      if (!this.triggeredHold) {
        ...
        i - this.starttime <= y &&
          ...
          (t.trigger_id = this.id),
          (t.getTouchIndex = e),
          i - w <= 2 * y && cr.distanceTo(v, b, this.x, this.y) < _
            ? (t.runtime.trigger(
      ...
      (h.onCreate = function () {
        ...
        this.runtime.isDirectCanvas
          ? (i = e = window.Canvas)
          : this.runtime.isCocoonJs && (i = e = window);
        var s = this;
        if (
          (window.navigator.pointerEnabled
            ? (e.addEventListener(
          ...
          var n = function (t) {
              var e = t.reading;
              (s.acc_x = e.accelerationX),
                (s.acc_y = e.accelerationY),
                (s.acc_z = e.accelerationZ);
            },
            r = function (t) {
              var e = t.reading;
              (s.orient_alpha = e.yawDegrees),
                (s.orient_beta = e.pitchDegrees),
                (s.orient_gamma = e.rollDegrees);
            },
            a = Windows.Devices.Sensors.Accelerometer.getDefault();
          a &&
            ((a.reportInterval = Math.max(a.minimumReportInterval, 16)),
            a.addEventListener("readingchanged", n));
          var o = Windows.Devices.Sensors.Inclinometer.getDefault();
          o &&
            ((o.reportInterval = Math.max(o.minimumReportInterval, 16)),
            o.addEventListener("readingchanged", r)),
            document.addEventListener(
              "visibilitychange",
              function (t) {
                document.hidden || document.msHidden
                  ? (a && a.removeEventListener("readingchanged", n),
                    o && o.removeEventListener("readingchanged", r))
                  : (a && a.addEventListener("readingchanged", n),
                    o && o.addEventListener("readingchanged", r));
              },
              !1
            );
        } else
          window.addEventListener(
            "deviceorientation",
            function (t) {
              (s.orient_alpha = t.alpha || 0),
                (s.orient_beta = t.beta || 0),
                (s.orient_gamma = t.gamma || 0);
            },
            !1
          ),
            window.addEventListener(
              ...
              function (t) {
                t.accelerationIncludingGravity &&
                  ((s.acc_g_x = t.accelerationIncludingGravity.x || 0),
                  (s.acc_g_y = t.accelerationIncludingGravity.y || 0),
                  (s.acc_g_z = t.accelerationIncludingGravity.z || 0)),
                  t.acceleration &&
                    ((s.acc_x = t.acceleration.x || 0),
                    (s.acc_y = t.acceleration.y || 0),
                    (s.acc_z = t.acceleration.z || 0));
              },
              !1
            );
        this.useMouseInput &&
          ...
          !this.runtime.isiOS &&
            ...
            navigator.accelerometer.watchAcceleration(t, null, {
              frequency: 40,
            }),
      ...
      (h.onPointerStart = function (t) {
        if (
          ...
          (this.trigger_index = this.touches.length),
            ...
            this.touches.push(e(s, n, t.pointerId, this.trigger_index)),
            (this.runtime.isInUserInputEvent = !0),
            this.runtime.trigger(
      ...
      (h.onPointerEnd = function (t, e) {
        if (
          ...
          (this.trigger_index = s >= 0 ? this.touches[s].startindex : -1),
            (this.trigger_id = s >= 0 ? this.touches[s].id : -1),
            (this.runtime.isInUserInputEvent = !0),
            this.runtime.trigger(
      ...
      (h.onTouchMove = function (t) {
        ...
        for (e = 0, i = t.changedTouches.length; e < i; e++) {
          ...
          if (a >= 0) {
            var o = this.runtime.isDomFree
              ? c
              : jQuery(this.runtime.canvas).offset();
            if (((n = this.touches[a]), r - n.time < 2)) continue;
            var h =
                2 *
                (s.radiusX ||
                  s.webkitRadiusX ||
            ...
            n.update(r, s.pageX - o.left, s.pageY - o.top, h, l, u);
          }
        }
      }),
      (h.onTouchStart = function (t) {
        ...
        for (s = 0, n = t.changedTouches.length; s < n; s++)
          if (
            ((r = t.changedTouches[s]),
            (a = this.findTouch(r.identifier)),
            a === -1)
          ) {
            ...
            (this.trigger_index = this.touches.length),
              ...
              this.touches.push(e(o, h, r.identifier, this.trigger_index)),
              this.runtime.trigger(
                cr.plugins_.Touch.prototype.cnds.OnNthTouchStart,
                this
              ),
      ...
      (h.onTouchEnd = function (t, e) {
        ...
        for (s = 0, n = t.changedTouches.length; s < n; s++)
          (r = t.changedTouches[s]),
            (a = this.findTouch(r.identifier)),
            a >= 0 &&
              ((this.trigger_index = this.touches[a].startindex),
              (this.trigger_id = this.touches[a].id),
              this.runtime.trigger(
                cr.plugins_.Touch.prototype.cnds.OnNthTouchEnd,
                this
              ),
              ...
              e || this.touches[a].maybeTriggerTap(this, a),
              i(this.touches[a]),
              this.touches.splice(a, 1));
        this.runtime.isInUserInputEvent = !1;
      }),
      (h.getAlpha = function () {
        return this.runtime.isCordova && 0 === this.orient_alpha && 0 !== p
          ? 90 * p
          : this.orient_alpha;
      }),
      (h.getBeta = function () {
        return this.runtime.isCordova && 0 === this.orient_beta && 0 !== u
          ? 90 * u
          : this.orient_beta;
      }),
      (h.getGamma = function () {
        return this.runtime.isCordova && 0 === this.orient_gamma && 0 !== l
          ? 90 * l
          : this.orient_gamma;
      });
    (h.onMouseDown = function (t) {
      var e = { pageX: t.pageX, pageY: t.pageY, identifier: 0 },
        i = { changedTouches: [e] };
      ...
      (h.tick2 = function () {
        ...
        for (t = 0, e = this.touches.length; t < e; ++t)
          (i = this.touches[t]),
            i.time <= s - 50 && (i.lasttime = s),
    ...
    (n.prototype.IsTouchingObject = function (t) {
      ...
      for (s = 0, n = h.length; s < n; s++) {
        ...
        for (c.update_bbox(), r = 0, a = this.touches.length; r < a; r++) {
          ...
          if (
            ((e = c.layer.canvasToLayer(l.x, l.y, !0)),
      ...
      return (
        !!x.length &&
        ((o.select_all = !1),
        cr.shallowAssignArray(o.instances, x),
        t.applySolToContainer(),
        cr.clearArray(x),
        !0)
      );
      ...
      (n.prototype.CompareTouchSpeed = function (t, e, i) {
        ...
        var s = this.touches[t],
          ...
          a = 0;
        return r > 0 && (a = n / r), cr.do_cmp(a, e, i);
      }),
      ...
      (a.cnds = new n()),
      (r.prototype.TouchCount = function (t) {
      ...
      (r.prototype.X = function (t, e) {
        ...
        cr.is_undefined(e)
          ? ((s = this.runtime.getLayerByNumber(0)),
            ...
            (s.angle = 0),
            t.set_float(
              s.canvasToLayer(this.touches[i].x, this.touches[i].y, !0)
            ),
            (s.scale = n),
            (s.zoomRate = r),
            (s.parallaxX = a),
      ...
      (r.prototype.XAt = function (t, e, i) {
        if (((e = Math.floor(e)), e < 0 || e >= this.touches.length))
          return void t.set_float(0);
        var s, n, r, a, o;
        cr.is_undefined(i)
          ? ((s = this.runtime.getLayerByNumber(0)),
            (n = s.scale),
      ...
      (r.prototype.XForID = function (t, e, i) {
        ...
        if (s < 0) return void t.set_float(0);
        var n,
          r,
          a,
          o,
        ...
        cr.is_undefined(i)
          ...
          : ((n = cr.is_number(i)
              ? this.runtime.getLayerByNumber(i)
              : this.runtime.getLayerByName(i)),
            n ? t.set_float(n.canvasToLayer(c.x, c.y, !0)) : t.set_float(0));
      }),
      (r.prototype.Y = function (t, e) {
        ...
        cr.is_undefined(e)
          ? ((s = this.runtime.getLayerByNumber(0)),
            ...
            (s.angle = 0),
            t.set_float(
              s.canvasToLayer(this.touches[i].x, this.touches[i].y, !1)
            ),
            (s.scale = n),
            (s.zoomRate = r),
            (s.parallaxY = a),
      ...
      (r.prototype.YForID = function (t, e, i) {
        ...
        cr.is_undefined(i)
          ...
          : ((n = cr.is_number(i)
              ? this.runtime.getLayerByNumber(i)
              : this.runtime.getLayerByName(i)),
            n ? t.set_float(n.canvasToLayer(c.x, c.y, !1)) : t.set_float(0));
      }),
      ...
      (r.prototype.AbsoluteXAt = function (t, e) {
        return (
          (e = Math.floor(e)),
          e < 0 || e >= this.touches.length
            ? void t.set_float(0)
            : void t.set_float(this.touches[e].x)
        );
      }),
      ...
      (r.prototype.AbsoluteYAt = function (t, e) {
        return (
          ...
          e < 0 || e >= this.touches.length
            ? void t.set_float(0)
            : void t.set_float(this.touches[e].y)
        );
      }),
  ...
  (cr.plugins_.api_boostermedia = function (t) {
    this.runtime = t;
  }),
  (function () {
    function t() {}
    function e() {}
    function i() {}
    var s = cr.plugins_.api_boostermedia.prototype;
    s.Type = function (t) {
      (this.plugin = t), (this.runtime = t.runtime);
    };
    var n = s.Type.prototype;
    ...
    (r.onCreate = function () {
      ...
      window.addEventListener("resize", function () {
        t.runtime.trigger(
          cr.plugins_.api_boostermedia.prototype.cnds.OnResize,
          t
        );
      }),
        "undefined" != typeof window.applicationCache &&
          (window.applicationCache.addEventListener("updateready", function () {
            (t.runtime.loadingprogress = 1),
              t.runtime.trigger(
                cr.plugins_.api_boostermedia.prototype.cnds.OnUpdateReady,
                t
              );
          }),
          window.applicationCache.addEventListener("progress", function (e) {
        ...
        this.runtime.addSuspendCallback(function (e) {
          e
            ? t.runtime.trigger(
                cr.plugins_.api_boostermedia.prototype.cnds.OnPageHidden,
                t
              )
            : t.runtime.trigger(
                cr.plugins_.api_boostermedia.prototype.cnds.OnPageVisible,
                t
              );
        }),
        (this.is_arcade = "undefined" != typeof window.is_scirra_arcade);
      ...
      (t.prototype.PageVisible = function () {
        return !this.runtime.isSuspended;
      }),
      (t.prototype.OnPageVisible = function () {
        return !0;
      }),
      ...
      (s.cnds = new t()),
      (e.prototype.MoreGames = function () {
        requestMore();
      }),
      (e.prototype.MainMenu = function () {
        try {
        } catch (t) {
          console.log("Main Menu");
        }
      }),
      (e.prototype.LevelStart = function () {
        try {
        } catch (t) {
          console.log("Level Start");
        }
      }),
      (e.prototype.LevelFailed = function () {
        try {
        } catch (t) {
      ...
      (e.prototype.GameComplete = function () {
        try {
        } catch (t) {
          console.log("Game Complete");
        }
      }),
      (e.prototype.HighScore = function (t) {
        var e = t;
        if (!window.highscore || e > window.highscore) {
          window.highscore = e;
        }
      }),
      ...
      (r.tick = function () {
        if (this.enabled) {
          var t,
            ...
            i,
            s,
            n = this.runtime.getDt(this.inst);
          this.inst.angle !== this.lastKnownAngle &&
            (this.setAngle &&
              ((t = cr.distanceTo(0, 0, this.dx, this.dy)),
              (this.dx = Math.cos(this.inst.angle) * t),
              (this.dy = Math.sin(this.inst.angle) * t)),
            (this.lastKnownAngle = this.inst.angle)),
            0 !== this.acc &&
              ...
              (e =
                0 === this.dx && 0 === this.dy
                  ? this.inst.angle
                  : cr.angleTo(0, 0, this.dx, this.dy)),
              (t += this.acc * n),
              t < 0 && (t = 0),
              (this.dx = Math.cos(e) * t),
              (this.dy = Math.sin(e) * t)),
            0 !== this.g && (this.dy += this.g * n),
            (this.lastx = this.inst.x),
            (this.lasty = this.inst.y),
            (0 === this.dx && 0 === this.dy) ||
              ((this.inst.x += this.dx * n),
              (this.inst.y += this.dy * n),
              (this.travelled += cr.distanceTo(0, 0, this.dx * n, this.dy * n)),
              this.setAngle &&
              ...
              this.inst.set_bbox_changed(),
              this.bounceOffSolid &&
                ((i = this.runtime.testOverlapSolid(this.inst)),
                i &&
                  (this.runtime.registerCollision(this.inst, i),
                  (t = cr.distanceTo(0, 0, this.dx, this.dy)),
                  (s = this.runtime.calculateSolidBounceAngle(
                    this.inst,
                    this.lastx,
                    this.lasty
                  )),
                  (this.dx = Math.cos(s) * t),
                  (this.dy = Math.sin(s) * t),
                  (this.inst.x += this.dx * n),
                  (this.inst.y += this.dy * n),
                  this.inst.set_bbox_changed(),
                  this.setAngle &&
        ...
        if (t) {
          ...
          if (e) {
            var i = this.runtime.getDt(this.inst),
              ...
              n = this.runtime.calculateSolidBounceAngle(
                this.inst,
                this.lastx,
                this.lasty,
                e
  ...
  (function () {
    ...
    (r.onCreate = function () {
      ...
      (s.cnds = new t()),
      (e.prototype.StartFade = function () {
        this.activeAtStart ||
          this.setMaxOpacity ||
          ((this.maxOpacity = this.inst.opacity ? this.inst.opacity : 1),
      ...
      (s.acts = new e()),
      (i.prototype.FadeInTime = function (t) {
  ...
  (function () {
    ...
    (r.onCreate = function () {
      ...
      (s.cnds = new t()),
      (e.prototype.Flash = function (t, e, i) {
        (this.ontime = t),
          (this.offtime = e),
          (this.stage = 1),
  ...
  (function () {
    ...
    (r.onCreate = function () {
      ...
      var t = this;
      this.recycled ||
        (this.myDestroyCallback = function (e) {
        ...
        if (this.pinObject) {
          ...
          if (3 === this.mode || 4 === this.mode) {
            ...
            if (i > this.pinDist || (4 === this.mode && i < this.pinDist)) {
              ...
              (t = this.pinObject.x + Math.cos(s) * this.pinDist),
                (e = this.pinObject.y + Math.sin(s) * this.pinDist);
            }
          } else
            (t =
              this.pinObject.x +
          ...
          (this.lastKnownAngle = n),
            (0 !== this.mode &&
              ...
              3 !== this.mode &&
              4 !== this.mode) ||
              (this.inst.x === t && this.inst.y === e) ||
              ((this.inst.x = t),
              (this.inst.y = e),
              this.inst.set_bbox_changed()),
            (0 !== this.mode && 2 !== this.mode) ||
              this.inst.angle === n ||
              ((this.inst.angle = n), this.inst.set_bbox_changed());
        }
      }),
      ...
      (s.cnds = new t()),
      (e.prototype.Pin = function (t, e) {
        if (t) {
          var i = t.getFirstPicked(this.inst);
          i &&
            ((this.pinObject = i),
            (this.pinAngle =
              cr.angleTo(i.x, i.y, this.inst.x, this.inst.y) - i.angle),
      ...
      (s.acts = new e()),
      (i.prototype.PinnedUID = function (t) {
  ...
  (function () {
    ...
    (c.updateGravity = function () {
      (this.downx = Math.cos(this.ga)),
        ...
        (this.g1 = this.g),
        this.g < 0 &&
          ((this.downx *= -1), (this.downy *= -1), (this.g = Math.abs(this.g)));
    }),
      (c.onCreate = function () {
      ...
      (c.afterLoad = function () {
        this.loadFloorObject === -1
          ? (this.lastFloorObject = null)
          : (this.lastFloorObject = this.runtime.getObjectByUID(
              this.loadFloorObject
            )),
          this.loadOverJumpthru === -1
            ? (this.wasOverJumpthru = null)
            : (this.wasOverJumpthru = this.runtime.getObjectByUID(
                this.loadOverJumpthru
              ));
      }),
      ...
      (c.isOnFloor = function () {
        ...
        if (
          ...
          s ||
            0 !== this.fallthrough ||
            (n = this.runtime.testOverlapJumpThru(this.inst, !0)),
          (this.inst.x = r),
          (this.inst.y = a),
          this.inst.set_bbox_changed(),
          s)
        )
          return this.runtime.testOverlap(this.inst, s)
            ? null
            : ((this.floorIsJumpthru = !1), s);
        if (n && n.length) {
          for (t = 0, i = 0, e = n.length; t < e; t++)
            (n[i] = n[t]), this.runtime.testOverlap(this.inst, n[t]) || i++;
      ...
      (c.posttick = function () {
        var t,
          ...
          p,
          d,
          f = this.runtime.getDt(this.inst);
        this.jumpkey || this.simjump || (this.jumped = !1);
        var g = this.leftkey || this.simleft,
          m = this.rightkey || this.simright,
          y = this.jumpkey || this.simjump,
          _ = y && !this.jumped;
        if (
          ((this.simleft = !1),
          (this.simright = !1),
          ...
          this.ignoreInput && ((g = !1), (m = !1), (y = !1), (_ = !1)),
            y || (this.sustainTime = 0);
          ...
          this.firstTick &&
            ...
            !v ||
              0 !== this.dy ||
              (v.y === this.lastFloorY && v.x === this.lastFloorX) ||
              ((t = v.x - this.lastFloorX),
              (e = v.y - this.lastFloorY),
              (this.inst.x += t),
              (this.inst.y += e),
              this.inst.set_bbox_changed(),
              (this.lastFloorX = v.x),
          ...
          w
            ? ((this.doubleJumped = !1),
              ...
              this.dy > 0 &&
                ...
                (this.dy = 0)),
              v != w
                ? ((this.lastFloorObject = w),
                  (this.lastFloorX = w.x),
                  (this.lastFloorY = w.y),
                  this.runtime.registerCollision(this.inst, w))
                : b &&
                  ((x = this.runtime.testOverlapSolid(this.inst)),
                  x &&
                    (this.runtime.registerCollision(this.inst, x),
            ...
            ((w && _) ||
              ...
              this.runtime.testOverlapSolid(this.inst)
                ...
                : ((this.sustainTime = this.jumpSustain),
                  ...
                  (_ = !0),
                  w ? (this.jumped = !0) : (this.doubleJumped = !0)),
              (this.inst.x = p),
              (this.inst.y = d),
              this.inst.set_bbox_changed()),
            w ||
              (y && this.sustainTime > 0
                ? ((this.dy = -this.jumpStrength), (this.sustainTime -= f))
                : ((this.lastFloorObject = null),
                  (this.dy += this.g * f),
            ...
            g == m &&
              (this.dx < 0
                ? ((this.dx += this.dec * f), this.dx > 0 && (this.dx = 0))
                : this.dx > 0 &&
                  ((this.dx -= this.dec * f), this.dx < 0 && (this.dx = 0))),
            g &&
              !m &&
              (this.dx > 0
                ? (this.dx -= (this.acc + this.dec) * f)
                : (this.dx -= this.acc * f)),
            m &&
              !g &&
              (this.dx < 0
            ...
            this.dx > this.maxspeed
              ? (this.dx = this.maxspeed)
              : this.dx < -this.maxspeed && (this.dx = -this.maxspeed);
          var T = !1;
          if (0 !== this.dx) {
            (p = this.inst.x),
              (d = this.inst.y),
              (t = this.dx * f * this.rightx),
              (e = this.dx * f * this.righty),
              (this.inst.x +=
                this.rightx * (this.dx > 1 ? 1 : -1) - this.downx),
              (this.inst.y +=
                this.righty * (this.dx > 1 ? 1 : -1) - this.downy),
              this.inst.set_bbox_changed();
            var S = !1,
            ...
            if (
              ...
              !i &&
                w &&
                ((i = this.runtime.testOverlapJumpThru(this.inst)),
                i &&
                  ((this.inst.x = p),
                  (this.inst.y = d),
                  this.inst.set_bbox_changed(),
                  this.runtime.testOverlap(this.inst, i)
                    ? ((i = null), (S = !1))
                    : (S = !0),
                  (this.inst.x = p + t),
                  (this.inst.y = d + e),
              ...
              !this.runtime.pushOutSolid(
                ...
                ? (this.runtime.registerCollision(this.inst, i),
                  (C = Math.max(Math.abs(this.dx * f * 2.5), 30)),
                  this.runtime.pushOutSolid(
                    this.inst,
              ...
              var A = this.isOnFloor();
              w && !A
                ? ((s = Math.ceil(Math.abs(this.dx * f)) + 2),
                  (p = this.inst.x),
                  (d = this.inst.y),
                  (this.inst.x += this.downx * s),
                  (this.inst.y += this.downy * s),
                  this.inst.set_bbox_changed(),
                  this.runtime.testOverlapSolid(this.inst) ||
                  this.runtime.testOverlapJumpThru(this.inst)
                    ? this.runtime.pushOutSolid(
          ...
          if (0 !== this.dy) {
            (p = this.inst.x),
              (d = this.inst.y),
              (this.inst.x += this.dy * f * this.downx),
              (this.inst.y += this.dy * f * this.downy);
            var k = this.inst.x,
              E = this.inst.y;
            this.inst.set_bbox_changed(),
              (x = this.runtime.testOverlapSolid(this.inst));
            ...
            if (!x && this.dy > 0 && !w) {
              if (
                ((n =
                  this.fallthrough > 0
                    ? null
                    : this.runtime.testOverlapJumpThru(this.inst, !0)),
                n && n.length)
              ) {
                if (this.wasOverJumpthru) {
                  for (
                    ...
                    (n[u] = n[c]),
                      this.runtime.testOverlap(this.inst, n[c]) || u++;
                  (n.length = u),
                    (this.inst.x = k),
                    (this.inst.y = E),
                    this.inst.set_bbox_changed();
            ...
            if (x) {
              this.runtime.registerCollision(this.inst, x),
                (this.sustainTime = 0);
              var C = P
                ? Math.abs(this.dy * f * 2.5 + 10)
                : Math.max(Math.abs(this.dy * f * 2.5 + 10), 30);
              this.runtime.pushOutSolid(
                this.inst,
                ...
                ? ((this.lastFloorObject = x),
                  (this.lastFloorX = x.x),
                  (this.lastFloorY = x.y),
                  (this.floorIsJumpthru = P),
                  P && (T = !0),
                  (this.dy = 0))
                : ((this.inst.x = p),
                  (this.inst.y = d),
              ...
              (this.animMode === h || T || (_ && 0 === this.dy)
                ...
                : (this.animMode !== r &&
                  ...
                  this.animMode === a ||
                    ...
                    (this.animMode = a)))),
            this.fallthrough > 0 && this.fallthrough--,
            (this.wasOverJumpthru = this.runtime.testOverlapJumpThru(
              this.inst
            ));
        }
      }),
      ...
      (e.prototype.FallThrough = function () {
        ...
        (this.inst.x = t),
          (this.inst.y = e),
          this.inst.set_bbox_changed(),
          i && ((this.fallthrough = 3), (this.lastFloorObject = null));
      }),
  ...
  (function () {
    ...
    function e() {}
    function i() {}
    var s = cr.behaviors.Rex_MoveTo.prototype;
    s.Type = function (t, e) {
      (this.behavior = t), (this.objtype = e), (this.runtime = t.runtime);
    };
    var n = s.Type.prototype;
    ...
    (r.onCreate = function () {
      (this.enabled = 1 == this.properties[0]),
        this.recycled || (this.move_params = { max: 0, acc: 0, dec: 0 }),
        (this.move_params.max = this.properties[1]),
        (this.move_params.acc = this.properties[2]),
        (this.move_params.dec = this.properties[3]),
        (this.is_continue_mode = 1 == this.properties[4]),
        this.recycled || (this.target = { x: 0, y: 0, a: 0 }),
        (this.is_moving = !1),
        (this.current_speed = 0),
        (this.remain_distance = 0),
        (this.remain_dt = 0),
        this.recycled || (this._pre_pos = { x: 0, y: 0 }),
        (this._pre_pos.x = 0),
        (this._pre_pos.y = 0),
        this.recycled || (this._moving_angle_info = { x: 0, y: 0, a: -1 }),
      ...
      (r.move = function (t) {
        if (0 != t) {
          (this._pre_pos.x == this.inst.x && this._pre_pos.y == this.inst.y) ||
            this._reset_current_pos();
          var e = !1;
          if (0 != this.move_params.dec) {
            var i = this.current_speed,
              s = (i * i) / (2 * this.move_params.dec);
            e = s >= this.remain_distance;
          }
          var n = e ? -this.move_params.dec : this.move_params.acc;
          ...
          if (this.remain_distance <= 0 || this.current_speed <= 0)
            ...
            var o = this.target.a;
            (this.inst.x += r * Math.cos(o)), (this.inst.y += r * Math.sin(o));
          }
          this.inst.set_bbox_changed(),
      ...
      (r.SetCurrentSpeed = function (t) {
        null != t
          ? (this.current_speed =
              t > this.move_params.max ? this.move_params.max : t)
          : 0 == this.move_params.acc &&
            (this.current_speed = this.move_params.max);
      }),
      (r._reset_current_pos = function () {
        var t = this.target.x - this.inst.x,
          e = this.target.y - this.inst.y;
        (this.target.a = Math.atan2(e, t)),
          (this.remain_distance = Math.sqrt(t * t + e * e)),
          (this._pre_pos.x = this.inst.x),
          (this._pre_pos.y = this.inst.y);
      }),
      (r.SetTargetPos = function (t, e) {
        (this.target.x = t),
          (this.target.y = e),
      ...
      (r.loadFromJSON = function (t) {
        (this.enabled = t.en),
          (this.move_params = t.v),
          (this.target = t.t),
          (this.is_moving = t.is_m),
          (this.current_speed = t.c_spd),
          (this.remain_distance = t.rd),
          (this._pre_pos = t.pp),
          (this._moving_angle_info = t.ma),
          (this._last_tick = t.lt);
      }),
      (s.cnds = new t()),
      (t.prototype.OnHitTarget = function () {
        return this.is_my_call;
      }),
      (t.prototype.CompareSpeed = function (t, e) {
        return cr.do_cmp(this.current_speed, t, e);
      }),
      (t.prototype.OnMoving = function () {
        return !1;
      }),
      (t.prototype.IsMoving = function () {
        return this.enabled && this.is_moving;
      }),
      (t.prototype.CompareMovingAngle = function (t, e) {
        var i = this.moving_angle_get();
        return i != -1 && cr.do_cmp(this.moving_angle_get(), t, e);
      }),
      (s.acts = new e()),
      (e.prototype.SetEnabled = function (t) {
        this.enabled = 1 === t;
      ...
      (e.prototype.SetTargetPos = function (t, e) {
        this.SetTargetPos(t, e);
      }),
      (e.prototype.SetCurrentSpeed = function (t) {
        this.SetCurrentSpeed(t);
      }),
      (e.prototype.SetTargetPosOnObject = function (t) {
        if (t) {
          var e = t.getFirstPicked();
          null != e && this.SetTargetPos(e.x, e.y);
        }
      }),
      (e.prototype.SetTargetPosByDeltaXY = function (t, e) {
        this.SetTargetPos(this.inst.x + t, this.inst.y + e);
      }),
      (e.prototype.SetTargetPosByDistanceAngle = function (t, e) {
      ...
      (s.exps = new i()),
      (i.prototype.Activated = function (t) {
      ...
      (i.prototype.Acc = function (t) {
        t.set_float(this.move_params.acc);
      }),
      (i.prototype.Dec = function (t) {
        t.set_float(this.move_params.dec);
      }),
      (i.prototype.TargetX = function (t) {
        t.set_float(this.target.x);
      }),
      (i.prototype.TargetY = function (t) {
...
(function () {
  for (
    var t = 1, e = 0, i = 1, s = 0, n = 0, r = 0, a = 0, o = 0, h = 0;
    h <= litetween_precision;
    h++
  ) {
    if (
      ((a = h / litetween_precision),
      (s =
        (a /= t) < 1 / 2.75
          ? i * (7.5625 * a * a) + e
          : a < 2 / 2.75
      ...
      (easeOutBounceArray[h] = easeOutBounce(h / litetween_precision, e, i, t)),
      (a = h / litetween_precision),
      (n = 0),
      (r = 0),
      0 == a && (s = e),
      ...
      n = i;
      var o = r / 4;
    } else var o = (r / (2 * Math.PI)) * Math.asin(i / n);
    if (
      ((s =
        -(
          n *
          Math.pow(2, 10 * (a -= 1)) *
          Math.sin(((a * t - o) * (2 * Math.PI)) / r)
        ) + e),
      (easeInElasticArray[h] = s),
      (a = h / litetween_precision),
      (n = 0),
      (r = 0),
      0 == a && (s = e),
    ...
    if (
      ((s =
        n * Math.pow(2, -10 * a) * Math.sin(((a * t - o) * (2 * Math.PI)) / r) +
        i +
        e),
      (easeOutElasticArray[h] = s),
      (a = h / litetween_precision),
      (n = 0),
      (r = 0),
      0 == a && (s = e),
    ...
    (s =
      a < 1
        ...
        : n *
          ...
          i +
          e),
      (easeInOutElasticArray[h] = s),
      (a = h / litetween_precision),
      (easeInCircle[h] = -(Math.sqrt(1 - a * a) - 1)),
      (a = h / litetween_precision),
      (easeOutCircle[h] = Math.sqrt(1 - (a - 1) * (a - 1))),
      (a = h / litetween_precision),
      (s =
        (a /= t / 2) < 1
          ? (-i / 2) * (Math.sqrt(1 - a * a) - 1) + e
          : (i / 2) * (Math.sqrt(1 - (a -= 2) * a) + 1) + e),
      (easeInOutCircle[h] = s),
      (a = h / litetween_precision),
      (o = 0),
      0 == o && (o = 1.70158),
      (s = i * ((a = a / t - 1) * a * ((o + 1) * a + o) + 1) + e),
      (easeOutBack[h] = s),
      (a = h / litetween_precision),
      (o = 0),
      0 == o && (o = 1.70158),
      (s =
        (a /= t / 2) < 1
          ? (i / 2) * (a * a * (((o *= 1.525) + 1) * a - o)) + e
          : (i / 2) * ((a -= 2) * a * (((o *= 1.525) + 1) * a + o) + 2) + e),
      (easeInOutBack[h] = s);
  }
})();
var TweenObject = (function () {
  var t = function (t, e, i, s, n, r, a) {
    (this.name = t),
      (this.value = 0),
      this.setInitial(s),
      this.setTarget(n),
...
(function () {
  ...
  (function () {
    ...
    (i.onCreate = function () {
          ...
          switch ((isNaN(r) && (r = 0), isNaN(a) && (a = 0), t)) {
            ...
            case 4:
              i =
                ...
                r +
                "," +
                (cr.to_degrees(this.inst.angle) + a);
              break;
            case 5:
              i =
      ...
      (i.updateTween = function (t, e) {
        var i = 1,
          s = 1;
        if (
          (this.inst.width < 0 && (i = -1),
          this.inst.height < 0 && (s = -1),
          0 === t.tweened)
        )
          t.enforce
            ? ((this.inst.x =
          ...
          t.enforce
            ? ((this.inst.width =
                i * t.initialparam1 +
                (t.targetparam1 - t.initialparam1) * (e * i)),
              (this.inst.height =
                s * t.initialparam2 +
                (t.targetparam2 - t.initialparam2) * (e * s)))
            : ((this.inst.width +=
                i * (t.targetparam1 - t.initialparam1) * e - t.lastKnownValue),
              (this.inst.height +=
                s * (t.targetparam2 - t.initialparam2) * e - t.lastKnownValue2),
              (t.lastKnownValue = i * (t.targetparam1 - t.initialparam1) * e),
              (t.lastKnownValue2 = s * (t.targetparam2 - t.initialparam2) * e));
        else if (2 === t.tweened)
          t.enforce
            ? (this.inst.width =
                i * t.initialparam1 +
          ...
          if (t.enforce) {
            ...
            var n = (t.targetparam1 - t.initialparam1) * e - t.lastKnownValue;
            (this.inst.angle = cr.clamp_angle(
              this.inst.angle + cr.to_radians(n)
            )),
              (t.lastKnownValue = (t.targetparam1 - t.initialparam1) * e);
          }
        else if (5 === t.tweened)
          ...
          this.inst.width < 0 &&
            (r = t.initialparam1 + (t.targetparam1 + t.initialparam1) * -e),
            this.inst.height < 0 &&
              (a = t.initialparam2 + (t.targetparam2 + t.initialparam2) * -e),
            t.enforce
              ? ((this.inst.width = this.inst.curFrame.width * r),
                (this.inst.height = this.inst.curFrame.height * a))
              : (this.inst.width < 0
                  ? ((this.inst.width =
                      r * (this.inst.width / (-1 + t.lastKnownValue))),
                ...
                this.inst.height < 0
                  ? ((this.inst.height =
                      a * (this.inst.height / (-1 + t.lastKnownValue2))),
                    (t.lastKnownValue2 = a + 1))
                  : ((this.inst.height =
                      a * (this.inst.height / (1 + t.lastKnownValue2))),
                    (t.lastKnownValue2 = a - 1)));
        }
    ...
    (s.IsActive = function () {
      ...
      (s.IsReversing = function () {
        return 2 == this.tween_list.default.state;
      }),
      (s.CompareProgress = function (t, e) {
    ...
    (n.Start = function (t, e) {
          ...
          if (1 === e) {
            switch (((this.target = "relative(" + n + ")"), t)) {
              ...
              case 1:
                ...
                break;
              case 2:
                (r = "" + cr.to_degrees(this.inst.angle + cr.to_radians(i))),
                  (a = r);
                break;
              case 3:
                (r = "" + 100 * this.inst.opacity + i), (a = r);
                break;
              case 4:
      ...
      (n.SetParameter = function (t, e, i, s, n) {
        if (void 0 === this.tween_list.default)
  ...
  (function () {
    function t(t) {
      ...
      for (e = 0, i = t.behavior_insts.length; e < i; ++e)
        if (
          ((s = t.behavior_insts[e]),
          s.behavior instanceof cr.behaviors.scrollto)
        )
          return s;
      return null;
    }
      ...
      (n.tick2 = function () {
        if (this.enabled) {
          var e,
            i,
            s,
            n = this.behavior.my_instances.valuesRef(),
            r = 0,
            a = 0,
            o = 0;
          for (e = 0, i = n.length; e < i; e++)
            (s = t(n[e])),
              s && s.enabled && ((r += n[e].x), (a += n[e].y), ++o);
          ...
          if (c >= this.behavior.shakeStart && c < this.behavior.shakeEnd) {
            var p =
              this.behavior.shakeMag * Math.min(this.runtime.timescale, 1);
          ...
          h.scrollToX(r / o + l), h.scrollToY(a / o + u);
        }
      }),
  ...
  (cr.getObjectRefTable = function () {
    return [
      ...
      cr.plugins_.api_boostermedia.prototype.acts.HighScore,
      ...
      cr.plugins_.api_boostermedia.prototype.acts.MainMenu,
      cr.plugins_.api_boostermedia.prototype.acts.MoreGames,
      ...
      cr.plugins_.Rex_TimeLine.prototype.exps.TimeLineTime,
